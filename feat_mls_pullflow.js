  ...
  function ensureStyle() {
    ...
    try {
      ...
      s.textContent = [
        ...
        '.mpf-card{background:#0f1e3c;border:1px solid rgba(120,150,210,.28);border-radius:14px;padding:16px 16px 14px;color:#e8eefc;box-shadow:0 8px 26px rgba(10,25,60,.35);}',
        ...
        '.mpf-hint{font-size:12.5px;line-height:1.5;color:#a7bce4;background:rgba(120,150,210,.09);border-radius:9px;padding:8px 10px;margin:8px 0 10px;}',
        ...
        '.mpf-step.running .dot{background:#2563eb;border-color:#60a5fa;color:#fff;animation:mpfPulse 1.2s infinite;}',
        '.mpf-step.attention .dot{background:#eab308;border-color:#eab308;color:#3a2d00;}',
        '.mpf-step.retrying .dot{background:#7c3aed;border-color:#a78bfa;color:#fff;animation:mpfPulse 1.2s infinite;}',
        ...
        '.mpf-btn.primary{background:linear-gradient(135deg,#1f7ae0,#1456a8);color:#fff;}',
        ...
        '.mpf-kv{margin:8px 0 0;border-top:1px solid rgba(120,150,210,.18);padding-top:8px;}',
        ...
        '.mpf-code code{flex:1 1 auto;background:#0a1630;border:1px solid rgba(120,150,210,.25);border-radius:7px;padding:6px 8px;font-size:11px;color:#a7c2ff;overflow:auto;}',
