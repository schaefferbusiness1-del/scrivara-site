...
function isRetiredPath(urlLike) {
  ...
  /* Owner directive 2026-07-20: the EXACT released 3.0.20 package is public.
  ...
  if (name === 'mls_assist_v3.0.20.zip') return false;
