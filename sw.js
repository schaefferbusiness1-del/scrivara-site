...
const SHELL = [
  ...
  '/public-preview-policy.js?v=b494',
  '/public-preview-runtime.js?v=b494',
  '/index.html',
...
function isRetiredPath(urlLike) {
  ...
  /* Owner directive 2026-07-20: the EXACT released 3.0.2 package is public.
  ...
  if (name === 'mls_assist_v3.0.2.zip') return false;
