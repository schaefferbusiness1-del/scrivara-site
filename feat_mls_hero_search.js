...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      "#" + INPUT_ID + ":focus{border-color:#C9DCD2;background:rgba(255,255,255,.16);box-shadow:0 0 0 3px rgba(147,197,253,.22);}",
  ...
  function setOrigHidden(h, hidden) {
    // Never change #heroToday's display: the Who's Next picker re-renders into it and
    // loops/locks up if it is hidden. Results render above the picker instead.
