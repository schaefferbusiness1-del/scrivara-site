...
(function () {
  ...
  function ensureStyle() {
    ...
    s.textContent = '.mlsopwb-btn{cursor:pointer;font-weight:600;padding:9px 14px;border-radius:10px;border:1px solid #7A5CC0;background:#7A5CC0;color:#fff;margin-top:8px}' +
      ...
      '.mlsopwb-tag{display:inline-block;font-weight:700;font-size:10px;letter-spacing:.04em;padding:2px 6px;border-radius:6px;background:#ede9fe;color:#2E6A4B;border:1px solid #C9DCD2}';
