...
(function () {
  ...
  function injectStyle() {
    ...
    st.textContent = [
      ...
      '.mlsavs-head{display:flex;align-items:center;gap:10px;padding:15px 18px;background:#1e3a8a;color:#fff;}',
      ...
      '.mlsavs-btn{cursor:pointer;border-radius:9px;padding:9px 13px;font-size:13px;font-weight:600;border:1px solid #cbd6e4;background:#fff;color:#1e3a8a;}',
      ...
      '.mlsavs-btn.gen{background:#1e3a8a;border-color:#1e3a8a;color:#fff;}',
      '.mlsavs-btn.gen:hover{background:#16306f;}',
      ...
      '.mlsavs-spin{display:inline-block;width:13px;height:13px;border:2px solid #cbd6e4;border-top-color:#1e3a8a;border-radius:50%;animation:mlsavsSpin .7s linear infinite;vertical-align:-2px;margin-right:6px;}',
