...
"",
"  /* 4) ONE floating action button. Every other floater folds into its menu",
"     (fabtidy adds the rows) or lives in Menu/rail - never a pile of pills. */",
"  #_patientFace, #mlsCopVoiceBtn, #mlsAsstFab, #mlsTabPickerChip, #mlsAddPtLauncher,",
"  #mlsScDock, #mlsPayReportFab, .mls-askreview-chip{ display:none !important; }",
"  #mlsFab{ right:14px !important; bottom:18px !important; left:auto !important; }",
