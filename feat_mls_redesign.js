...
"/* --- cards / panels --- */",
"body.mls-redesign .card{ border:1px solid var(--line) !important;",
...
"/* quick-start hero (host #visitHero is a .card with an inline gradient) -> design dark hero */",
"body.mls-redesign #visitHero{ background:linear-gradient(135deg,#0d2138 0%,#143560 55%,#15406f 100%) !important;",
"  color:#fff !important; border:0 !important; border-radius:22px !important;",
"  box-shadow:0 22px 50px -22px rgba(13,33,56,.6) !important; }",
"body.mls-redesign #visitHero, body.mls-redesign #visitHero *{ }",
"body.mls-redesign #visitHero input{ background:rgba(255,255,255,.96) !important; color:#0f2540 !important;",
"  border:0 !important; border-radius:11px !important; }",
"body.mls-redesign #visitHero #heroRecBtn{ background:linear-gradient(135deg,#19b8a6,#13a18f) !important;",
"  color:#fff !important; border:0 !important; box-shadow:0 10px 22px -8px rgba(25,184,166,.7) !important; }",
