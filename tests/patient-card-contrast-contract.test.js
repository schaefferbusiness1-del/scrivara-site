...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b968'"), 'shared asset version was not bumped to b968');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b968'"), 'app build version was not bumped to b968');
