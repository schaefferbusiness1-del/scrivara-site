...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b568'"), 'shared asset version was not bumped to b568');
assert(source.includes("var MLS_APP_BUILD='2026-07-24-b568'"), 'app build version was not bumped to b568');
