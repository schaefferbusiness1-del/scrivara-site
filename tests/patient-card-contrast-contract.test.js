...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b922'"), 'shared asset version was not bumped to b922');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b922'"), 'app build version was not bumped to b922');
