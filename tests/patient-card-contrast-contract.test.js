...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b275'"), 'shared asset version was not bumped to b275');
assert(source.includes("var MLS_APP_BUILD='2026-07-14-b275'"), 'app build version was not bumped to b275');
