...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b358'"), 'shared asset version was not bumped to b358');
assert(source.includes("var MLS_APP_BUILD='2026-07-17-b358'"), 'app build version was not bumped to b358');
