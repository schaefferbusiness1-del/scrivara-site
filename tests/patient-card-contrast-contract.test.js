...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b303'"), 'shared asset version was not bumped to b303');
assert(source.includes("var MLS_APP_BUILD='2026-07-15-b303'"), 'app build version was not bumped to b303');
