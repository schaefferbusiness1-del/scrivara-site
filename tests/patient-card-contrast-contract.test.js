...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b400'"), 'shared asset version was not bumped to b400');
assert(source.includes("var MLS_APP_BUILD='2026-07-18-b400'"), 'app build version was not bumped to b400');
