...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b369'"), 'shared asset version was not bumped to b369');
assert(source.includes("var MLS_APP_BUILD='2026-07-17-b369'"), 'app build version was not bumped to b369');
