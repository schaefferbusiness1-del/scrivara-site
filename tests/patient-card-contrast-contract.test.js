...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b306'"), 'shared asset version was not bumped to b306');
assert(source.includes("var MLS_APP_BUILD='2026-07-15-b306'"), 'app build version was not bumped to b306');
