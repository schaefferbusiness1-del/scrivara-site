...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b290'"), 'shared asset version was not bumped to b290');
assert(source.includes("var MLS_APP_BUILD='2026-07-15-b290'"), 'app build version was not bumped to b290');
