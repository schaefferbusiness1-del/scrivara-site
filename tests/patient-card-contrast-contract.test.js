...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b312'"), 'shared asset version was not bumped to b312');
assert(source.includes("var MLS_APP_BUILD='2026-07-16-b312'"), 'app build version was not bumped to b312');
