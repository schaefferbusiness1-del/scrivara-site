...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b350'"), 'shared asset version was not bumped to b350');
assert(source.includes("var MLS_APP_BUILD='2026-07-16-b350'"), 'app build version was not bumped to b350');
