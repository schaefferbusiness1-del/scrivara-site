...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b768'"), 'shared asset version was not bumped to b768');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b768'"), 'app build version was not bumped to b768');
