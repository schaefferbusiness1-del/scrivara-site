...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b390'"), 'shared asset version was not bumped to b390');
assert(source.includes("var MLS_APP_BUILD='2026-07-17-b390'"), 'app build version was not bumped to b390');
