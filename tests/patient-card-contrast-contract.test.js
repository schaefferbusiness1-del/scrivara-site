...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b403'"), 'shared asset version was not bumped to b403');
assert(source.includes("var MLS_APP_BUILD='2026-07-18-b403'"), 'app build version was not bumped to b403');
