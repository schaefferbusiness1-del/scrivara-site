...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b416'"), 'shared asset version was not bumped to b416');
assert(source.includes("var MLS_APP_BUILD='2026-07-18-b416'"), 'app build version was not bumped to b416');
