...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b1031'"), 'shared asset version was not bumped to b1031');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b1031'"), 'app build version was not bumped to b1031');
