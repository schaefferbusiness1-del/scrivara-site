...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b511'"), 'shared asset version was not bumped to b511');
assert(source.includes("var MLS_APP_BUILD='2026-07-23-b511'"), 'app build version was not bumped to b511');
