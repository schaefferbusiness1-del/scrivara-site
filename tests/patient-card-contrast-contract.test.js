...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b558'"), 'shared asset version was not bumped to b558');
assert(source.includes("var MLS_APP_BUILD='2026-07-24-b558'"), 'app build version was not bumped to b558');
