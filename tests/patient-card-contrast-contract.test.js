...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b311'"), 'shared asset version was not bumped to b311');
assert(source.includes("var MLS_APP_BUILD='2026-07-16-b311'"), 'app build version was not bumped to b311');
