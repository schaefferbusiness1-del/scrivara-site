...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b960'"), 'shared asset version was not bumped to b960');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b960'"), 'app build version was not bumped to b960');
