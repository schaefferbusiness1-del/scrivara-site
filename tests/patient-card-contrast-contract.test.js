...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b944'"), 'shared asset version was not bumped to b944');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b944'"), 'app build version was not bumped to b944');
