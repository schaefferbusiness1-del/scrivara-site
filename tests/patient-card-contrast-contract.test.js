...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b920'"), 'shared asset version was not bumped to b920');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b920'"), 'app build version was not bumped to b920');
