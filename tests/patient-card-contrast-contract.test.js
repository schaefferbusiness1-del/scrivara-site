...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b469'"), 'shared asset version was not bumped to b434');
assert(source.includes("var MLS_APP_BUILD='2026-07-20-b469'"), 'app build version was not bumped to b434');
