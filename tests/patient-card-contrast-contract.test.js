...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b685'"), 'shared asset version was not bumped to b685');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b685'"), 'app build version was not bumped to b685');
