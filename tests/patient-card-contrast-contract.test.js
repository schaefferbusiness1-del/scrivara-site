...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b363'"), 'shared asset version was not bumped to b363');
assert(source.includes("var MLS_APP_BUILD='2026-07-17-b363'"), 'app build version was not bumped to b363');
