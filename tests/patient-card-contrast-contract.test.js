...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b431'"), 'shared asset version was not bumped to b431');
assert(source.includes("var MLS_APP_BUILD='2026-07-19-b431'"), 'app build version was not bumped to b431');
