...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b305'"), 'shared asset version was not bumped to b305');
assert(source.includes("var MLS_APP_BUILD='2026-07-15-b305'"), 'app build version was not bumped to b305');
