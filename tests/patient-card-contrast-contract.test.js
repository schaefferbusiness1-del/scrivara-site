...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b360'"), 'shared asset version was not bumped to b360');
assert(source.includes("var MLS_APP_BUILD='2026-07-17-b360'"), 'app build version was not bumped to b360');
