...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b494'"), 'shared asset version was not bumped to b494');
assert(source.includes("var MLS_APP_BUILD='2026-07-21-b494'"), 'app build version was not bumped to b494');
