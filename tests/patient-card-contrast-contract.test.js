...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b295'"), 'shared asset version was not bumped to b293');
assert(source.includes("var MLS_APP_BUILD='2026-07-15-b295'"), 'app build version was not bumped to b293');
