...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b615'"), 'shared asset version was not bumped to b615');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b615'"), 'app build version was not bumped to b615');
