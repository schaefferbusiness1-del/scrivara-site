...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b379'"), 'shared asset version was not bumped to b379');
assert(source.includes("var MLS_APP_BUILD='2026-07-17-b379'"), 'app build version was not bumped to b379');
