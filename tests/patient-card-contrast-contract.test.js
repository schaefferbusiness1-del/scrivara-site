...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b348'"), 'shared asset version was not bumped to b348');
assert(source.includes("var MLS_APP_BUILD='2026-07-16-b348'"), 'app build version was not bumped to b348');
