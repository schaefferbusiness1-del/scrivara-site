...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b391'"), 'shared asset version was not bumped to b391');
assert(source.includes("var MLS_APP_BUILD='2026-07-17-b391'"), 'app build version was not bumped to b391');
