...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b622'"), 'shared asset version was not bumped to b622');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b622'"), 'app build version was not bumped to b622');
