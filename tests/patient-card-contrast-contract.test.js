...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b763'"), 'shared asset version was not bumped to b763');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b763'"), 'app build version was not bumped to b763');
