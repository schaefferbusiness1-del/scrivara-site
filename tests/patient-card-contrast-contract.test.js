...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b794'"), 'shared asset version was not bumped to b794');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b794'"), 'app build version was not bumped to b794');
