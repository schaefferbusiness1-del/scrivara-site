...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b283'"), 'shared asset version was not bumped to b283');
assert(source.includes("var MLS_APP_BUILD='2026-07-15-b283'"), 'app build version was not bumped to b283');
