...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b662'"), 'shared asset version was not bumped to b662');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b662'"), 'app build version was not bumped to b662');
