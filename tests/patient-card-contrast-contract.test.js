...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b482'"), 'shared asset version was not bumped to b482');
assert(source.includes("var MLS_APP_BUILD='2026-07-21-b482'"), 'app build version was not bumped to b482');
