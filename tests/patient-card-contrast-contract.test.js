...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b486'"), 'shared asset version was not bumped to b486');
assert(source.includes("var MLS_APP_BUILD='2026-07-21-b486'"), 'app build version was not bumped to b486');
