...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b1038'"), 'shared asset version was not bumped to b1038');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b1038'"), 'app build version was not bumped to b1038');
