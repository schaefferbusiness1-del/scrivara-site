...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b415'"), 'shared asset version was not bumped to b415');
assert(source.includes("var MLS_APP_BUILD='2026-07-18-b415'"), 'app build version was not bumped to b415');
