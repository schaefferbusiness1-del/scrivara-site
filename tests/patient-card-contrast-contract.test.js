...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b1016'"), 'shared asset version was not bumped to b1016');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b1016'"), 'app build version was not bumped to b1016');
