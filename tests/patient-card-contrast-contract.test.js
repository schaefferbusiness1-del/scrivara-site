...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b488'"), 'shared asset version was not bumped to b488');
assert(source.includes("var MLS_APP_BUILD='2026-07-21-b488'"), 'app build version was not bumped to b488');
