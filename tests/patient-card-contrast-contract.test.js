...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b613'"), 'shared asset version was not bumped to b613');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b613'"), 'app build version was not bumped to b613');
