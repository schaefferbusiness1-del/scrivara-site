...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b366'"), 'shared asset version was not bumped to b366');
assert(source.includes("var MLS_APP_BUILD='2026-07-17-b366'"), 'app build version was not bumped to b366');
