...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b274'"), 'shared asset version was not bumped to b274');
assert(source.includes("var MLS_APP_BUILD='2026-07-14-b274'"), 'app build version was not bumped to b274');
