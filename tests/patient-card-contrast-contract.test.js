...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b591'"), 'shared asset version was not bumped to b591');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b591'"), 'app build version was not bumped to b591');
