...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b803'"), 'shared asset version was not bumped to b803');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b803'"), 'app build version was not bumped to b803');
