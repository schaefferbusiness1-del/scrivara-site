...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b382'"), 'shared asset version was not bumped to b382');
assert(source.includes("var MLS_APP_BUILD='2026-07-17-b382'"), 'app build version was not bumped to b382');
