...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b674'"), 'shared asset version was not bumped to b674');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b674'"), 'app build version was not bumped to b674');
