...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b507'"), 'shared asset version was not bumped to b507');
assert(source.includes("var MLS_APP_BUILD='2026-07-23-b507'"), 'app build version was not bumped to b507');
