...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b513'"), 'shared asset version was not bumped to b513');
assert(source.includes("var MLS_APP_BUILD='2026-07-23-b513'"), 'app build version was not bumped to b513');
