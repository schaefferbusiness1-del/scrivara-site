...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b586'"), 'shared asset version was not bumped to b586');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b586'"), 'app build version was not bumped to b586');
