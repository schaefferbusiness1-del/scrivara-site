...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b514'"), 'shared asset version was not bumped to b514');
assert(source.includes("var MLS_APP_BUILD='2026-07-23-b514'"), 'app build version was not bumped to b514');
