...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b906'"), 'shared asset version was not bumped to b906');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b906'"), 'app build version was not bumped to b906');
