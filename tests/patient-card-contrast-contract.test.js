...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b344'"), 'shared asset version was not bumped to b344');
assert(source.includes("var MLS_APP_BUILD='2026-07-16-b344'"), 'app build version was not bumped to b344');
