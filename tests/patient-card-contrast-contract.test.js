...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b324'"), 'shared asset version was not bumped to b324');
assert(source.includes("var MLS_APP_BUILD='2026-07-16-b324'"), 'app build version was not bumped to b324');
