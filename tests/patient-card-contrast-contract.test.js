...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b643'"), 'shared asset version was not bumped to b643');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b643'"), 'app build version was not bumped to b643');
