...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b430'"), 'shared asset version was not bumped to b430');
assert(source.includes("var MLS_APP_BUILD='2026-07-19-b430'"), 'app build version was not bumped to b430');
