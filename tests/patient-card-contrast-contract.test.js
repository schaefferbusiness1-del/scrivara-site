...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b975'"), 'shared asset version was not bumped to b975');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b975'"), 'app build version was not bumped to b975');
