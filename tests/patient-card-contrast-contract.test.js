...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b681'"), 'shared asset version was not bumped to b681');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b681'"), 'app build version was not bumped to b681');
