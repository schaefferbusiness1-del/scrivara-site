...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b518'"), 'shared asset version was not bumped to b518');
assert(source.includes("var MLS_APP_BUILD='2026-07-23-b518'"), 'app build version was not bumped to b518');
