...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b555'"), 'shared asset version was not bumped to b555');
assert(source.includes("var MLS_APP_BUILD='2026-07-24-b555'"), 'app build version was not bumped to b555');
