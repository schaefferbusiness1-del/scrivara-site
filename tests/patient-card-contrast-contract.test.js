...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b770'"), 'shared asset version was not bumped to b770');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b770'"), 'app build version was not bumped to b770');
