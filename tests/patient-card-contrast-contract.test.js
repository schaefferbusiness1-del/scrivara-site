...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b291'"), 'shared asset version was not bumped to b291');
assert(source.includes("var MLS_APP_BUILD='2026-07-15-b291'"), 'app build version was not bumped to b291');
