...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b355'"), 'shared asset version was not bumped to b355');
assert(source.includes("var MLS_APP_BUILD='2026-07-16-b355'"), 'app build version was not bumped to b355');
