...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b933'"), 'shared asset version was not bumped to b933');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b933'"), 'app build version was not bumped to b933');
