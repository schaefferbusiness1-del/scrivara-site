...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b1028'"), 'shared asset version was not bumped to b1028');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b1028'"), 'app build version was not bumped to b1028');
