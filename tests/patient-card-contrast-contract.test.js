...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b1018'"), 'shared asset version was not bumped to b1018');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b1018'"), 'app build version was not bumped to b1018');
