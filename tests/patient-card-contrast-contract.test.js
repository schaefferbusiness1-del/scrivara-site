...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b479'"), 'shared asset version was not bumped to b479');
assert(source.includes("var MLS_APP_BUILD='2026-07-21-b479'"), 'app build version was not bumped to b479');
