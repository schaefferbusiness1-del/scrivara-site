...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b537'"), 'shared asset version was not bumped to b537');
assert(source.includes("var MLS_APP_BUILD='2026-07-24-b537'"), 'app build version was not bumped to b537');
