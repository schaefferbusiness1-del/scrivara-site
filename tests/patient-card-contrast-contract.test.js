...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b378'"), 'shared asset version was not bumped to b378');
assert(source.includes("var MLS_APP_BUILD='2026-07-17-b378'"), 'app build version was not bumped to b378');
