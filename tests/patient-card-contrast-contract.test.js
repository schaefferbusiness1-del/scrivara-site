...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b515'"), 'shared asset version was not bumped to b515');
assert(source.includes("var MLS_APP_BUILD='2026-07-23-b515'"), 'app build version was not bumped to b515');
