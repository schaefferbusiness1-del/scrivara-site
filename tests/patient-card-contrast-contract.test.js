...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b523'"), 'shared asset version was not bumped to b523');
assert(source.includes("var MLS_APP_BUILD='2026-07-24-b523'"), 'app build version was not bumped to b523');
