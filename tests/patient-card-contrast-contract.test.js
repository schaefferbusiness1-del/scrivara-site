...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b510'"), 'shared asset version was not bumped to b510');
assert(source.includes("var MLS_APP_BUILD='2026-07-23-b510'"), 'app build version was not bumped to b510');
