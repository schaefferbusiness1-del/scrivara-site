...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b411'"), 'shared asset version was not bumped to b411');
assert(source.includes("var MLS_APP_BUILD='2026-07-18-b411'"), 'app build version was not bumped to b411');
