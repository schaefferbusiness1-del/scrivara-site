...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b964'"), 'shared asset version was not bumped to b964');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b964'"), 'app build version was not bumped to b964');
