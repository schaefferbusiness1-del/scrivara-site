...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b978'"), 'shared asset version was not bumped to b978');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b978'"), 'app build version was not bumped to b978');
