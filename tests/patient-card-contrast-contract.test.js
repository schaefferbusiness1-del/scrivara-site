...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b393'"), 'shared asset version was not bumped to b393');
assert(source.includes("var MLS_APP_BUILD='2026-07-17-b393'"), 'app build version was not bumped to b393');
