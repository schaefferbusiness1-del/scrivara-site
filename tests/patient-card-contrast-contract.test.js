...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b566'"), 'shared asset version was not bumped to b566');
assert(source.includes("var MLS_APP_BUILD='2026-07-24-b566'"), 'app build version was not bumped to b566');
