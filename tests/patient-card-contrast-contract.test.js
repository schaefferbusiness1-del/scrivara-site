...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b433'"), 'shared asset version was not bumped to b433');
assert(source.includes("var MLS_APP_BUILD='2026-07-19-b433'"), 'app build version was not bumped to b433');
