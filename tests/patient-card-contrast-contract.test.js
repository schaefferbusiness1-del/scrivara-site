...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b962'"), 'shared asset version was not bumped to b962');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b962'"), 'app build version was not bumped to b962');
