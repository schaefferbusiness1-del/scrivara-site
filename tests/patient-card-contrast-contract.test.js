...
assert(source.includes("window.__MLS_AV = window.__MLS_AV || 'b807'"), 'shared asset version was not bumped to b807');
assert(source.includes("var MLS_APP_BUILD='2026-07-25-b807'"), 'app build version was not bumped to b807');
