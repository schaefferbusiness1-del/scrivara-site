...
async function main() {
  ...
  assert(connect.includes('feat_mls_opnote_integrity.js?v=20260722oni281'), 'production does not load the final op-note integrity owner');
  assert(stagingConnect.includes('feat_mls_opnote_integrity.js?v=20260722oni281'), 'staging does not load the same op-note integrity owner');
