...
assert(source.includes("var VERSION = 't3-1.0.7'"), 'Visit identity owner version was not advanced');
...
assert(connect.includes('A+"?v=20260723t3108"'), 'Visit identity owner loader is not explicitly cache-busted');
