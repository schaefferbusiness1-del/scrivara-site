...
assert(source.includes("var VERSION = 't3-1.0.6'"), 'Visit identity owner version was not advanced');
assert(connect.includes('A+"?v=20260716t3106"'), 'Visit identity owner loader is not explicitly cache-busted');
