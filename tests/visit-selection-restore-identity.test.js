...
assert(source.includes("var VERSION = 't3-p1-1.2.0'"), 'Visit identity owner must publish the promoted P1 exact-census version');
...
assert(connect.includes('V="t3-p1-1.2.0"') && connect.includes('s.src=SRC+"?v="+(window.__MLS_AV||"p1-preview")'),
  'Visit identity owner loader must use the same promoted version and the shared release cache token');
