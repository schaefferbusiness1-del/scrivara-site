...
assert(source.includes("var VERSION = 't3-1.0.8'"), 'Visit identity owner version was not advanced');
...
assert(connect.includes('A+"?v=20260727t3109"'), 'Visit identity owner loader is not explicitly cache-busted');
