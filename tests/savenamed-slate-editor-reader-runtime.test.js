...
// 3.0.127: bannernames-1.0.0 (either name athena prints on the banner) on top of 3.0.126; native persistence remains verified.
assert.strictEqual(manifest.version, '3.0.127', 'regression must exercise the 3.0.127 candidate');
