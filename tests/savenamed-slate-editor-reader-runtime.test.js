...
// 3.0.123: unique first/last+DOB identity; native persistence remains verified.
assert.strictEqual(manifest.version, '3.0.123', 'regression must exercise the 3.0.123 candidate');
