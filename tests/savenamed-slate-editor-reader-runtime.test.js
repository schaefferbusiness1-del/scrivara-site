...
// 3.0.124: identity recovery parity; native persistence remains verified.
assert.strictEqual(manifest.version, '3.0.124', 'regression must exercise the 3.0.124 candidate');
