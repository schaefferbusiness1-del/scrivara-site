...
// 3.0.119 (2026-09-12): candidate pin moved with exact-row recovery;
// the write reader remains unchanged from the visit-census release.
assert.strictEqual(manifest.version, '3.0.119', 'regression must exercise the 3.0.119 candidate');
