...
assert(/id=["']dl["'][^>]*href=["']MLS_Assist_v3.0.53.zip["']/i.test(downloadPage) && !/candidate package withheld/i.test(downloadPage),
  'manual download must offer exactly the stamped released package (owner directive 2026-07-20)');
assert(/cd89ee7ed85528061ef7019821d644b6dcec74e433b1fd2249afad435aa09414/.test(downloadPage),
