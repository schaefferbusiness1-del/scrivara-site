...
async function verifyLoaderRuntime() {
  ...
  assert.strictEqual(success.mainScripts[0].src, 'mls-connect.js?v=b681', 'main UI script is not exact-versioned');
  ...
  assert.strictEqual(success.mainScripts[0].source, 'mls-connect.js?v=b681');
