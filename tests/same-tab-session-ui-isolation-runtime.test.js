...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b508'"), 'web asset stamp changed from b508');
assert(read('sw.js').includes("const CACHE = 'mls-v94'"), 'service-worker cache stamp changed from v64');
