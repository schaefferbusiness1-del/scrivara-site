...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1337'"), 'web asset stamp changed from b1337');
assert(read('sw.js').includes("const CACHE = 'mls-v352'"), 'service-worker cache stamp changed from v297');
