...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b486'"), 'web asset stamp changed from b486');
assert(read('sw.js').includes("const CACHE = 'mls-v73'"), 'service-worker cache stamp changed from v64');
