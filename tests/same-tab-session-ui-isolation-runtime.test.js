...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b485'"), 'web asset stamp changed from b485');
assert(read('sw.js').includes("const CACHE = 'mls-v72'"), 'service-worker cache stamp changed from v64');
