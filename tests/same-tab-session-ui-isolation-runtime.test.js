...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b504'"), 'web asset stamp changed from b504');
assert(read('sw.js').includes("const CACHE = 'mls-v90'"), 'service-worker cache stamp changed from v64');
