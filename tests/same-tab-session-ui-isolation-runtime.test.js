...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b559'"), 'web asset stamp changed from b559');
assert(read('sw.js').includes("const CACHE = 'mls-v141'"), 'service-worker cache stamp changed from v64');
