...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b501'"), 'web asset stamp changed from b501');
assert(read('sw.js').includes("const CACHE = 'mls-v87'"), 'service-worker cache stamp changed from v64');
