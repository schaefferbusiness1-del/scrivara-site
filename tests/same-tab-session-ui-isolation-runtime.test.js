...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b494'"), 'web asset stamp changed from b494');
assert(read('sw.js').includes("const CACHE = 'mls-v81'"), 'service-worker cache stamp changed from v64');
