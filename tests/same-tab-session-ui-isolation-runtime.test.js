...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b650'"), 'web asset stamp changed from b650');
assert(read('sw.js').includes("const CACHE = 'mls-v174'"), 'service-worker cache stamp changed from v64');
