...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1324'"), 'web asset stamp changed from b1324');
assert(read('sw.js').includes("const CACHE = 'mls-v339'"), 'service-worker cache stamp changed from v297');
