...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b507'"), 'web asset stamp changed from b507');
assert(read('sw.js').includes("const CACHE = 'mls-v93'"), 'service-worker cache stamp changed from v64');
