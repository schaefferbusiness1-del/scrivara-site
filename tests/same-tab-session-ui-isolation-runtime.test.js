...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1291'"), 'web asset stamp changed from b1291');
assert(read('sw.js').includes("const CACHE = 'mls-v306'"), 'service-worker cache stamp changed from v297');
