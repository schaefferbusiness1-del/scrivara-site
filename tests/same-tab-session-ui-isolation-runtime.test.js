...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b472'"), 'web asset stamp changed from b434');
assert(read('sw.js').includes("const CACHE = 'mls-v59'"), 'service-worker cache stamp changed from v22');
