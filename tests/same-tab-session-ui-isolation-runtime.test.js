...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b861'"), 'web asset stamp changed from b861');
assert(read('sw.js').includes("const CACHE = 'mls-v195'"), 'service-worker cache stamp changed from v64');
