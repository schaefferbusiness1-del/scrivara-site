...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b537'"), 'web asset stamp changed from b537');
assert(read('sw.js').includes("const CACHE = 'mls-v119'"), 'service-worker cache stamp changed from v64');
