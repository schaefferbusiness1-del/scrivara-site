...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b492'"), 'web asset stamp changed from b492');
assert(read('sw.js').includes("const CACHE = 'mls-v79'"), 'service-worker cache stamp changed from v64');
