...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b430'"), 'web asset stamp changed from b430');
assert(read('sw.js').includes("const CACHE = 'mls-v18'"), 'service-worker cache stamp changed from v18');
