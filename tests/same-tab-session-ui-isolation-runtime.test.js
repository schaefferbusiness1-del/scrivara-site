...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1327'"), 'web asset stamp changed from b1327');
assert(read('sw.js').includes("const CACHE = 'mls-v342'"), 'service-worker cache stamp changed from v297');
