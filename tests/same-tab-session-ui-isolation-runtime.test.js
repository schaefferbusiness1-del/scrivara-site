...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1326'"), 'web asset stamp changed from b1326');
assert(read('sw.js').includes("const CACHE = 'mls-v341'"), 'service-worker cache stamp changed from v297');
