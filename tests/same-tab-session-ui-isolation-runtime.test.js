...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1272'"), 'web asset stamp changed from b1272');
assert(read('sw.js').includes("const CACHE = 'mls-v287'"), 'service-worker cache stamp changed from v287');
