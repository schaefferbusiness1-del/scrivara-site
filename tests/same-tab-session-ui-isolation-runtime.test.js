...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1303'"), 'web asset stamp changed from b1303');
assert(read('sw.js').includes("const CACHE = 'mls-v318'"), 'service-worker cache stamp changed from v297');
