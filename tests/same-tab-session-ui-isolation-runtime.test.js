...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b574'"), 'web asset stamp changed from b574');
assert(read('sw.js').includes("const CACHE = 'mls-v156'"), 'service-worker cache stamp changed from v64');
