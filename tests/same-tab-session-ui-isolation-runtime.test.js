...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1081'"), 'web asset stamp changed from b1081');
assert(read('sw.js').includes("const CACHE = 'mls-v218'"), 'service-worker cache stamp changed from v206');
