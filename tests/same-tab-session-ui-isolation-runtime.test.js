...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b511'"), 'web asset stamp changed from b511');
assert(read('sw.js').includes("const CACHE = 'mls-v97'"), 'service-worker cache stamp changed from v64');
