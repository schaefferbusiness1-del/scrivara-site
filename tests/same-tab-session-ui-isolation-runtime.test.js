...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b557'"), 'web asset stamp changed from b557');
assert(read('sw.js').includes("const CACHE = 'mls-v139'"), 'service-worker cache stamp changed from v64');
