...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b519'"), 'web asset stamp changed from b519');
assert(read('sw.js').includes("const CACHE = 'mls-v105'"), 'service-worker cache stamp changed from v64');
