...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b482'"), 'web asset stamp changed from b482');
assert(read('sw.js').includes("const CACHE = 'mls-v69'"), 'service-worker cache stamp changed from v64');
