...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1070'"), 'web asset stamp changed from b1070');
assert(read('sw.js').includes("const CACHE = 'mls-v207'"), 'service-worker cache stamp changed from v206');
