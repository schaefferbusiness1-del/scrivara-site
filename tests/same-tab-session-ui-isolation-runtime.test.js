...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b577'"), 'web asset stamp changed from b577');
assert(read('sw.js').includes("const CACHE = 'mls-v159'"), 'service-worker cache stamp changed from v64');
