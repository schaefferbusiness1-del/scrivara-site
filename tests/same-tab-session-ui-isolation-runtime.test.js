...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b483'"), 'web asset stamp changed from b483');
assert(read('sw.js').includes("const CACHE = 'mls-v70'"), 'service-worker cache stamp changed from v64');
