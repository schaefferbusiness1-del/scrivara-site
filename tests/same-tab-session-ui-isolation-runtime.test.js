...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1297'"), 'web asset stamp changed from b1297');
assert(read('sw.js').includes("const CACHE = 'mls-v312'"), 'service-worker cache stamp changed from v297');
