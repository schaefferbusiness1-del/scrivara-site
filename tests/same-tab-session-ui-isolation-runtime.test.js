...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b495'"), 'web asset stamp changed from b495');
assert(read('sw.js').includes("const CACHE = 'mls-v82'"), 'service-worker cache stamp changed from v64');
