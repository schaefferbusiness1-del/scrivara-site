...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b538'"), 'web asset stamp changed from b538');
assert(read('sw.js').includes("const CACHE = 'mls-v120'"), 'service-worker cache stamp changed from v64');
