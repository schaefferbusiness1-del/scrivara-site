...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1339'"), 'web asset stamp changed from b1339');
assert(read('sw.js').includes("const CACHE = 'mls-v354'"), 'service-worker cache stamp changed from v297');
