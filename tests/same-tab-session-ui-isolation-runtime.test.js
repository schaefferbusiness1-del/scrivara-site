...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1228'"), 'web asset stamp changed from b1228');
assert(read('sw.js').includes("const CACHE = 'mls-v243'"), 'service-worker cache stamp changed from v206');
