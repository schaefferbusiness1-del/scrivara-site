...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1226'"), 'web asset stamp changed from b1226');
assert(read('sw.js').includes("const CACHE = 'mls-v241'"), 'service-worker cache stamp changed from v206');
