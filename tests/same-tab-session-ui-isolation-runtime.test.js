...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1263'"), 'web asset stamp changed from b1263');
assert(read('sw.js').includes("const CACHE = 'mls-v278'"), 'service-worker cache stamp changed from v278');
