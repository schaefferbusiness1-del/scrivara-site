...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b500'"), 'web asset stamp changed from b500');
assert(read('sw.js').includes("const CACHE = 'mls-v86'"), 'service-worker cache stamp changed from v64');
