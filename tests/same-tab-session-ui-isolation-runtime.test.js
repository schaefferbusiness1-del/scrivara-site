...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b478'"), 'web asset stamp changed from b478');
assert(read('sw.js').includes("const CACHE = 'mls-v65'"), 'service-worker cache stamp changed from v64');
