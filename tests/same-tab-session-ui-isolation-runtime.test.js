...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b568'"), 'web asset stamp changed from b568');
assert(read('sw.js').includes("const CACHE = 'mls-v150'"), 'service-worker cache stamp changed from v64');
