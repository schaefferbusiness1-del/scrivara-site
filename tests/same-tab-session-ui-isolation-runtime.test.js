...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b487'"), 'web asset stamp changed from b487');
assert(read('sw.js').includes("const CACHE = 'mls-v74'"), 'service-worker cache stamp changed from v64');
