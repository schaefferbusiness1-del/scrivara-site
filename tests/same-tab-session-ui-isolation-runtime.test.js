...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1210'"), 'web asset stamp changed from b1210');
assert(read('sw.js').includes("const CACHE = 'mls-v225'"), 'service-worker cache stamp changed from v206');
