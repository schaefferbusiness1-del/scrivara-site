...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1224'"), 'web asset stamp changed from b1224');
assert(read('sw.js').includes("const CACHE = 'mls-v239'"), 'service-worker cache stamp changed from v206');
