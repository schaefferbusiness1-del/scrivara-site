...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b513'"), 'web asset stamp changed from b513');
assert(read('sw.js').includes("const CACHE = 'mls-v99'"), 'service-worker cache stamp changed from v64');
