...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1334'"), 'web asset stamp changed from b1334');
assert(read('sw.js').includes("const CACHE = 'mls-v349'"), 'service-worker cache stamp changed from v297');
