...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b469'"), 'web asset stamp changed from b434');
assert(read('sw.js').includes("const CACHE = 'mls-v56'"), 'service-worker cache stamp changed from v22');
