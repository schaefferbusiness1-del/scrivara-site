...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1287'"), 'web asset stamp changed from b1287');
assert(read('sw.js').includes("const CACHE = 'mls-v302'"), 'service-worker cache stamp changed from v297');
