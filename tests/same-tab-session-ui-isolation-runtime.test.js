...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1336'"), 'web asset stamp changed from b1336');
assert(read('sw.js').includes("const CACHE = 'mls-v351'"), 'service-worker cache stamp changed from v297');
