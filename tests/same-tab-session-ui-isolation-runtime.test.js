...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b553'"), 'web asset stamp changed from b553');
assert(read('sw.js').includes("const CACHE = 'mls-v135'"), 'service-worker cache stamp changed from v64');
