...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1253'"), 'web asset stamp changed from b1253');
assert(read('sw.js').includes("const CACHE = 'mls-v268'"), 'service-worker cache stamp changed from v268');
