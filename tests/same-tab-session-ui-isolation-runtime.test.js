...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b491'"), 'web asset stamp changed from b491');
assert(read('sw.js').includes("const CACHE = 'mls-v78'"), 'service-worker cache stamp changed from v64');
