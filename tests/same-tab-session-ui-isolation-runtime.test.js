...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1279'"), 'web asset stamp changed from b1279');
assert(read('sw.js').includes("const CACHE = 'mls-v294'"), 'service-worker cache stamp changed from v294');
