...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b433'"), 'web asset stamp changed from b433');
assert(read('sw.js').includes("const CACHE = 'mls-v21'"), 'service-worker cache stamp changed from v21');
