...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1338'"), 'web asset stamp changed from b1338');
assert(read('sw.js').includes("const CACHE = 'mls-v353'"), 'service-worker cache stamp changed from v297');
