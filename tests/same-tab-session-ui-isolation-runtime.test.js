...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1237'"), 'web asset stamp changed from b1237');
assert(read('sw.js').includes("const CACHE = 'mls-v252'"), 'service-worker cache stamp changed from v252');
