...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b488'"), 'web asset stamp changed from b488');
assert(read('sw.js').includes("const CACHE = 'mls-v75'"), 'service-worker cache stamp changed from v64');
