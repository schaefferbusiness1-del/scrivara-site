...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b476'"), 'web asset stamp changed from b434');
assert(read('sw.js').includes("const CACHE = 'mls-v63'"), 'service-worker cache stamp changed from v22');
