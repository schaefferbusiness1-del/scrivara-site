...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1283'"), 'web asset stamp changed from b1283');
assert(read('sw.js').includes("const CACHE = 'mls-v298'"), 'service-worker cache stamp changed from v297');
