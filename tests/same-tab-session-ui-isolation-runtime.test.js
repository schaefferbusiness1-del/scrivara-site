...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b551'"), 'web asset stamp changed from b551');
assert(read('sw.js').includes("const CACHE = 'mls-v133'"), 'service-worker cache stamp changed from v64');
