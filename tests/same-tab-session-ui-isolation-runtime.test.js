...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b435'"), 'web asset stamp changed from b434');
assert(read('sw.js').includes("const CACHE = 'mls-v23'"), 'service-worker cache stamp changed from v22');
