...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b441'"), 'web asset stamp changed from b434');
assert(read('sw.js').includes("const CACHE = 'mls-v29'"), 'service-worker cache stamp changed from v22');
