...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b663'"), 'web asset stamp changed from b663');
assert(read('sw.js').includes("const CACHE = 'mls-v184'"), 'service-worker cache stamp changed from v64');
