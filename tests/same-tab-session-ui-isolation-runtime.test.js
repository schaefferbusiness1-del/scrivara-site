...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b533'"), 'web asset stamp changed from b533');
assert(read('sw.js').includes("const CACHE = 'mls-v115'"), 'service-worker cache stamp changed from v64');
