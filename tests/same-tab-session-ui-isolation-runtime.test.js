...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1288'"), 'web asset stamp changed from b1288');
assert(read('sw.js').includes("const CACHE = 'mls-v303'"), 'service-worker cache stamp changed from v297');
