...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b658'"), 'web asset stamp changed from b658');
assert(read('sw.js').includes("const CACHE = 'mls-v181'"), 'service-worker cache stamp changed from v64');
