...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1304'"), 'web asset stamp changed from b1304');
assert(read('sw.js').includes("const CACHE = 'mls-v319'"), 'service-worker cache stamp changed from v297');
