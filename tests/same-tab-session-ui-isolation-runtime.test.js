...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1227'"), 'web asset stamp changed from b1227');
assert(read('sw.js').includes("const CACHE = 'mls-v242'"), 'service-worker cache stamp changed from v206');
