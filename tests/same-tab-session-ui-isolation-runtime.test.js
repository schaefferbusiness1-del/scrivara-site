...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1277'"), 'web asset stamp changed from b1277');
assert(read('sw.js').includes("const CACHE = 'mls-v292'"), 'service-worker cache stamp changed from v292');
