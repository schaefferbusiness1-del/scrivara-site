...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1331'"), 'web asset stamp changed from b1331');
assert(read('sw.js').includes("const CACHE = 'mls-v346'"), 'service-worker cache stamp changed from v297');
