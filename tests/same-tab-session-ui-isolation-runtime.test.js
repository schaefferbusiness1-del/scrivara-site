...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b858'"), 'web asset stamp changed from b858');
assert(read('sw.js').includes("const CACHE = 'mls-v193'"), 'service-worker cache stamp changed from v64');
