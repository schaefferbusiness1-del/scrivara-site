...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1310'"), 'web asset stamp changed from b1310');
assert(read('sw.js').includes("const CACHE = 'mls-v325'"), 'service-worker cache stamp changed from v297');
