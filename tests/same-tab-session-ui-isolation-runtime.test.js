...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1259'"), 'web asset stamp changed from b1259');
assert(read('sw.js').includes("const CACHE = 'mls-v274'"), 'service-worker cache stamp changed from v274');
