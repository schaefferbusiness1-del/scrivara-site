...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1257'"), 'web asset stamp changed from b1257');
assert(read('sw.js').includes("const CACHE = 'mls-v272'"), 'service-worker cache stamp changed from v272');
