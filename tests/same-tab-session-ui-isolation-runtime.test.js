...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1230'"), 'web asset stamp changed from b1230');
assert(read('sw.js').includes("const CACHE = 'mls-v245'"), 'service-worker cache stamp changed from v245');
