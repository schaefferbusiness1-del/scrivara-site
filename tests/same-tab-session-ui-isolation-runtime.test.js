...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1071'"), 'web asset stamp changed from b1071');
assert(read('sw.js').includes("const CACHE = 'mls-v208'"), 'service-worker cache stamp changed from v206');
