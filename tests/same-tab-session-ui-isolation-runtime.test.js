...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b854'"), 'web asset stamp changed from b854');
assert(read('sw.js').includes("const CACHE = 'mls-v189'"), 'service-worker cache stamp changed from v64');
