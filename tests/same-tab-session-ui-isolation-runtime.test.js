...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1072'"), 'web asset stamp changed from b1072');
assert(read('sw.js').includes("const CACHE = 'mls-v209'"), 'service-worker cache stamp changed from v206');
