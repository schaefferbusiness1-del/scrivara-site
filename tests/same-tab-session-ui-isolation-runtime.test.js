...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b543'"), 'web asset stamp changed from b543');
assert(read('sw.js').includes("const CACHE = 'mls-v125'"), 'service-worker cache stamp changed from v64');
