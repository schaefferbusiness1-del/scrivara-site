...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1214'"), 'web asset stamp changed from b1214');
assert(read('sw.js').includes("const CACHE = 'mls-v229'"), 'service-worker cache stamp changed from v206');
