...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b556'"), 'web asset stamp changed from b556');
assert(read('sw.js').includes("const CACHE = 'mls-v138'"), 'service-worker cache stamp changed from v64');
