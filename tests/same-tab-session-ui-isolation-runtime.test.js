...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b569'"), 'web asset stamp changed from b569');
assert(read('sw.js').includes("const CACHE = 'mls-v151'"), 'service-worker cache stamp changed from v64');
