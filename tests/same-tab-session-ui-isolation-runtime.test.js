...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1254'"), 'web asset stamp changed from b1254');
assert(read('sw.js').includes("const CACHE = 'mls-v269'"), 'service-worker cache stamp changed from v269');
