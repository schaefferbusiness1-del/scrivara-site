...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b558'"), 'web asset stamp changed from b558');
assert(read('sw.js').includes("const CACHE = 'mls-v140'"), 'service-worker cache stamp changed from v64');
