...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b477'"), 'web asset stamp changed from b477');
assert(read('sw.js').includes("const CACHE = 'mls-v64'"), 'service-worker cache stamp changed from v64');
