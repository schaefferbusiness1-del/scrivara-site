...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1078'"), 'web asset stamp changed from b1078');
assert(read('sw.js').includes("const CACHE = 'mls-v215'"), 'service-worker cache stamp changed from v206');
