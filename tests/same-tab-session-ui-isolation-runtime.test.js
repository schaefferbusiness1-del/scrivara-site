...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b516'"), 'web asset stamp changed from b516');
assert(read('sw.js').includes("const CACHE = 'mls-v102'"), 'service-worker cache stamp changed from v64');
