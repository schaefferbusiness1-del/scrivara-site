...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b530'"), 'web asset stamp changed from b530');
assert(read('sw.js').includes("const CACHE = 'mls-v112'"), 'service-worker cache stamp changed from v64');
