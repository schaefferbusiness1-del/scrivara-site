...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b859'"), 'web asset stamp changed from b859');
assert(read('sw.js').includes("const CACHE = 'mls-v194'"), 'service-worker cache stamp changed from v64');
