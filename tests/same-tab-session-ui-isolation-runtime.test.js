...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1308'"), 'web asset stamp changed from b1308');
assert(read('sw.js').includes("const CACHE = 'mls-v323'"), 'service-worker cache stamp changed from v297');
