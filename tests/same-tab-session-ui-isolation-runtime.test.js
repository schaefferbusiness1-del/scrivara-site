...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1083'"), 'web asset stamp changed from b1083');
assert(read('sw.js').includes("const CACHE = 'mls-v220'"), 'service-worker cache stamp changed from v206');
