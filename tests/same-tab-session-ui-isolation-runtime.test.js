...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b524'"), 'web asset stamp changed from b524');
assert(read('sw.js').includes("const CACHE = 'mls-v110'"), 'service-worker cache stamp changed from v64');
