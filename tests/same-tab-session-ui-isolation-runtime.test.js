...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b503'"), 'web asset stamp changed from b503');
assert(read('sw.js').includes("const CACHE = 'mls-v89'"), 'service-worker cache stamp changed from v64');
