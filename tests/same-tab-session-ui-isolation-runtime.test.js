...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1321'"), 'web asset stamp changed from b1321');
assert(read('sw.js').includes("const CACHE = 'mls-v336'"), 'service-worker cache stamp changed from v297');
