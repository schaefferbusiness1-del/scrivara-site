...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b490'"), 'web asset stamp changed from b490');
assert(read('sw.js').includes("const CACHE = 'mls-v77'"), 'service-worker cache stamp changed from v64');
