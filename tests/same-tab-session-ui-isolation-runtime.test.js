...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1300'"), 'web asset stamp changed from b1300');
assert(read('sw.js').includes("const CACHE = 'mls-v315'"), 'service-worker cache stamp changed from v297');
