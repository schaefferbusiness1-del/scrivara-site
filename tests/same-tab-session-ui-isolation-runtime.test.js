...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1330'"), 'web asset stamp changed from b1330');
assert(read('sw.js').includes("const CACHE = 'mls-v345'"), 'service-worker cache stamp changed from v297');
