...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b636'"), 'web asset stamp changed from b636');
assert(read('sw.js').includes("const CACHE = 'mls-v170'"), 'service-worker cache stamp changed from v64');
