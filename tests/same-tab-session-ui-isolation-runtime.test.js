...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1245'"), 'web asset stamp changed from b1245');
assert(read('sw.js').includes("const CACHE = 'mls-v260'"), 'service-worker cache stamp changed from v260');
