...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b496'"), 'web asset stamp changed from b496');
assert(read('sw.js').includes("const CACHE = 'mls-v83'"), 'service-worker cache stamp changed from v64');
