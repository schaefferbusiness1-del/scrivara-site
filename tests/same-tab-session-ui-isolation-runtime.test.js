...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1074'"), 'web asset stamp changed from b1074');
assert(read('sw.js').includes("const CACHE = 'mls-v211'"), 'service-worker cache stamp changed from v206');
