...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1322'"), 'web asset stamp changed from b1322');
assert(read('sw.js').includes("const CACHE = 'mls-v337'"), 'service-worker cache stamp changed from v297');
