...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1220'"), 'web asset stamp changed from b1220');
assert(read('sw.js').includes("const CACHE = 'mls-v235'"), 'service-worker cache stamp changed from v206');
