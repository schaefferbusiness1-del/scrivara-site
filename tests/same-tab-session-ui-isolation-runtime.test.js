...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b542'"), 'web asset stamp changed from b542');
assert(read('sw.js').includes("const CACHE = 'mls-v124'"), 'service-worker cache stamp changed from v64');
