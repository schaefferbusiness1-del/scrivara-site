...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1084'"), 'web asset stamp changed from b1084');
assert(read('sw.js').includes("const CACHE = 'mls-v221'"), 'service-worker cache stamp changed from v206');
