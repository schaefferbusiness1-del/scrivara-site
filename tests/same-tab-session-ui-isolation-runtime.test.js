...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1234'"), 'web asset stamp changed from b1234');
assert(read('sw.js').includes("const CACHE = 'mls-v249'"), 'service-worker cache stamp changed from v249');
