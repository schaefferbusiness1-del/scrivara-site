...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1271'"), 'web asset stamp changed from b1271');
assert(read('sw.js').includes("const CACHE = 'mls-v286'"), 'service-worker cache stamp changed from v286');
