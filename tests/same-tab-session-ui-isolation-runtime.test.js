...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b581'"), 'web asset stamp changed from b581');
assert(read('sw.js').includes("const CACHE = 'mls-v163'"), 'service-worker cache stamp changed from v64');
