...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1290'"), 'web asset stamp changed from b1290');
assert(read('sw.js').includes("const CACHE = 'mls-v305'"), 'service-worker cache stamp changed from v297');
