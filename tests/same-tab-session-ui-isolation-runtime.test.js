...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1295'"), 'web asset stamp changed from b1295');
assert(read('sw.js').includes("const CACHE = 'mls-v310'"), 'service-worker cache stamp changed from v297');
