...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1292'"), 'web asset stamp changed from b1292');
assert(read('sw.js').includes("const CACHE = 'mls-v307'"), 'service-worker cache stamp changed from v297');
