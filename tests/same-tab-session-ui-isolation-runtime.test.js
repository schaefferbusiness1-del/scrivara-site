...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1278'"), 'web asset stamp changed from b1278');
assert(read('sw.js').includes("const CACHE = 'mls-v293'"), 'service-worker cache stamp changed from v293');
