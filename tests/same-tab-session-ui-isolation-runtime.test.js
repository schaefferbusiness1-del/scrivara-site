...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b652'"), 'web asset stamp changed from b652');
assert(read('sw.js').includes("const CACHE = 'mls-v175'"), 'service-worker cache stamp changed from v64');
