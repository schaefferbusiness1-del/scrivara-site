...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1311'"), 'web asset stamp changed from b1311');
assert(read('sw.js').includes("const CACHE = 'mls-v326'"), 'service-worker cache stamp changed from v297');
