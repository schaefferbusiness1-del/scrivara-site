...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1079'"), 'web asset stamp changed from b1079');
assert(read('sw.js').includes("const CACHE = 'mls-v216'"), 'service-worker cache stamp changed from v206');
