...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1076'"), 'web asset stamp changed from b1076');
assert(read('sw.js').includes("const CACHE = 'mls-v213'"), 'service-worker cache stamp changed from v206');
