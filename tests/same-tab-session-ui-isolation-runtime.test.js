...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1315'"), 'web asset stamp changed from b1315');
assert(read('sw.js').includes("const CACHE = 'mls-v330'"), 'service-worker cache stamp changed from v297');
