...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1296'"), 'web asset stamp changed from b1296');
assert(read('sw.js').includes("const CACHE = 'mls-v311'"), 'service-worker cache stamp changed from v297');
