...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b643'"), 'web asset stamp changed from b643');
assert(read('sw.js').includes("const CACHE = 'mls-v171'"), 'service-worker cache stamp changed from v64');
