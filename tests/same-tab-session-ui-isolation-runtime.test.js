...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1212'"), 'web asset stamp changed from b1212');
assert(read('sw.js').includes("const CACHE = 'mls-v227'"), 'service-worker cache stamp changed from v206');
