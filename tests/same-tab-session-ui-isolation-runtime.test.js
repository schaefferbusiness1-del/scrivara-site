...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b623'"), 'web asset stamp changed from b623');
assert(read('sw.js').includes("const CACHE = 'mls-v169'"), 'service-worker cache stamp changed from v64');
