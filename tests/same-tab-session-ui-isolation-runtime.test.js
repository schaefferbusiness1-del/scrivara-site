...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b431'"), 'web asset stamp changed from b431');
assert(read('sw.js').includes("const CACHE = 'mls-v19'"), 'service-worker cache stamp changed from v19');
