...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1239'"), 'web asset stamp changed from b1239');
assert(read('sw.js').includes("const CACHE = 'mls-v254'"), 'service-worker cache stamp changed from v254');
