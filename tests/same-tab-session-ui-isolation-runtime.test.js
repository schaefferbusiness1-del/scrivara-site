...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1073'"), 'web asset stamp changed from b1073');
assert(read('sw.js').includes("const CACHE = 'mls-v210'"), 'service-worker cache stamp changed from v206');
