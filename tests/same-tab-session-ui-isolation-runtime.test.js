...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1301'"), 'web asset stamp changed from b1301');
assert(read('sw.js').includes("const CACHE = 'mls-v316'"), 'service-worker cache stamp changed from v297');
