...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1332'"), 'web asset stamp changed from b1332');
assert(read('sw.js').includes("const CACHE = 'mls-v347'"), 'service-worker cache stamp changed from v297');
