...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b509'"), 'web asset stamp changed from b509');
assert(read('sw.js').includes("const CACHE = 'mls-v95'"), 'service-worker cache stamp changed from v64');
