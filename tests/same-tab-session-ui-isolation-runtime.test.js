...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b573'"), 'web asset stamp changed from b573');
assert(read('sw.js').includes("const CACHE = 'mls-v155'"), 'service-worker cache stamp changed from v64');
