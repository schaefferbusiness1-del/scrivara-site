...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b518'"), 'web asset stamp changed from b518');
assert(read('sw.js').includes("const CACHE = 'mls-v104'"), 'service-worker cache stamp changed from v64');
