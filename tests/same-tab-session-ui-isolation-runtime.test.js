...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1270'"), 'web asset stamp changed from b1270');
assert(read('sw.js').includes("const CACHE = 'mls-v285'"), 'service-worker cache stamp changed from v285');
