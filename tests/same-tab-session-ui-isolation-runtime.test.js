...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b523'"), 'web asset stamp changed from b523');
assert(read('sw.js').includes("const CACHE = 'mls-v109'"), 'service-worker cache stamp changed from v64');
