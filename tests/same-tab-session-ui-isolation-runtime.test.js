...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1264'"), 'web asset stamp changed from b1264');
assert(read('sw.js').includes("const CACHE = 'mls-v279'"), 'service-worker cache stamp changed from v279');
