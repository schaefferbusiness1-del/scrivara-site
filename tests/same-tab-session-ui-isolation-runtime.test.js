...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b539'"), 'web asset stamp changed from b539');
assert(read('sw.js').includes("const CACHE = 'mls-v121'"), 'service-worker cache stamp changed from v64');
