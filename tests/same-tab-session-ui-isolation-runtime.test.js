...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1256'"), 'web asset stamp changed from b1256');
assert(read('sw.js').includes("const CACHE = 'mls-v271'"), 'service-worker cache stamp changed from v271');
