...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1241'"), 'web asset stamp changed from b1241');
assert(read('sw.js').includes("const CACHE = 'mls-v256'"), 'service-worker cache stamp changed from v256');
