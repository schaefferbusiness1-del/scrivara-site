...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b567'"), 'web asset stamp changed from b567');
assert(read('sw.js').includes("const CACHE = 'mls-v149'"), 'service-worker cache stamp changed from v64');
