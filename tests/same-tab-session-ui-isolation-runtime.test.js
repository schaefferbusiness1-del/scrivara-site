...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1216'"), 'web asset stamp changed from b1216');
assert(read('sw.js').includes("const CACHE = 'mls-v231'"), 'service-worker cache stamp changed from v206');
