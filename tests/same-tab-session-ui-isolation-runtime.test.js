...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1219'"), 'web asset stamp changed from b1219');
assert(read('sw.js').includes("const CACHE = 'mls-v234'"), 'service-worker cache stamp changed from v206');
