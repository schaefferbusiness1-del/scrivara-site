...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b547'"), 'web asset stamp changed from b547');
assert(read('sw.js').includes("const CACHE = 'mls-v129'"), 'service-worker cache stamp changed from v64');
