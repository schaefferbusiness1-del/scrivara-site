...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1246'"), 'web asset stamp changed from b1246');
assert(read('sw.js').includes("const CACHE = 'mls-v261'"), 'service-worker cache stamp changed from v261');
