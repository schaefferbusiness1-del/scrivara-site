...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1285'"), 'web asset stamp changed from b1285');
assert(read('sw.js').includes("const CACHE = 'mls-v300'"), 'service-worker cache stamp changed from v297');
