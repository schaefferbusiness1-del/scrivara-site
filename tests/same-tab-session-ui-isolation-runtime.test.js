...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b562'"), 'web asset stamp changed from b562');
assert(read('sw.js').includes("const CACHE = 'mls-v144'"), 'service-worker cache stamp changed from v64');
