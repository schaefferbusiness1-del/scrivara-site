...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1262'"), 'web asset stamp changed from b1262');
assert(read('sw.js').includes("const CACHE = 'mls-v277'"), 'service-worker cache stamp changed from v277');
