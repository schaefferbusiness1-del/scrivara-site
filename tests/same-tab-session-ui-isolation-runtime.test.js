...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1307'"), 'web asset stamp changed from b1307');
assert(read('sw.js').includes("const CACHE = 'mls-v322'"), 'service-worker cache stamp changed from v297');
