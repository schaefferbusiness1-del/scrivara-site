...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b480'"), 'web asset stamp changed from b480');
assert(read('sw.js').includes("const CACHE = 'mls-v67'"), 'service-worker cache stamp changed from v64');
