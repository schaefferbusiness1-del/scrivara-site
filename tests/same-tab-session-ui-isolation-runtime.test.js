...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b548'"), 'web asset stamp changed from b548');
assert(read('sw.js').includes("const CACHE = 'mls-v130'"), 'service-worker cache stamp changed from v64');
