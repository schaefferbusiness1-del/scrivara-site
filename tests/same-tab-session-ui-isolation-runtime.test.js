...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b580'"), 'web asset stamp changed from b580');
assert(read('sw.js').includes("const CACHE = 'mls-v162'"), 'service-worker cache stamp changed from v64');
