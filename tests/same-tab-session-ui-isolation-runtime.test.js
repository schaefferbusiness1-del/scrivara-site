...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b654'"), 'web asset stamp changed from b654');
assert(read('sw.js').includes("const CACHE = 'mls-v177'"), 'service-worker cache stamp changed from v64');
