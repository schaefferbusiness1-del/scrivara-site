...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b489'"), 'web asset stamp changed from b489');
assert(read('sw.js').includes("const CACHE = 'mls-v76'"), 'service-worker cache stamp changed from v64');
