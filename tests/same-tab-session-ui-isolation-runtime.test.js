...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1268'"), 'web asset stamp changed from b1268');
assert(read('sw.js').includes("const CACHE = 'mls-v283'"), 'service-worker cache stamp changed from v283');
