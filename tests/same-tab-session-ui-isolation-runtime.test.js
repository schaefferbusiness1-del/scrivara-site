...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b534'"), 'web asset stamp changed from b534');
assert(read('sw.js').includes("const CACHE = 'mls-v116'"), 'service-worker cache stamp changed from v64');
