...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b617'"), 'web asset stamp changed from b617');
assert(read('sw.js').includes("const CACHE = 'mls-v168'"), 'service-worker cache stamp changed from v64');
