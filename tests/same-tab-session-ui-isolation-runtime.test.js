...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1255'"), 'web asset stamp changed from b1255');
assert(read('sw.js').includes("const CACHE = 'mls-v270'"), 'service-worker cache stamp changed from v270');
