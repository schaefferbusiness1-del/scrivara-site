...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1342'"), 'web asset stamp changed from b1342');
assert(read('sw.js').includes("const CACHE = 'mls-v357'"), 'service-worker cache stamp changed from v297');
