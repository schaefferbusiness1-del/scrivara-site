...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1260'"), 'web asset stamp changed from b1260');
assert(read('sw.js').includes("const CACHE = 'mls-v275'"), 'service-worker cache stamp changed from v275');
