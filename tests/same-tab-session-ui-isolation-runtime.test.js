...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b579'"), 'web asset stamp changed from b579');
assert(read('sw.js').includes("const CACHE = 'mls-v161'"), 'service-worker cache stamp changed from v64');
