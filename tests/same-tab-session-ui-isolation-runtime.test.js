...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1218'"), 'web asset stamp changed from b1218');
assert(read('sw.js').includes("const CACHE = 'mls-v233'"), 'service-worker cache stamp changed from v206');
