...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1302'"), 'web asset stamp changed from b1302');
assert(read('sw.js').includes("const CACHE = 'mls-v317'"), 'service-worker cache stamp changed from v297');
