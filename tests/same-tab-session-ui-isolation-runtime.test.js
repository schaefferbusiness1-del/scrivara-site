...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b497'"), 'web asset stamp changed from b497');
assert(read('sw.js').includes("const CACHE = 'mls-v84'"), 'service-worker cache stamp changed from v64');
