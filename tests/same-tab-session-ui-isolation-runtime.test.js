...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1232'"), 'web asset stamp changed from b1232');
assert(read('sw.js').includes("const CACHE = 'mls-v247'"), 'service-worker cache stamp changed from v247');
