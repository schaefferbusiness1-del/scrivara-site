...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1077'"), 'web asset stamp changed from b1077');
assert(read('sw.js').includes("const CACHE = 'mls-v214'"), 'service-worker cache stamp changed from v206');
