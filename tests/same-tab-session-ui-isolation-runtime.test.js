...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1341'"), 'web asset stamp changed from b1341');
assert(read('sw.js').includes("const CACHE = 'mls-v356'"), 'service-worker cache stamp changed from v297');
