...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b479'"), 'web asset stamp changed from b479');
assert(read('sw.js').includes("const CACHE = 'mls-v66'"), 'service-worker cache stamp changed from v64');
