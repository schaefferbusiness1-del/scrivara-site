...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1082'"), 'web asset stamp changed from b1082');
assert(read('sw.js').includes("const CACHE = 'mls-v219'"), 'service-worker cache stamp changed from v206');
