...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1345'"), 'web asset stamp changed from b1345');
assert(read('sw.js').includes("const CACHE = 'mls-v360'"), 'service-worker cache stamp changed from v297');
