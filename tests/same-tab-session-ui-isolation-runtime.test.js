...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b571'"), 'web asset stamp changed from b571');
assert(read('sw.js').includes("const CACHE = 'mls-v153'"), 'service-worker cache stamp changed from v64');
