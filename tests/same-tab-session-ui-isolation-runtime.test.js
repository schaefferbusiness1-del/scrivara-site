...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1309'"), 'web asset stamp changed from b1309');
assert(read('sw.js').includes("const CACHE = 'mls-v324'"), 'service-worker cache stamp changed from v297');
