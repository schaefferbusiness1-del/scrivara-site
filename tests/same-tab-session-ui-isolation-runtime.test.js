...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1313'"), 'web asset stamp changed from b1313');
assert(read('sw.js').includes("const CACHE = 'mls-v328'"), 'service-worker cache stamp changed from v297');
