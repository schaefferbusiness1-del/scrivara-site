...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b505'"), 'web asset stamp changed from b505');
assert(read('sw.js').includes("const CACHE = 'mls-v91'"), 'service-worker cache stamp changed from v64');
