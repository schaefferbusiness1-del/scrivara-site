...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b583'"), 'web asset stamp changed from b583');
assert(read('sw.js').includes("const CACHE = 'mls-v165'"), 'service-worker cache stamp changed from v64');
