...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1213'"), 'web asset stamp changed from b1213');
assert(read('sw.js').includes("const CACHE = 'mls-v228'"), 'service-worker cache stamp changed from v206');
