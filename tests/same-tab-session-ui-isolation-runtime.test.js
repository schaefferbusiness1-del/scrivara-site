...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b576'"), 'web asset stamp changed from b576');
assert(read('sw.js').includes("const CACHE = 'mls-v158'"), 'service-worker cache stamp changed from v64');
