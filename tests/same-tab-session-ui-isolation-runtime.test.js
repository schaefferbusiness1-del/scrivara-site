...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b532'"), 'web asset stamp changed from b532');
assert(read('sw.js').includes("const CACHE = 'mls-v114'"), 'service-worker cache stamp changed from v64');
