...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1233'"), 'web asset stamp changed from b1233');
assert(read('sw.js').includes("const CACHE = 'mls-v248'"), 'service-worker cache stamp changed from v248');
