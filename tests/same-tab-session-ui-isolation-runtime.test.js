...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b517'"), 'web asset stamp changed from b517');
assert(read('sw.js').includes("const CACHE = 'mls-v103'"), 'service-worker cache stamp changed from v64');
