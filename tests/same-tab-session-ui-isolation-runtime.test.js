...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1312'"), 'web asset stamp changed from b1312');
assert(read('sw.js').includes("const CACHE = 'mls-v327'"), 'service-worker cache stamp changed from v297');
