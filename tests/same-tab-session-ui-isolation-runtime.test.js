...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1252'"), 'web asset stamp changed from b1252');
assert(read('sw.js').includes("const CACHE = 'mls-v267'"), 'service-worker cache stamp changed from v267');
