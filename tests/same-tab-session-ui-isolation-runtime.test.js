...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b582'"), 'web asset stamp changed from b582');
assert(read('sw.js').includes("const CACHE = 'mls-v164'"), 'service-worker cache stamp changed from v64');
