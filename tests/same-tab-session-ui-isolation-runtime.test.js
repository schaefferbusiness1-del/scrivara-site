...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1250'"), 'web asset stamp changed from b1250');
assert(read('sw.js').includes("const CACHE = 'mls-v265'"), 'service-worker cache stamp changed from v265');
