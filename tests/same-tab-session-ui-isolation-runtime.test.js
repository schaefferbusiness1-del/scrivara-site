...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1299'"), 'web asset stamp changed from b1299');
assert(read('sw.js').includes("const CACHE = 'mls-v314'"), 'service-worker cache stamp changed from v297');
