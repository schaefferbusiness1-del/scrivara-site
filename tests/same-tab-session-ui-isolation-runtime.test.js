...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b541'"), 'web asset stamp changed from b541');
assert(read('sw.js').includes("const CACHE = 'mls-v123'"), 'service-worker cache stamp changed from v64');
