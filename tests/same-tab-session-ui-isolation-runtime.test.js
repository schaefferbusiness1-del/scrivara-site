...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1333'"), 'web asset stamp changed from b1333');
assert(read('sw.js').includes("const CACHE = 'mls-v348'"), 'service-worker cache stamp changed from v297');
