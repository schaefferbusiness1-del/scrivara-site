...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1238'"), 'web asset stamp changed from b1238');
assert(read('sw.js').includes("const CACHE = 'mls-v253'"), 'service-worker cache stamp changed from v253');
