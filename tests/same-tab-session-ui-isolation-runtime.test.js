...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1215'"), 'web asset stamp changed from b1215');
assert(read('sw.js').includes("const CACHE = 'mls-v230'"), 'service-worker cache stamp changed from v206');
