...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b584'"), 'web asset stamp changed from b584');
assert(read('sw.js').includes("const CACHE = 'mls-v166'"), 'service-worker cache stamp changed from v64');
