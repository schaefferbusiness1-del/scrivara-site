...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1222'"), 'web asset stamp changed from b1222');
assert(read('sw.js').includes("const CACHE = 'mls-v237'"), 'service-worker cache stamp changed from v206');
