...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b522'"), 'web asset stamp changed from b522');
assert(read('sw.js').includes("const CACHE = 'mls-v108'"), 'service-worker cache stamp changed from v64');
