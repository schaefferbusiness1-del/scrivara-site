...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1247'"), 'web asset stamp changed from b1247');
assert(read('sw.js').includes("const CACHE = 'mls-v262'"), 'service-worker cache stamp changed from v262');
