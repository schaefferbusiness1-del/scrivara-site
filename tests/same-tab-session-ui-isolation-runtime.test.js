...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1343'"), 'web asset stamp changed from b1343');
assert(read('sw.js').includes("const CACHE = 'mls-v358'"), 'service-worker cache stamp changed from v297');
