...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1317'"), 'web asset stamp changed from b1317');
assert(read('sw.js').includes("const CACHE = 'mls-v332'"), 'service-worker cache stamp changed from v297');
