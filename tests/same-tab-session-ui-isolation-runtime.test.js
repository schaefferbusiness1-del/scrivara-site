...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1316'"), 'web asset stamp changed from b1316');
assert(read('sw.js').includes("const CACHE = 'mls-v331'"), 'service-worker cache stamp changed from v297');
