...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b520'"), 'web asset stamp changed from b520');
assert(read('sw.js').includes("const CACHE = 'mls-v106'"), 'service-worker cache stamp changed from v64');
