...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b563'"), 'web asset stamp changed from b563');
assert(read('sw.js').includes("const CACHE = 'mls-v145'"), 'service-worker cache stamp changed from v64');
