...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1261'"), 'web asset stamp changed from b1261');
assert(read('sw.js').includes("const CACHE = 'mls-v276'"), 'service-worker cache stamp changed from v276');
