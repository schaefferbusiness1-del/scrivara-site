...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1269'"), 'web asset stamp changed from b1269');
assert(read('sw.js').includes("const CACHE = 'mls-v284'"), 'service-worker cache stamp changed from v284');
