...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b785'"), 'web asset stamp changed from b785');
assert(read('sw.js').includes("const CACHE = 'mls-v188'"), 'service-worker cache stamp changed from v64');
