...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1335'"), 'web asset stamp changed from b1335');
assert(read('sw.js').includes("const CACHE = 'mls-v350'"), 'service-worker cache stamp changed from v297');
