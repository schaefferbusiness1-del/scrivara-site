...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b564'"), 'web asset stamp changed from b564');
assert(read('sw.js').includes("const CACHE = 'mls-v146'"), 'service-worker cache stamp changed from v64');
