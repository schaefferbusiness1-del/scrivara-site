...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b493'"), 'web asset stamp changed from b493');
assert(read('sw.js').includes("const CACHE = 'mls-v80'"), 'service-worker cache stamp changed from v64');
