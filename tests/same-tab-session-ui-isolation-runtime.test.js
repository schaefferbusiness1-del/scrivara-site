...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1281'"), 'web asset stamp changed from b1281');
assert(read('sw.js').includes("const CACHE = 'mls-v296'"), 'service-worker cache stamp changed from v296');
