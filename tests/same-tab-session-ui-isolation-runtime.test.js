...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1273'"), 'web asset stamp changed from b1273');
assert(read('sw.js').includes("const CACHE = 'mls-v288'"), 'service-worker cache stamp changed from v288');
