...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1267'"), 'web asset stamp changed from b1267');
assert(read('sw.js').includes("const CACHE = 'mls-v282'"), 'service-worker cache stamp changed from v282');
