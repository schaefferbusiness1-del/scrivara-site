...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1305'"), 'web asset stamp changed from b1305');
assert(read('sw.js').includes("const CACHE = 'mls-v320'"), 'service-worker cache stamp changed from v297');
