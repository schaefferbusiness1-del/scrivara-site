...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1294'"), 'web asset stamp changed from b1294');
assert(read('sw.js').includes("const CACHE = 'mls-v309'"), 'service-worker cache stamp changed from v297');
