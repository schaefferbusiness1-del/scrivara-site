...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1328'"), 'web asset stamp changed from b1328');
assert(read('sw.js').includes("const CACHE = 'mls-v343'"), 'service-worker cache stamp changed from v297');
