...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b510'"), 'web asset stamp changed from b510');
assert(read('sw.js').includes("const CACHE = 'mls-v96'"), 'service-worker cache stamp changed from v64');
