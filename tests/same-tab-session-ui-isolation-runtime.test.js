...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b550'"), 'web asset stamp changed from b550');
assert(read('sw.js').includes("const CACHE = 'mls-v132'"), 'service-worker cache stamp changed from v64');
