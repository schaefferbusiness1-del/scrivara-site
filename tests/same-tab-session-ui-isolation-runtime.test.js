...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1280'"), 'web asset stamp changed from b1280');
assert(read('sw.js').includes("const CACHE = 'mls-v295'"), 'service-worker cache stamp changed from v295');
