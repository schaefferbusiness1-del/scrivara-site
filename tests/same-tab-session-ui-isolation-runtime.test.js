...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1282'"), 'web asset stamp changed from b1282');
assert(read('sw.js').includes("const CACHE = 'mls-v297'"), 'service-worker cache stamp changed from v297');
