...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1274'"), 'web asset stamp changed from b1274');
assert(read('sw.js').includes("const CACHE = 'mls-v289'"), 'service-worker cache stamp changed from v289');
