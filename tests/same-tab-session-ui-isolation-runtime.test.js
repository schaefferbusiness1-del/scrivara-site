...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b560'"), 'web asset stamp changed from b560');
assert(read('sw.js').includes("const CACHE = 'mls-v142'"), 'service-worker cache stamp changed from v64');
