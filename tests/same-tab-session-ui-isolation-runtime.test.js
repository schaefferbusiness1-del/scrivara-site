...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1075'"), 'web asset stamp changed from b1075');
assert(read('sw.js').includes("const CACHE = 'mls-v212'"), 'service-worker cache stamp changed from v206');
