...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b498'"), 'web asset stamp changed from b498');
assert(read('sw.js').includes("const CACHE = 'mls-v85'"), 'service-worker cache stamp changed from v64');
