...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1319'"), 'web asset stamp changed from b1319');
assert(read('sw.js').includes("const CACHE = 'mls-v334'"), 'service-worker cache stamp changed from v297');
