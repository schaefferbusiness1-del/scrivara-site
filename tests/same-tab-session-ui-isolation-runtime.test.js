...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1284'"), 'web asset stamp changed from b1284');
assert(read('sw.js').includes("const CACHE = 'mls-v299'"), 'service-worker cache stamp changed from v297');
