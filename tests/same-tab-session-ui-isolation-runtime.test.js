...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b578'"), 'web asset stamp changed from b578');
assert(read('sw.js').includes("const CACHE = 'mls-v160'"), 'service-worker cache stamp changed from v64');
