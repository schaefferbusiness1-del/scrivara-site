...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1221'"), 'web asset stamp changed from b1221');
assert(read('sw.js').includes("const CACHE = 'mls-v236'"), 'service-worker cache stamp changed from v206');
