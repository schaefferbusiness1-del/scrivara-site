...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1293'"), 'web asset stamp changed from b1293');
assert(read('sw.js').includes("const CACHE = 'mls-v308'"), 'service-worker cache stamp changed from v297');
