...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b668'"), 'web asset stamp changed from b668');
assert(read('sw.js').includes("const CACHE = 'mls-v185'"), 'service-worker cache stamp changed from v64');
