...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b514'"), 'web asset stamp changed from b514');
assert(read('sw.js').includes("const CACHE = 'mls-v100'"), 'service-worker cache stamp changed from v64');
