...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1211'"), 'web asset stamp changed from b1211');
assert(read('sw.js').includes("const CACHE = 'mls-v226'"), 'service-worker cache stamp changed from v206');
