...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b552'"), 'web asset stamp changed from b552');
assert(read('sw.js').includes("const CACHE = 'mls-v134'"), 'service-worker cache stamp changed from v64');
