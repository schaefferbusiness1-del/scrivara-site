...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b521'"), 'web asset stamp changed from b521');
assert(read('sw.js').includes("const CACHE = 'mls-v107'"), 'service-worker cache stamp changed from v64');
