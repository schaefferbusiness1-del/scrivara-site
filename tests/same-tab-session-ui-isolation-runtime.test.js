...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b856'"), 'web asset stamp changed from b856');
assert(read('sw.js').includes("const CACHE = 'mls-v191'"), 'service-worker cache stamp changed from v64');
