...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1289'"), 'web asset stamp changed from b1289');
assert(read('sw.js').includes("const CACHE = 'mls-v304'"), 'service-worker cache stamp changed from v297');
