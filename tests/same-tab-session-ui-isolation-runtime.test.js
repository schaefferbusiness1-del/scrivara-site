...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1248'"), 'web asset stamp changed from b1248');
assert(read('sw.js').includes("const CACHE = 'mls-v263'"), 'service-worker cache stamp changed from v263');
