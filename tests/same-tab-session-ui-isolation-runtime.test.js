...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1080'"), 'web asset stamp changed from b1080');
assert(read('sw.js').includes("const CACHE = 'mls-v217'"), 'service-worker cache stamp changed from v206');
