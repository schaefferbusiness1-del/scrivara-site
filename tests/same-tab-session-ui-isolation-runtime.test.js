...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1258'"), 'web asset stamp changed from b1258');
assert(read('sw.js').includes("const CACHE = 'mls-v273'"), 'service-worker cache stamp changed from v273');
