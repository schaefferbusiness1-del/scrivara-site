...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1231'"), 'web asset stamp changed from b1231');
assert(read('sw.js').includes("const CACHE = 'mls-v246'"), 'service-worker cache stamp changed from v246');
