...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1340'"), 'web asset stamp changed from b1340');
assert(read('sw.js').includes("const CACHE = 'mls-v355'"), 'service-worker cache stamp changed from v297');
