...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1249'"), 'web asset stamp changed from b1249');
assert(read('sw.js').includes("const CACHE = 'mls-v264'"), 'service-worker cache stamp changed from v264');
