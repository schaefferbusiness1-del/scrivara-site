...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b669'"), 'web asset stamp changed from b669');
assert(read('sw.js').includes("const CACHE = 'mls-v186'"), 'service-worker cache stamp changed from v64');
