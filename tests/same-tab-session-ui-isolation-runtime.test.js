...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1240'"), 'web asset stamp changed from b1240');
assert(read('sw.js').includes("const CACHE = 'mls-v255'"), 'service-worker cache stamp changed from v255');
