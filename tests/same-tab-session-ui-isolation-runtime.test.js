...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1251'"), 'web asset stamp changed from b1251');
assert(read('sw.js').includes("const CACHE = 'mls-v266'"), 'service-worker cache stamp changed from v266');
