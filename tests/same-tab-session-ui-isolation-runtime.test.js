...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b646'"), 'web asset stamp changed from b646');
assert(read('sw.js').includes("const CACHE = 'mls-v172'"), 'service-worker cache stamp changed from v64');
