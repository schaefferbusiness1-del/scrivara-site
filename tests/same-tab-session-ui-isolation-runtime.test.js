...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b502'"), 'web asset stamp changed from b502');
assert(read('sw.js').includes("const CACHE = 'mls-v88'"), 'service-worker cache stamp changed from v64');
