...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1329'"), 'web asset stamp changed from b1329');
assert(read('sw.js').includes("const CACHE = 'mls-v344'"), 'service-worker cache stamp changed from v297');
