...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b587'"), 'web asset stamp changed from b587');
assert(read('sw.js').includes("const CACHE = 'mls-v167'"), 'service-worker cache stamp changed from v64');
