...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1085'"), 'web asset stamp changed from b1085');
assert(read('sw.js').includes("const CACHE = 'mls-v222'"), 'service-worker cache stamp changed from v206');
