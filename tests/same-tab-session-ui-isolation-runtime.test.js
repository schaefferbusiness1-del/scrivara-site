...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b649'"), 'web asset stamp changed from b649');
assert(read('sw.js').includes("const CACHE = 'mls-v173'"), 'service-worker cache stamp changed from v64');
