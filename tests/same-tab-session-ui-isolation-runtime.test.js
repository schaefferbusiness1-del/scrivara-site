...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b855'"), 'web asset stamp changed from b855');
assert(read('sw.js').includes("const CACHE = 'mls-v190'"), 'service-worker cache stamp changed from v64');
