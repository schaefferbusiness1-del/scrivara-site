...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1217'"), 'web asset stamp changed from b1217');
assert(read('sw.js').includes("const CACHE = 'mls-v232'"), 'service-worker cache stamp changed from v206');
