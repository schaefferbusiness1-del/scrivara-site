...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1236'"), 'web asset stamp changed from b1236');
assert(read('sw.js').includes("const CACHE = 'mls-v251'"), 'service-worker cache stamp changed from v251');
