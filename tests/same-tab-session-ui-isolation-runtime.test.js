...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b566'"), 'web asset stamp changed from b566');
assert(read('sw.js').includes("const CACHE = 'mls-v148'"), 'service-worker cache stamp changed from v64');
