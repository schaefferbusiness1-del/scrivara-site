...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b515'"), 'web asset stamp changed from b515');
assert(read('sw.js').includes("const CACHE = 'mls-v101'"), 'service-worker cache stamp changed from v64');
