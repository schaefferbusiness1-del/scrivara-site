...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b657'"), 'web asset stamp changed from b657');
assert(read('sw.js').includes("const CACHE = 'mls-v178'"), 'service-worker cache stamp changed from v64');
