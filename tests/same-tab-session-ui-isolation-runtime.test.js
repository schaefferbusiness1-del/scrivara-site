...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1223'"), 'web asset stamp changed from b1223');
assert(read('sw.js').includes("const CACHE = 'mls-v238'"), 'service-worker cache stamp changed from v206');
