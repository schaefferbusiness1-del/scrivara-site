...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b857'"), 'web asset stamp changed from b857');
assert(read('sw.js').includes("const CACHE = 'mls-v192'"), 'service-worker cache stamp changed from v64');
