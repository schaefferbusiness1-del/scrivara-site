...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1298'"), 'web asset stamp changed from b1298');
assert(read('sw.js').includes("const CACHE = 'mls-v313'"), 'service-worker cache stamp changed from v297');
