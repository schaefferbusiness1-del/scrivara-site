...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b484'"), 'web asset stamp changed from b484');
assert(read('sw.js').includes("const CACHE = 'mls-v71'"), 'service-worker cache stamp changed from v64');
