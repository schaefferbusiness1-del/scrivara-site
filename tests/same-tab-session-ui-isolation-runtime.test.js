...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1325'"), 'web asset stamp changed from b1325');
assert(read('sw.js').includes("const CACHE = 'mls-v340'"), 'service-worker cache stamp changed from v297');
