...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b554'"), 'web asset stamp changed from b554');
assert(read('sw.js').includes("const CACHE = 'mls-v136'"), 'service-worker cache stamp changed from v64');
