...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1229'"), 'web asset stamp changed from b1229');
assert(read('sw.js').includes("const CACHE = 'mls-v244'"), 'service-worker cache stamp changed from v244');
