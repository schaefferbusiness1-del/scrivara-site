...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1344'"), 'web asset stamp changed from b1344');
assert(read('sw.js').includes("const CACHE = 'mls-v359'"), 'service-worker cache stamp changed from v297');
