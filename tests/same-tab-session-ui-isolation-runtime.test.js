...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1306'"), 'web asset stamp changed from b1306');
assert(read('sw.js').includes("const CACHE = 'mls-v321'"), 'service-worker cache stamp changed from v297');
