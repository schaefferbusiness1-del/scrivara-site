...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1244'"), 'web asset stamp changed from b1244');
assert(read('sw.js').includes("const CACHE = 'mls-v259'"), 'service-worker cache stamp changed from v259');
