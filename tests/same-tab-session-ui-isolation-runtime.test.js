...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b535'"), 'web asset stamp changed from b535');
assert(read('sw.js').includes("const CACHE = 'mls-v117'"), 'service-worker cache stamp changed from v64');
