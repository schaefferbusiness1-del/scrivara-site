...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1323'"), 'web asset stamp changed from b1323');
assert(read('sw.js').includes("const CACHE = 'mls-v338'"), 'service-worker cache stamp changed from v297');
