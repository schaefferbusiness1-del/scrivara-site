...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1320'"), 'web asset stamp changed from b1320');
assert(read('sw.js').includes("const CACHE = 'mls-v335'"), 'service-worker cache stamp changed from v297');
