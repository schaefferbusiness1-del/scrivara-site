...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1276'"), 'web asset stamp changed from b1276');
assert(read('sw.js').includes("const CACHE = 'mls-v291'"), 'service-worker cache stamp changed from v291');
