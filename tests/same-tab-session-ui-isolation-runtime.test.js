...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b544'"), 'web asset stamp changed from b544');
assert(read('sw.js').includes("const CACHE = 'mls-v126'"), 'service-worker cache stamp changed from v64');
