...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b565'"), 'web asset stamp changed from b565');
assert(read('sw.js').includes("const CACHE = 'mls-v147'"), 'service-worker cache stamp changed from v64');
