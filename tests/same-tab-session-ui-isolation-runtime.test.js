...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1095'"), 'web asset stamp changed from b1095');
assert(read('sw.js').includes("const CACHE = 'mls-v224'"), 'service-worker cache stamp changed from v206');
