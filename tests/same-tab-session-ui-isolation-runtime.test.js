...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1225'"), 'web asset stamp changed from b1225');
assert(read('sw.js').includes("const CACHE = 'mls-v240'"), 'service-worker cache stamp changed from v206');
