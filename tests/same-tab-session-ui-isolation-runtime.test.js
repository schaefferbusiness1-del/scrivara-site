...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b512'"), 'web asset stamp changed from b512');
assert(read('sw.js').includes("const CACHE = 'mls-v98'"), 'service-worker cache stamp changed from v64');
