...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1318'"), 'web asset stamp changed from b1318');
assert(read('sw.js').includes("const CACHE = 'mls-v333'"), 'service-worker cache stamp changed from v297');
