...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b661'"), 'web asset stamp changed from b661');
assert(read('sw.js').includes("const CACHE = 'mls-v183'"), 'service-worker cache stamp changed from v64');
