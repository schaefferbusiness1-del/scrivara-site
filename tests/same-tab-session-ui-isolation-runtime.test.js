...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b540'"), 'web asset stamp changed from b540');
assert(read('sw.js').includes("const CACHE = 'mls-v122'"), 'service-worker cache stamp changed from v64');
