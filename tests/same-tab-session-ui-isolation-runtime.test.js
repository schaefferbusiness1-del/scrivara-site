...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b575'"), 'web asset stamp changed from b575');
assert(read('sw.js').includes("const CACHE = 'mls-v157'"), 'service-worker cache stamp changed from v64');
