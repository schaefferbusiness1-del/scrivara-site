...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1286'"), 'web asset stamp changed from b1286');
assert(read('sw.js').includes("const CACHE = 'mls-v301'"), 'service-worker cache stamp changed from v297');
