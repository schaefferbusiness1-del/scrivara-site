...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1314'"), 'web asset stamp changed from b1314');
assert(read('sw.js').includes("const CACHE = 'mls-v329'"), 'service-worker cache stamp changed from v297');
