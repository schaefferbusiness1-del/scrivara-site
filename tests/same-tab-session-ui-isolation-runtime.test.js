...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b531'"), 'web asset stamp changed from b531');
assert(read('sw.js').includes("const CACHE = 'mls-v113'"), 'service-worker cache stamp changed from v64');
