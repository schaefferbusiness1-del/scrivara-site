...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b481'"), 'web asset stamp changed from b481');
assert(read('sw.js').includes("const CACHE = 'mls-v68'"), 'service-worker cache stamp changed from v64');
