...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b701'"), 'web asset stamp changed from b701');
assert(read('sw.js').includes("const CACHE = 'mls-v187'"), 'service-worker cache stamp changed from v64');
