...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1275'"), 'web asset stamp changed from b1275');
assert(read('sw.js').includes("const CACHE = 'mls-v290'"), 'service-worker cache stamp changed from v290');
