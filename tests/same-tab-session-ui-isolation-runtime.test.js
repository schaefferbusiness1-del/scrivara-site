...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b549'"), 'web asset stamp changed from b549');
assert(read('sw.js').includes("const CACHE = 'mls-v131'"), 'service-worker cache stamp changed from v64');
