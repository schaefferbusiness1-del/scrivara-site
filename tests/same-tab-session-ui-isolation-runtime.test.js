...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b450'"), 'web asset stamp changed from b434');
assert(read('sw.js').includes("const CACHE = 'mls-v37'"), 'service-worker cache stamp changed from v22');
