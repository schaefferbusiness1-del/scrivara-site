...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b1086'"), 'web asset stamp changed from b1086');
assert(read('sw.js').includes("const CACHE = 'mls-v223'"), 'service-worker cache stamp changed from v206');
