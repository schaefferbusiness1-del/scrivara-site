...
assert(read('ScribeFlow.html').includes("window.__MLS_AV='b555'"), 'web asset stamp changed from b555');
assert(read('sw.js').includes("const CACHE = 'mls-v137'"), 'service-worker cache stamp changed from v64');
