...
assert(app.includes("window.__MLS_AV='b648'"), 'ScribeFlow loader was not cache-busted to b648');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b648'"), 'shared asset version was not bumped to b648');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b648'"), 'app build was not bumped to b648');
