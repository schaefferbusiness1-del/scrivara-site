...
assert(app.includes("window.__MLS_AV='b411'"), 'ScribeFlow loader was not cache-busted to b411');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b411'"), 'shared asset version was not bumped to b411');
assert(connect.includes("var MLS_APP_BUILD='2026-07-18-b411'"), 'app build was not bumped to b411');
