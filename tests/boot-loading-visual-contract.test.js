...
assert(app.includes("window.__MLS_AV='b638'"), 'ScribeFlow loader was not cache-busted to b638');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b638'"), 'shared asset version was not bumped to b638');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b638'"), 'app build was not bumped to b638');
