...
assert(app.includes("window.__MLS_AV='b396'"), 'ScribeFlow loader was not cache-busted to b396');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b396'"), 'shared asset version was not bumped to b396');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b396'"), 'app build was not bumped to b396');
