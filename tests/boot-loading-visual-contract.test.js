...
assert(app.includes("window.__MLS_AV='b552'"), 'ScribeFlow loader was not cache-busted to b552');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b552'"), 'shared asset version was not bumped to b552');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b552'"), 'app build was not bumped to b552');
