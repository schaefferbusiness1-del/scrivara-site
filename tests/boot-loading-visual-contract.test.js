...
assert(app.includes("window.__MLS_AV='b351'"), 'ScribeFlow loader was not cache-busted to b351');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b351'"), 'shared asset version was not bumped to b351');
assert(connect.includes("var MLS_APP_BUILD='2026-07-16-b351'"), 'app build was not bumped to b351');
