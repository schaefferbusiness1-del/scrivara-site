...
assert(app.includes("window.__MLS_AV='b356'"), 'ScribeFlow loader was not cache-busted to b356');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b356'"), 'shared asset version was not bumped to b356');
assert(connect.includes("var MLS_APP_BUILD='2026-07-16-b356'"), 'app build was not bumped to b356');
