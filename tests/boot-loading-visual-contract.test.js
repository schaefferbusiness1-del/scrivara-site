...
assert(app.includes("window.__MLS_AV='b777'"), 'ScribeFlow loader was not cache-busted to b777');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b777'"), 'shared asset version was not bumped to b777');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b777'"), 'app build was not bumped to b777');
