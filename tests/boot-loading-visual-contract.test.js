...
assert(app.includes("window.__MLS_AV='b361'"), 'ScribeFlow loader was not cache-busted to b361');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b361'"), 'shared asset version was not bumped to b361');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b361'"), 'app build was not bumped to b361');
