...
assert(app.includes("window.__MLS_AV='b728'"), 'ScribeFlow loader was not cache-busted to b728');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b728'"), 'shared asset version was not bumped to b728');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b728'"), 'app build was not bumped to b728');
