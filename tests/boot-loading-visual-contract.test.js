...
assert(app.includes("window.__MLS_AV=\"b300\""), 'ScribeFlow loader was not cache-busted to b300');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b300'"), 'shared asset version was not bumped to b300');
assert(connect.includes("var MLS_APP_BUILD='2026-07-15-b300'"), 'app build was not bumped to b300');
