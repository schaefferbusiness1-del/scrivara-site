...
assert(app.includes("window.__MLS_AV='b996'"), 'ScribeFlow loader was not cache-busted to b996');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b996'"), 'shared asset version was not bumped to b996');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b996'"), 'app build was not bumped to b996');
