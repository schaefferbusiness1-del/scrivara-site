...
assert(app.includes("window.__MLS_AV='b669'"), 'ScribeFlow loader was not cache-busted to b669');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b669'"), 'shared asset version was not bumped to b669');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b669'"), 'app build was not bumped to b669');
