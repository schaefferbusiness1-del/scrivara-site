...
assert(app.includes("window.__MLS_AV='b917'"), 'ScribeFlow loader was not cache-busted to b917');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b917'"), 'shared asset version was not bumped to b917');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b917'"), 'app build was not bumped to b917');
