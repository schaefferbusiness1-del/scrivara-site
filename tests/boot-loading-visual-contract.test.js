...
assert(app.includes("window.__MLS_AV='b950'"), 'ScribeFlow loader was not cache-busted to b950');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b950'"), 'shared asset version was not bumped to b950');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b950'"), 'app build was not bumped to b950');
