...
assert(app.includes("window.__MLS_AV='b811'"), 'ScribeFlow loader was not cache-busted to b811');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b811'"), 'shared asset version was not bumped to b811');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b811'"), 'app build was not bumped to b811');
