...
assert(app.includes("window.__MLS_AV='b383'"), 'ScribeFlow loader was not cache-busted to b383');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b383'"), 'shared asset version was not bumped to b383');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b383'"), 'app build was not bumped to b383');
