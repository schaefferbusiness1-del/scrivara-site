...
assert(app.includes("window.__MLS_AV='b895'"), 'ScribeFlow loader was not cache-busted to b895');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b895'"), 'shared asset version was not bumped to b895');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b895'"), 'app build was not bumped to b895');
