...
assert(app.includes("window.__MLS_AV='b362'"), 'ScribeFlow loader was not cache-busted to b362');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b362'"), 'shared asset version was not bumped to b362');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b362'"), 'app build was not bumped to b362');
