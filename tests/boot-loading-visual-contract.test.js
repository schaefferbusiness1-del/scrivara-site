...
assert(app.includes("window.__MLS_AV='b896'"), 'ScribeFlow loader was not cache-busted to b896');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b896'"), 'shared asset version was not bumped to b896');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b896'"), 'app build was not bumped to b896');
