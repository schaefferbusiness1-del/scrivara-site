...
assert(app.includes("window.__MLS_AV='b515'"), 'ScribeFlow loader was not cache-busted to b515');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b515'"), 'shared asset version was not bumped to b515');
assert(connect.includes("var MLS_APP_BUILD='2026-07-23-b515'"), 'app build was not bumped to b515');
