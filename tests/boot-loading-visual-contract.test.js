...
assert(app.includes("window.__MLS_AV='b939'"), 'ScribeFlow loader was not cache-busted to b939');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b939'"), 'shared asset version was not bumped to b939');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b939'"), 'app build was not bumped to b939');
