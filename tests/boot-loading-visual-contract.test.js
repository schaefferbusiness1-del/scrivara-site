...
assert(app.includes("window.__MLS_AV='b787'"), 'ScribeFlow loader was not cache-busted to b787');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b787'"), 'shared asset version was not bumped to b787');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b787'"), 'app build was not bumped to b787');
