...
assert(app.includes("window.__MLS_AV='b727'"), 'ScribeFlow loader was not cache-busted to b727');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b727'"), 'shared asset version was not bumped to b727');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b727'"), 'app build was not bumped to b727');
