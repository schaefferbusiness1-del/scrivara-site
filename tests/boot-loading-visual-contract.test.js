...
assert(app.includes("window.__MLS_AV='b549'"), 'ScribeFlow loader was not cache-busted to b549');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b549'"), 'shared asset version was not bumped to b549');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b549'"), 'app build was not bumped to b549');
