...
assert(app.includes("window.__MLS_AV='b844'"), 'ScribeFlow loader was not cache-busted to b844');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b844'"), 'shared asset version was not bumped to b844');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b844'"), 'app build was not bumped to b844');
