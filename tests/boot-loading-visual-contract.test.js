...
assert(app.includes("window.__MLS_AV='b708'"), 'ScribeFlow loader was not cache-busted to b708');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b708'"), 'shared asset version was not bumped to b708');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b708'"), 'app build was not bumped to b708');
