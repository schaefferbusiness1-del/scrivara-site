...
assert(app.includes("window.__MLS_AV='b883'"), 'ScribeFlow loader was not cache-busted to b883');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b883'"), 'shared asset version was not bumped to b883');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b883'"), 'app build was not bumped to b883');
