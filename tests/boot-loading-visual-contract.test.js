...
assert(app.includes("window.__MLS_AV='b533'"), 'ScribeFlow loader was not cache-busted to b533');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b533'"), 'shared asset version was not bumped to b533');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b533'"), 'app build was not bumped to b533');
