...
assert(app.includes("window.__MLS_AV='b623'"), 'ScribeFlow loader was not cache-busted to b623');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b623'"), 'shared asset version was not bumped to b623');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b623'"), 'app build was not bumped to b623');
