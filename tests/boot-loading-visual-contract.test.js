...
assert(app.includes("window.__MLS_AV='b894'"), 'ScribeFlow loader was not cache-busted to b894');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b894'"), 'shared asset version was not bumped to b894');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b894'"), 'app build was not bumped to b894');
