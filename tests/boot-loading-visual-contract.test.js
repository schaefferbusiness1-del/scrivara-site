...
assert(app.includes("window.__MLS_AV='b732'"), 'ScribeFlow loader was not cache-busted to b732');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b732'"), 'shared asset version was not bumped to b732');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b732'"), 'app build was not bumped to b732');
