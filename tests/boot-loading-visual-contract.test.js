...
assert(app.includes("window.__MLS_AV='b947'"), 'ScribeFlow loader was not cache-busted to b947');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b947'"), 'shared asset version was not bumped to b947');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b947'"), 'app build was not bumped to b947');
