...
assert(app.includes("window.__MLS_AV='b865'"), 'ScribeFlow loader was not cache-busted to b865');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b865'"), 'shared asset version was not bumped to b865');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b865'"), 'app build was not bumped to b865');
