...
assert(app.includes("window.__MLS_AV='b412'"), 'ScribeFlow loader was not cache-busted to b412');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b412'"), 'shared asset version was not bumped to b412');
assert(connect.includes("var MLS_APP_BUILD='2026-07-18-b412'"), 'app build was not bumped to b412');
