...
assert(app.includes("window.__MLS_AV='b553'"), 'ScribeFlow loader was not cache-busted to b553');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b553'"), 'shared asset version was not bumped to b553');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b553'"), 'app build was not bumped to b553');
