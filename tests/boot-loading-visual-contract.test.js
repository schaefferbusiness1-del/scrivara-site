...
assert(app.includes("window.__MLS_AV='b734'"), 'ScribeFlow loader was not cache-busted to b734');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b734'"), 'shared asset version was not bumped to b734');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b734'"), 'app build was not bumped to b734');
