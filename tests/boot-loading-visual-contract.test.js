...
assert(app.includes("window.__MLS_AV='b679'"), 'ScribeFlow loader was not cache-busted to b679');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b679'"), 'shared asset version was not bumped to b679');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b679'"), 'app build was not bumped to b679');
