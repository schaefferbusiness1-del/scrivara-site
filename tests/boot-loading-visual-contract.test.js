...
assert(app.includes("window.__MLS_AV='b961'"), 'ScribeFlow loader was not cache-busted to b961');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b961'"), 'shared asset version was not bumped to b961');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b961'"), 'app build was not bumped to b961');
