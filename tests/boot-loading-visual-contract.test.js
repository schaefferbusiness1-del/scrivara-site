...
assert(app.includes("window.__MLS_AV='b892'"), 'ScribeFlow loader was not cache-busted to b892');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b892'"), 'shared asset version was not bumped to b892');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b892'"), 'app build was not bumped to b892');
