...
assert(app.includes("window.__MLS_AV='b762'"), 'ScribeFlow loader was not cache-busted to b762');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b762'"), 'shared asset version was not bumped to b762');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b762'"), 'app build was not bumped to b762');
