...
assert(app.includes("window.__MLS_AV='b823'"), 'ScribeFlow loader was not cache-busted to b823');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b823'"), 'shared asset version was not bumped to b823');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b823'"), 'app build was not bumped to b823');
