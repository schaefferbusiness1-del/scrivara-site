...
assert(app.includes("window.__MLS_AV='b827'"), 'ScribeFlow loader was not cache-busted to b827');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b827'"), 'shared asset version was not bumped to b827');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b827'"), 'app build was not bumped to b827');
