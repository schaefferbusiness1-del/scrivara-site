...
assert(app.includes("window.__MLS_AV='b792'"), 'ScribeFlow loader was not cache-busted to b792');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b792'"), 'shared asset version was not bumped to b792');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b792'"), 'app build was not bumped to b792');
