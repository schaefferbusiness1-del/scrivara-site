...
assert(app.includes("window.__MLS_AV='b613'"), 'ScribeFlow loader was not cache-busted to b613');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b613'"), 'shared asset version was not bumped to b613');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b613'"), 'app build was not bumped to b613');
