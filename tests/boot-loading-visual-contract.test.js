...
assert(app.includes("window.__MLS_AV='b505'"), 'ScribeFlow loader was not cache-busted to b505');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b505'"), 'shared asset version was not bumped to b505');
assert(connect.includes("var MLS_APP_BUILD='2026-07-23-b505'"), 'app build was not bumped to b505');
