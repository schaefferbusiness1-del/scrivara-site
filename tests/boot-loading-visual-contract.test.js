...
assert(app.includes("window.__MLS_AV='b719'"), 'ScribeFlow loader was not cache-busted to b719');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b719'"), 'shared asset version was not bumped to b719');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b719'"), 'app build was not bumped to b719');
