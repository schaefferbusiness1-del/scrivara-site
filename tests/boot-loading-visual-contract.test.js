...
assert(app.includes("window.__MLS_AV='b328'"), 'ScribeFlow loader was not cache-busted to b328');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b328'"), 'shared asset version was not bumped to b328');
assert(connect.includes("var MLS_APP_BUILD='2026-07-16-b328'"), 'app build was not bumped to b328');
