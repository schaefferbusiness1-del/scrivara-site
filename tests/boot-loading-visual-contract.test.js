...
assert(app.includes("window.__MLS_AV='b573'"), 'ScribeFlow loader was not cache-busted to b573');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b573'"), 'shared asset version was not bumped to b573');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b573'"), 'app build was not bumped to b573');
