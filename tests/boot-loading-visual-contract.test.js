...
assert(app.includes("window.__MLS_AV='b695'"), 'ScribeFlow loader was not cache-busted to b695');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b695'"), 'shared asset version was not bumped to b695');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b695'"), 'app build was not bumped to b695');
