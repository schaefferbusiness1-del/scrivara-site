...
assert(app.includes("window.__MLS_AV='b774'"), 'ScribeFlow loader was not cache-busted to b774');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b774'"), 'shared asset version was not bumped to b774');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b774'"), 'app build was not bumped to b774');
