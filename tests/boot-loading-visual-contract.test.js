...
assert(app.includes("window.__MLS_AV='b852'"), 'ScribeFlow loader was not cache-busted to b852');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b852'"), 'shared asset version was not bumped to b852');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b852'"), 'app build was not bumped to b852');
