...
assert(app.includes("window.__MLS_AV='b532'"), 'ScribeFlow loader was not cache-busted to b532');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b532'"), 'shared asset version was not bumped to b532');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b532'"), 'app build was not bumped to b532');
