...
assert(app.includes("window.__MLS_AV='b807'"), 'ScribeFlow loader was not cache-busted to b807');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b807'"), 'shared asset version was not bumped to b807');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b807'"), 'app build was not bumped to b807');
