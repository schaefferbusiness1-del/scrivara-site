...
assert(app.includes("window.__MLS_AV='b752'"), 'ScribeFlow loader was not cache-busted to b752');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b752'"), 'shared asset version was not bumped to b752');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b752'"), 'app build was not bumped to b752');
