...
assert(app.includes("window.__MLS_AV='b983'"), 'ScribeFlow loader was not cache-busted to b983');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b983'"), 'shared asset version was not bumped to b983');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b983'"), 'app build was not bumped to b983');
