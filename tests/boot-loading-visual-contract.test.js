...
assert(app.includes("window.__MLS_AV='b318'"), 'ScribeFlow loader was not cache-busted to b318');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b318'"), 'shared asset version was not bumped to b318');
assert(connect.includes("var MLS_APP_BUILD='2026-07-16-b318'"), 'app build was not bumped to b318');
