...
assert(app.includes("window.__MLS_AV='b666'"), 'ScribeFlow loader was not cache-busted to b666');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b666'"), 'shared asset version was not bumped to b666');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b666'"), 'app build was not bumped to b666');
