...
assert(app.includes("window.__MLS_AV='b1040'"), 'ScribeFlow loader was not cache-busted to b1040');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b1040'"), 'shared asset version was not bumped to b1040');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b1040'"), 'app build was not bumped to b1040');
