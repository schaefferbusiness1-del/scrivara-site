...
assert(app.includes("window.__MLS_AV='b381'"), 'ScribeFlow loader was not cache-busted to b381');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b381'"), 'shared asset version was not bumped to b381');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b381'"), 'app build was not bumped to b381');
