...
assert(app.includes("window.__MLS_AV='b544'"), 'ScribeFlow loader was not cache-busted to b544');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b544'"), 'shared asset version was not bumped to b544');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b544'"), 'app build was not bumped to b544');
