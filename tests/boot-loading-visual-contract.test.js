...
assert(app.includes("window.__MLS_AV='b741'"), 'ScribeFlow loader was not cache-busted to b741');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b741'"), 'shared asset version was not bumped to b741');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b741'"), 'app build was not bumped to b741');
