...
assert(app.includes("window.__MLS_AV='b370'"), 'ScribeFlow loader was not cache-busted to b370');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b370'"), 'shared asset version was not bumped to b370');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b370'"), 'app build was not bumped to b370');
