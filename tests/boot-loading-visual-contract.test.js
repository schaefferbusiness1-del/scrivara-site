...
assert(app.includes("window.__MLS_AV='b830'"), 'ScribeFlow loader was not cache-busted to b830');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b830'"), 'shared asset version was not bumped to b830');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b830'"), 'app build was not bumped to b830');
