...
assert(app.includes("window.__MLS_AV='b481'"), 'ScribeFlow loader was not cache-busted to b481');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b481'"), 'shared asset version was not bumped to b481');
assert(connect.includes("var MLS_APP_BUILD='2026-07-21-b481'"), 'app build was not bumped to b481');
