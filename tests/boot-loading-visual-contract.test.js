...
assert(app.includes("window.__MLS_AV='b885'"), 'ScribeFlow loader was not cache-busted to b885');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b885'"), 'shared asset version was not bumped to b885');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b885'"), 'app build was not bumped to b885');
