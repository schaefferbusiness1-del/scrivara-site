...
assert(app.includes("window.__MLS_AV='b990'"), 'ScribeFlow loader was not cache-busted to b990');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b990'"), 'shared asset version was not bumped to b990');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b990'"), 'app build was not bumped to b990');
