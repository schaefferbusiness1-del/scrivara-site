...
assert(app.includes("window.__MLS_AV='b530'"), 'ScribeFlow loader was not cache-busted to b530');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b530'"), 'shared asset version was not bumped to b530');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b530'"), 'app build was not bumped to b530');
