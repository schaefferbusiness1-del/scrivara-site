...
assert(app.includes("window.__MLS_AV='b477'"), 'ScribeFlow loader was not cache-busted to b477');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b477'"), 'shared asset version was not bumped to b477');
assert(connect.includes("var MLS_APP_BUILD='2026-07-21-b477'"), 'app build was not bumped to b477');
