...
assert(app.includes("window.__MLS_AV='b504'"), 'ScribeFlow loader was not cache-busted to b504');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b504'"), 'shared asset version was not bumped to b504');
assert(connect.includes("var MLS_APP_BUILD='2026-07-23-b504'"), 'app build was not bumped to b504');
