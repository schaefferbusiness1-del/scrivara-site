...
assert(app.includes("window.__MLS_AV='b583'"), 'ScribeFlow loader was not cache-busted to b583');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b583'"), 'shared asset version was not bumped to b583');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b583'"), 'app build was not bumped to b583');
