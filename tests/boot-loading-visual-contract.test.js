...
assert(app.includes("window.__MLS_AV='b878'"), 'ScribeFlow loader was not cache-busted to b878');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b878'"), 'shared asset version was not bumped to b878');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b878'"), 'app build was not bumped to b878');
