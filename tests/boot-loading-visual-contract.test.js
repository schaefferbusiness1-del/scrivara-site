...
assert(app.includes("window.__MLS_AV='b677'"), 'ScribeFlow loader was not cache-busted to b677');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b677'"), 'shared asset version was not bumped to b677');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b677'"), 'app build was not bumped to b677');
