...
assert(app.includes("window.__MLS_AV='b920'"), 'ScribeFlow loader was not cache-busted to b920');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b920'"), 'shared asset version was not bumped to b920');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b920'"), 'app build was not bumped to b920');
