...
assert(app.includes("window.__MLS_AV=\"b308\""), 'ScribeFlow loader was not cache-busted to b308');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b308'"), 'shared asset version was not bumped to b308');
assert(connect.includes("var MLS_APP_BUILD='2026-07-15-b308'"), 'app build was not bumped to b308');
