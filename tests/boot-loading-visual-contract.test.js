...
assert(app.includes("window.__MLS_AV='b902'"), 'ScribeFlow loader was not cache-busted to b902');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b902'"), 'shared asset version was not bumped to b902');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b902'"), 'app build was not bumped to b902');
