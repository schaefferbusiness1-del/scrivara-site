...
assert(app.includes("window.__MLS_AV='b589'"), 'ScribeFlow loader was not cache-busted to b589');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b589'"), 'shared asset version was not bumped to b589');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b589'"), 'app build was not bumped to b589');
