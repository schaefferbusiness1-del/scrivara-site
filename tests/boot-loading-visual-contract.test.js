...
assert(app.includes("window.__MLS_AV='b916'"), 'ScribeFlow loader was not cache-busted to b916');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b916'"), 'shared asset version was not bumped to b916');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b916'"), 'app build was not bumped to b916');
