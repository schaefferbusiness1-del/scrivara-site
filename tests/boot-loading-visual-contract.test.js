...
assert(app.includes("window.__MLS_AV='b491'"), 'ScribeFlow loader was not cache-busted to b491');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b491'"), 'shared asset version was not bumped to b491');
assert(connect.includes("var MLS_APP_BUILD='2026-07-21-b491'"), 'app build was not bumped to b491');
