...
assert(app.includes("window.__MLS_AV='b693'"), 'ScribeFlow loader was not cache-busted to b693');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b693'"), 'shared asset version was not bumped to b693');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b693'"), 'app build was not bumped to b693');
