...
assert(app.includes("window.__MLS_AV='b911'"), 'ScribeFlow loader was not cache-busted to b911');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b911'"), 'shared asset version was not bumped to b911');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b911'"), 'app build was not bumped to b911');
