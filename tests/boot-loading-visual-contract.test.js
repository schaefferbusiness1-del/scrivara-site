...
assert(app.includes("window.__MLS_AV='b484'"), 'ScribeFlow loader was not cache-busted to b484');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b484'"), 'shared asset version was not bumped to b484');
assert(connect.includes("var MLS_APP_BUILD='2026-07-21-b484'"), 'app build was not bumped to b484');
