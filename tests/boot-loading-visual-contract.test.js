...
assert(app.includes("window.__MLS_AV='b854'"), 'ScribeFlow loader was not cache-busted to b854');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b854'"), 'shared asset version was not bumped to b854');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b854'"), 'app build was not bumped to b854');
