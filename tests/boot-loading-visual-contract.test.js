...
assert(app.includes("window.__MLS_AV='b419'"), 'ScribeFlow loader was not cache-busted to b419');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b419'"), 'shared asset version was not bumped to b419');
assert(connect.includes("var MLS_APP_BUILD='2026-07-18-b419'"), 'app build was not bumped to b419');
