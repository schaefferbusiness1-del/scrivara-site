...
assert(app.includes("window.__MLS_AV='b501'"), 'ScribeFlow loader was not cache-busted to b501');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b501'"), 'shared asset version was not bumped to b501');
assert(connect.includes("var MLS_APP_BUILD='2026-07-23-b501'"), 'app build was not bumped to b501');
