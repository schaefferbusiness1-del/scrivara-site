...
assert(app.includes("window.__MLS_AV='b405'"), 'ScribeFlow loader was not cache-busted to b405');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b405'"), 'shared asset version was not bumped to b405');
assert(connect.includes("var MLS_APP_BUILD='2026-07-18-b405'"), 'app build was not bumped to b405');
