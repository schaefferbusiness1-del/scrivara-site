...
assert(app.includes("window.__MLS_AV='b674'"), 'ScribeFlow loader was not cache-busted to b674');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b674'"), 'shared asset version was not bumped to b674');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b674'"), 'app build was not bumped to b674');
