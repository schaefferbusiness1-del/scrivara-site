...
assert(app.includes("window.__MLS_AV='b982'"), 'ScribeFlow loader was not cache-busted to b982');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b982'"), 'shared asset version was not bumped to b982');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b982'"), 'app build was not bumped to b982');
