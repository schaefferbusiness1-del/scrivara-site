...
assert(app.includes("window.__MLS_AV='b403'"), 'ScribeFlow loader was not cache-busted to b403');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b403'"), 'shared asset version was not bumped to b403');
assert(connect.includes("var MLS_APP_BUILD='2026-07-18-b403'"), 'app build was not bumped to b403');
