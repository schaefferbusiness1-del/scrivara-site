...
assert(app.includes("window.__MLS_AV='b765'"), 'ScribeFlow loader was not cache-busted to b765');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b765'"), 'shared asset version was not bumped to b765');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b765'"), 'app build was not bumped to b765');
