...
assert(app.includes("window.__MLS_AV='b729'"), 'ScribeFlow loader was not cache-busted to b729');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b729'"), 'shared asset version was not bumped to b729');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b729'"), 'app build was not bumped to b729');
