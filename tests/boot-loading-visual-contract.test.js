...
assert(app.includes("window.__MLS_AV='b516'"), 'ScribeFlow loader was not cache-busted to b516');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b516'"), 'shared asset version was not bumped to b516');
assert(connect.includes("var MLS_APP_BUILD='2026-07-23-b516'"), 'app build was not bumped to b516');
