...
assert(app.includes("window.__MLS_AV='b687'"), 'ScribeFlow loader was not cache-busted to b687');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b687'"), 'shared asset version was not bumped to b687');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b687'"), 'app build was not bumped to b687');
