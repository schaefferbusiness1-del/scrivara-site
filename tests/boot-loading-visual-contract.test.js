...
assert(app.includes("window.__MLS_AV='b740'"), 'ScribeFlow loader was not cache-busted to b740');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b740'"), 'shared asset version was not bumped to b740');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b740'"), 'app build was not bumped to b740');
