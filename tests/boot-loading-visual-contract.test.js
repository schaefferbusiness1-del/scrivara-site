...
assert(app.includes("window.__MLS_AV='b415'"), 'ScribeFlow loader was not cache-busted to b415');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b415'"), 'shared asset version was not bumped to b415');
assert(connect.includes("var MLS_APP_BUILD='2026-07-18-b415'"), 'app build was not bumped to b415');
