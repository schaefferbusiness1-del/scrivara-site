...
assert(app.includes("window.__MLS_AV='b385'"), 'ScribeFlow loader was not cache-busted to b385');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b385'"), 'shared asset version was not bumped to b385');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b385'"), 'app build was not bumped to b385');
