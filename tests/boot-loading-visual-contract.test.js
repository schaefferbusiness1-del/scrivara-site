...
assert(app.includes("window.__MLS_AV='b388'"), 'ScribeFlow loader was not cache-busted to b388');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b388'"), 'shared asset version was not bumped to b388');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b388'"), 'app build was not bumped to b388');
