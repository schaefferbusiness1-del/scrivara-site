...
assert(app.includes("window.__MLS_AV='b1027'"), 'ScribeFlow loader was not cache-busted to b1027');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b1027'"), 'shared asset version was not bumped to b1027');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b1027'"), 'app build was not bumped to b1027');
