...
assert(app.includes("window.__MLS_AV='b531'"), 'ScribeFlow loader was not cache-busted to b531');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b531'"), 'shared asset version was not bumped to b531');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b531'"), 'app build was not bumped to b531');
