...
assert(app.includes("window.__MLS_AV='b585'"), 'ScribeFlow loader was not cache-busted to b585');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b585'"), 'shared asset version was not bumped to b585');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b585'"), 'app build was not bumped to b585');
