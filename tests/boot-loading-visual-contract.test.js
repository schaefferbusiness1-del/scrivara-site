...
assert(app.includes("window.__MLS_AV='b503'"), 'ScribeFlow loader was not cache-busted to b503');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b503'"), 'shared asset version was not bumped to b503');
assert(connect.includes("var MLS_APP_BUILD='2026-07-23-b503'"), 'app build was not bumped to b503');
