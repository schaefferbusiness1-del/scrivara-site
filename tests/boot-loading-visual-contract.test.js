...
assert(app.includes("window.__MLS_AV='b822'"), 'ScribeFlow loader was not cache-busted to b822');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b822'"), 'shared asset version was not bumped to b822');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b822'"), 'app build was not bumped to b822');
