...
assert(app.includes("window.__MLS_AV='b664'"), 'ScribeFlow loader was not cache-busted to b664');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b664'"), 'shared asset version was not bumped to b664');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b664'"), 'app build was not bumped to b664');
