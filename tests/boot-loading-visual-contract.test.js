...
assert(app.includes("window.__MLS_AV=\"b301\""), 'ScribeFlow loader was not cache-busted to b301');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b301'"), 'shared asset version was not bumped to b301');
assert(connect.includes("var MLS_APP_BUILD='2026-07-15-b301'"), 'app build was not bumped to b301');
