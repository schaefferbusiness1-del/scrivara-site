...
assert(app.includes("window.__MLS_AV='b754'"), 'ScribeFlow loader was not cache-busted to b754');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b754'"), 'shared asset version was not bumped to b754');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b754'"), 'app build was not bumped to b754');
