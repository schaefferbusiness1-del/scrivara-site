...
assert(app.includes("window.__MLS_AV='b401'"), 'ScribeFlow loader was not cache-busted to b401');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b401'"), 'shared asset version was not bumped to b401');
assert(connect.includes("var MLS_APP_BUILD='2026-07-18-b401'"), 'app build was not bumped to b401');
