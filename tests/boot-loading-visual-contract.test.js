...
assert(app.includes("window.__MLS_AV='b406'"), 'ScribeFlow loader was not cache-busted to b406');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b406'"), 'shared asset version was not bumped to b406');
assert(connect.includes("var MLS_APP_BUILD='2026-07-18-b406'"), 'app build was not bumped to b406');
