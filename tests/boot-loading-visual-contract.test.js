...
assert(app.includes("window.__MLS_AV='b371'"), 'ScribeFlow loader was not cache-busted to b371');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b371'"), 'shared asset version was not bumped to b371');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b371'"), 'app build was not bumped to b371');
