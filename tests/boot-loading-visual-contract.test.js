...
assert(app.includes("window.__MLS_AV='b935'"), 'ScribeFlow loader was not cache-busted to b935');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b935'"), 'shared asset version was not bumped to b935');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b935'"), 'app build was not bumped to b935');
