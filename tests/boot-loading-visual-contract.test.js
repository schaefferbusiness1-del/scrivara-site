...
assert(app.includes("window.__MLS_AV='b430'"), 'ScribeFlow loader was not cache-busted to b430');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b430'"), 'shared asset version was not bumped to b430');
assert(connect.includes("var MLS_APP_BUILD='2026-07-19-b430'"), 'app build was not bumped to b430');
