...
assert(app.includes("window.__MLS_AV='b726'"), 'ScribeFlow loader was not cache-busted to b726');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b726'"), 'shared asset version was not bumped to b726');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b726'"), 'app build was not bumped to b726');
