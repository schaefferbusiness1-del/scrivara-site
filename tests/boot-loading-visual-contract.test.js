...
assert(app.includes("window.__MLS_AV='b569'"), 'ScribeFlow loader was not cache-busted to b569');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b569'"), 'shared asset version was not bumped to b569');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b569'"), 'app build was not bumped to b569');
