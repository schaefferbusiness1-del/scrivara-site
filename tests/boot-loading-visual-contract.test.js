...
assert(app.includes("window.__MLS_AV='b386'"), 'ScribeFlow loader was not cache-busted to b386');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b386'"), 'shared asset version was not bumped to b386');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b386'"), 'app build was not bumped to b386');
