...
assert(app.includes("window.__MLS_AV='b912'"), 'ScribeFlow loader was not cache-busted to b912');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b912'"), 'shared asset version was not bumped to b912');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b912'"), 'app build was not bumped to b912');
