...
assert(app.includes("window.__MLS_AV='b809'"), 'ScribeFlow loader was not cache-busted to b809');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b809'"), 'shared asset version was not bumped to b809');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b809'"), 'app build was not bumped to b809');
