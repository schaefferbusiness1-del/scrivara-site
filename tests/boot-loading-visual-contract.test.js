...
assert(app.includes("window.__MLS_AV='b739'"), 'ScribeFlow loader was not cache-busted to b739');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b739'"), 'shared asset version was not bumped to b739');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b739'"), 'app build was not bumped to b739');
