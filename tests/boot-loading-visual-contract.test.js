...
assert(app.includes("window.__MLS_AV='b929'"), 'ScribeFlow loader was not cache-busted to b929');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b929'"), 'shared asset version was not bumped to b929');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b929'"), 'app build was not bumped to b929');
