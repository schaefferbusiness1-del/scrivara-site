...
assert(app.includes("window.__MLS_AV='b604'"), 'ScribeFlow loader was not cache-busted to b604');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b604'"), 'shared asset version was not bumped to b604');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b604'"), 'app build was not bumped to b604');
