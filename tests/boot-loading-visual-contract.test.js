...
assert(app.includes("window.__MLS_AV='b659'"), 'ScribeFlow loader was not cache-busted to b659');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b659'"), 'shared asset version was not bumped to b659');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b659'"), 'app build was not bumped to b659');
