...
assert(app.includes("window.__MLS_AV='b976'"), 'ScribeFlow loader was not cache-busted to b976');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b976'"), 'shared asset version was not bumped to b976');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b976'"), 'app build was not bumped to b976');
