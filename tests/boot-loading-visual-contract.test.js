...
assert(app.includes("window.__MLS_AV='b963'"), 'ScribeFlow loader was not cache-busted to b963');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b963'"), 'shared asset version was not bumped to b963');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b963'"), 'app build was not bumped to b963');
