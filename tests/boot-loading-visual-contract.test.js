...
assert(app.includes("window.__MLS_AV='b745'"), 'ScribeFlow loader was not cache-busted to b745');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b745'"), 'shared asset version was not bumped to b745');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b745'"), 'app build was not bumped to b745');
