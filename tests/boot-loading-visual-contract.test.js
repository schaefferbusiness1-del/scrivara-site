...
assert(app.includes("window.__MLS_AV='b924'"), 'ScribeFlow loader was not cache-busted to b924');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b924'"), 'shared asset version was not bumped to b924');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b924'"), 'app build was not bumped to b924');
