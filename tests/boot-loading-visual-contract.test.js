...
assert(app.includes("window.__MLS_AV='b489'"), 'ScribeFlow loader was not cache-busted to b489');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b489'"), 'shared asset version was not bumped to b489');
assert(connect.includes("var MLS_APP_BUILD='2026-07-21-b489'"), 'app build was not bumped to b489');
