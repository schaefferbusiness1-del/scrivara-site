...
assert(app.includes("window.__MLS_AV='b337'"), 'ScribeFlow loader was not cache-busted to b337');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b337'"), 'shared asset version was not bumped to b337');
assert(connect.includes("var MLS_APP_BUILD='2026-07-16-b337'"), 'app build was not bumped to b337');
