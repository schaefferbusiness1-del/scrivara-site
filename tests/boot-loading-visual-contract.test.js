...
assert(app.includes("window.__MLS_AV='b725'"), 'ScribeFlow loader was not cache-busted to b725');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b725'"), 'shared asset version was not bumped to b725');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b725'"), 'app build was not bumped to b725');
