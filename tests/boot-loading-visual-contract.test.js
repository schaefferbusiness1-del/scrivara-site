...
assert(app.includes("window.__MLS_AV='b367'"), 'ScribeFlow loader was not cache-busted to b367');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b367'"), 'shared asset version was not bumped to b367');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b367'"), 'app build was not bumped to b367');
