...
assert(app.includes("window.__MLS_AV='b564'"), 'ScribeFlow loader was not cache-busted to b564');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b564'"), 'shared asset version was not bumped to b564');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b564'"), 'app build was not bumped to b564');
