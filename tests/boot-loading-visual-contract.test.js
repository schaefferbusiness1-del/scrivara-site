...
assert(app.includes("window.__MLS_AV='b408'"), 'ScribeFlow loader was not cache-busted to b408');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b408'"), 'shared asset version was not bumped to b408');
assert(connect.includes("var MLS_APP_BUILD='2026-07-18-b408'"), 'app build was not bumped to b408');
