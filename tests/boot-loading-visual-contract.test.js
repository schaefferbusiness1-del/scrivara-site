...
assert(app.includes("window.__MLS_AV='b417'"), 'ScribeFlow loader was not cache-busted to b417');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b417'"), 'shared asset version was not bumped to b417');
assert(connect.includes("var MLS_APP_BUILD='2026-07-18-b417'"), 'app build was not bumped to b417');
