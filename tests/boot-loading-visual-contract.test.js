...
assert(app.includes("window.__MLS_AV='b799'"), 'ScribeFlow loader was not cache-busted to b799');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b799'"), 'shared asset version was not bumped to b799');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b799'"), 'app build was not bumped to b799');
