...
assert(app.includes("window.__MLS_AV='b492'"), 'ScribeFlow loader was not cache-busted to b492');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b492'"), 'shared asset version was not bumped to b492');
assert(connect.includes("var MLS_APP_BUILD='2026-07-21-b492'"), 'app build was not bumped to b492');
