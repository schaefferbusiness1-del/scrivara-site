...
assert(app.includes("window.__MLS_AV='b404'"), 'ScribeFlow loader was not cache-busted to b404');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b404'"), 'shared asset version was not bumped to b404');
assert(connect.includes("var MLS_APP_BUILD='2026-07-18-b404'"), 'app build was not bumped to b404');
