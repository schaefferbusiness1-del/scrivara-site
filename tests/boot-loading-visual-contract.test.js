...
assert(app.includes("window.__MLS_AV='b407'"), 'ScribeFlow loader was not cache-busted to b407');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b407'"), 'shared asset version was not bumped to b407');
assert(connect.includes("var MLS_APP_BUILD='2026-07-18-b407'"), 'app build was not bumped to b407');
