...
assert(app.includes("window.__MLS_AV='b742'"), 'ScribeFlow loader was not cache-busted to b742');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b742'"), 'shared asset version was not bumped to b742');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b742'"), 'app build was not bumped to b742');
