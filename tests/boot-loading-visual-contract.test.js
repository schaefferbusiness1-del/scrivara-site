...
assert(app.includes("window.__MLS_AV='b547'"), 'ScribeFlow loader was not cache-busted to b547');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b547'"), 'shared asset version was not bumped to b547');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b547'"), 'app build was not bumped to b547');
