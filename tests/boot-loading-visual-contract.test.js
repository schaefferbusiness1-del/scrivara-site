...
assert(app.includes("window.__MLS_AV='b1009'"), 'ScribeFlow loader was not cache-busted to b1009');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b1009'"), 'shared asset version was not bumped to b1009');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b1009'"), 'app build was not bumped to b1009');
