...
assert(app.includes("window.__MLS_AV='b737'"), 'ScribeFlow loader was not cache-busted to b737');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b737'"), 'shared asset version was not bumped to b737');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b737'"), 'app build was not bumped to b737');
