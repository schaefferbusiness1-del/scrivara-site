...
assert(app.includes("window.__MLS_AV='b507'"), 'ScribeFlow loader was not cache-busted to b507');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b507'"), 'shared asset version was not bumped to b507');
assert(connect.includes("var MLS_APP_BUILD='2026-07-23-b507'"), 'app build was not bumped to b507');
