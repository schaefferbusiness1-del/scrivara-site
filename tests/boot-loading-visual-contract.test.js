...
assert(app.includes("window.__MLS_AV='b923'"), 'ScribeFlow loader was not cache-busted to b923');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b923'"), 'shared asset version was not bumped to b923');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b923'"), 'app build was not bumped to b923');
