...
assert(app.includes("window.__MLS_AV='b486'"), 'ScribeFlow loader was not cache-busted to b486');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b486'"), 'shared asset version was not bumped to b486');
assert(connect.includes("var MLS_APP_BUILD='2026-07-21-b486'"), 'app build was not bumped to b486');
