...
assert(app.includes("window.__MLS_AV='b938'"), 'ScribeFlow loader was not cache-busted to b938');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b938'"), 'shared asset version was not bumped to b938');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b938'"), 'app build was not bumped to b938');
