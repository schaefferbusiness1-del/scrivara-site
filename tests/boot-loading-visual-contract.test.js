...
assert(app.includes("window.__MLS_AV='b872'"), 'ScribeFlow loader was not cache-busted to b872');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b872'"), 'shared asset version was not bumped to b872');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b872'"), 'app build was not bumped to b872');
