...
assert(app.includes("window.__MLS_AV='b974'"), 'ScribeFlow loader was not cache-busted to b974');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b974'"), 'shared asset version was not bumped to b974');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b974'"), 'app build was not bumped to b974');
