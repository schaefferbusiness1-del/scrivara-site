...
assert(app.includes("window.__MLS_AV='b688'"), 'ScribeFlow loader was not cache-busted to b688');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b688'"), 'shared asset version was not bumped to b688');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b688'"), 'app build was not bumped to b688');
