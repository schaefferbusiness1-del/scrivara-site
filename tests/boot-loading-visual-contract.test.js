...
assert(app.includes("window.__MLS_AV='b392'"), 'ScribeFlow loader was not cache-busted to b392');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b392'"), 'shared asset version was not bumped to b392');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b392'"), 'app build was not bumped to b392');
