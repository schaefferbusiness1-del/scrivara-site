...
assert(app.includes("window.__MLS_AV='b832'"), 'ScribeFlow loader was not cache-busted to b832');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b832'"), 'shared asset version was not bumped to b832');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b832'"), 'app build was not bumped to b832');
