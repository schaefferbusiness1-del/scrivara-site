...
assert(app.includes("window.__MLS_AV='b933'"), 'ScribeFlow loader was not cache-busted to b933');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b933'"), 'shared asset version was not bumped to b933');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b933'"), 'app build was not bumped to b933');
