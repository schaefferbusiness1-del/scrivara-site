...
assert(app.includes("window.__MLS_AV='b358'"), 'ScribeFlow loader was not cache-busted to b358');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b358'"), 'shared asset version was not bumped to b358');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b358'"), 'app build was not bumped to b358');
