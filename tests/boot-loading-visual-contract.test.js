...
assert(app.includes("window.__MLS_AV='b999'"), 'ScribeFlow loader was not cache-busted to b999');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b999'"), 'shared asset version was not bumped to b999');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b999'"), 'app build was not bumped to b999');
