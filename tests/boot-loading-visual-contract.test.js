...
assert(app.includes("window.__MLS_AV='b478'"), 'ScribeFlow loader was not cache-busted to b478');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b478'"), 'shared asset version was not bumped to b478');
assert(connect.includes("var MLS_APP_BUILD='2026-07-21-b478'"), 'app build was not bumped to b478');
