...
assert(app.includes("window.__MLS_AV='b888'"), 'ScribeFlow loader was not cache-busted to b888');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b888'"), 'shared asset version was not bumped to b888');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b888'"), 'app build was not bumped to b888');
