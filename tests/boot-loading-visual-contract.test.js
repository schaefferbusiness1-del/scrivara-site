...
assert(app.includes("window.__MLS_AV='b989'"), 'ScribeFlow loader was not cache-busted to b989');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b989'"), 'shared asset version was not bumped to b989');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b989'"), 'app build was not bumped to b989');
