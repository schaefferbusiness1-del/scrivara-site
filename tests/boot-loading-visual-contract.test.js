...
assert(app.includes("window.__MLS_AV='b733'"), 'ScribeFlow loader was not cache-busted to b733');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b733'"), 'shared asset version was not bumped to b733');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b733'"), 'app build was not bumped to b733');
