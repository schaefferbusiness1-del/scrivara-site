...
assert(app.includes("window.__MLS_AV='b707'"), 'ScribeFlow loader was not cache-busted to b707');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b707'"), 'shared asset version was not bumped to b707');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b707'"), 'app build was not bumped to b707');
