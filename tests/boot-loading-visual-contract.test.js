...
assert(app.includes("window.__MLS_AV='b617'"), 'ScribeFlow loader was not cache-busted to b617');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b617'"), 'shared asset version was not bumped to b617');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b617'"), 'app build was not bumped to b617');
