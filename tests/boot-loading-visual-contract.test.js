...
assert(app.includes("window.__MLS_AV='b319'"), 'ScribeFlow loader was not cache-busted to b319');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b319'"), 'shared asset version was not bumped to b319');
assert(connect.includes("var MLS_APP_BUILD='2026-07-16-b319'"), 'app build was not bumped to b319');
