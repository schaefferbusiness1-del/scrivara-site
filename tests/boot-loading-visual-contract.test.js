...
assert(app.includes("window.__MLS_AV='b820'"), 'ScribeFlow loader was not cache-busted to b820');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b820'"), 'shared asset version was not bumped to b820');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b820'"), 'app build was not bumped to b820');
