...
assert(app.includes("window.__MLS_AV='b837'"), 'ScribeFlow loader was not cache-busted to b837');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b837'"), 'shared asset version was not bumped to b837');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b837'"), 'app build was not bumped to b837');
