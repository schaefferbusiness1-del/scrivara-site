...
assert(app.includes("window.__MLS_AV='b619'"), 'ScribeFlow loader was not cache-busted to b619');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b619'"), 'shared asset version was not bumped to b619');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b619'"), 'app build was not bumped to b619');
