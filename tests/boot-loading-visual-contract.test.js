...
assert(app.includes("window.__MLS_AV='b510'"), 'ScribeFlow loader was not cache-busted to b510');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b510'"), 'shared asset version was not bumped to b510');
assert(connect.includes("var MLS_APP_BUILD='2026-07-23-b510'"), 'app build was not bumped to b510');
