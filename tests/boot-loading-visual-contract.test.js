...
assert(app.includes("window.__MLS_AV=\"b307\""), 'ScribeFlow loader was not cache-busted to b307');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b307'"), 'shared asset version was not bumped to b307');
assert(connect.includes("var MLS_APP_BUILD='2026-07-15-b307'"), 'app build was not bumped to b307');
