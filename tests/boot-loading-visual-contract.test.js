...
assert(app.includes("window.__MLS_AV='b882'"), 'ScribeFlow loader was not cache-busted to b882');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b882'"), 'shared asset version was not bumped to b882');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b882'"), 'app build was not bumped to b882');
