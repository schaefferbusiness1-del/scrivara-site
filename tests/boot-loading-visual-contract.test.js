...
assert(app.includes("window.__MLS_AV='b347'"), 'ScribeFlow loader was not cache-busted to b347');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b347'"), 'shared asset version was not bumped to b347');
assert(connect.includes("var MLS_APP_BUILD='2026-07-16-b347'"), 'app build was not bumped to b347');
