...
assert(app.includes("window.__MLS_AV='b716'"), 'ScribeFlow loader was not cache-busted to b716');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b716'"), 'shared asset version was not bumped to b716');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b716'"), 'app build was not bumped to b716');
