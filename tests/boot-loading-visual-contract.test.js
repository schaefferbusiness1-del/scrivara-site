...
assert(app.includes("window.__MLS_AV='b746'"), 'ScribeFlow loader was not cache-busted to b746');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b746'"), 'shared asset version was not bumped to b746');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b746'"), 'app build was not bumped to b746');
