...
assert(app.includes("window.__MLS_AV='b365'"), 'ScribeFlow loader was not cache-busted to b365');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b365'"), 'shared asset version was not bumped to b365');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b365'"), 'app build was not bumped to b365');
