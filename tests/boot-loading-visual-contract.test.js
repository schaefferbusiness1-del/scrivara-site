...
assert(app.includes("window.__MLS_AV='b797'"), 'ScribeFlow loader was not cache-busted to b797');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b797'"), 'shared asset version was not bumped to b797');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b797'"), 'app build was not bumped to b797');
