...
assert(app.includes("window.__MLS_AV='b860'"), 'ScribeFlow loader was not cache-busted to b860');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b860'"), 'shared asset version was not bumped to b860');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b860'"), 'app build was not bumped to b860');
