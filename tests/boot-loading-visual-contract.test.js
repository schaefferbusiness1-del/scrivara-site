...
assert(app.includes("window.__MLS_AV='b793'"), 'ScribeFlow loader was not cache-busted to b793');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b793'"), 'shared asset version was not bumped to b793');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b793'"), 'app build was not bumped to b793');
