...
assert(app.includes("window.__MLS_AV='b680'"), 'ScribeFlow loader was not cache-busted to b680');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b680'"), 'shared asset version was not bumped to b680');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b680'"), 'app build was not bumped to b680');
