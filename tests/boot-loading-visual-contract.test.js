...
assert(app.includes("window.__MLS_AV='b848'"), 'ScribeFlow loader was not cache-busted to b848');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b848'"), 'shared asset version was not bumped to b848');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b848'"), 'app build was not bumped to b848');
