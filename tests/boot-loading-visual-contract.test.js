...
assert(app.includes("window.__MLS_AV='b789'"), 'ScribeFlow loader was not cache-busted to b789');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b789'"), 'shared asset version was not bumped to b789');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b789'"), 'app build was not bumped to b789');
