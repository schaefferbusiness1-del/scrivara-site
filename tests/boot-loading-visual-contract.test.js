...
assert(app.includes("window.__MLS_AV='b899'"), 'ScribeFlow loader was not cache-busted to b899');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b899'"), 'shared asset version was not bumped to b899');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b899'"), 'app build was not bumped to b899');
