...
assert(app.includes("window.__MLS_AV='b856'"), 'ScribeFlow loader was not cache-busted to b856');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b856'"), 'shared asset version was not bumped to b856');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b856'"), 'app build was not bumped to b856');
