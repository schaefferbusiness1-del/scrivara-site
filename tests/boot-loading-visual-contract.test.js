...
assert(app.includes("window.__MLS_AV='b815'"), 'ScribeFlow loader was not cache-busted to b815');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b815'"), 'shared asset version was not bumped to b815');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b815'"), 'app build was not bumped to b815');
