...
assert(app.includes("window.__MLS_AV='b600'"), 'ScribeFlow loader was not cache-busted to b600');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b600'"), 'shared asset version was not bumped to b600');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b600'"), 'app build was not bumped to b600');
