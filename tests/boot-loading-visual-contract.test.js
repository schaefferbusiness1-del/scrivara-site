...
assert(app.includes("window.__MLS_AV=\"b309\""), 'ScribeFlow loader was not cache-busted to b309');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b309'"), 'shared asset version was not bumped to b309');
assert(connect.includes("var MLS_APP_BUILD='2026-07-15-b309'"), 'app build was not bumped to b309');
