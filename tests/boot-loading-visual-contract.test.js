...
assert(app.includes("window.__MLS_AV='b864'"), 'ScribeFlow loader was not cache-busted to b864');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b864'"), 'shared asset version was not bumped to b864');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b864'"), 'app build was not bumped to b864');
