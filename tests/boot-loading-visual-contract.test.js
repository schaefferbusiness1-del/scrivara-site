...
assert(app.includes("window.__MLS_AV='b771'"), 'ScribeFlow loader was not cache-busted to b771');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b771'"), 'shared asset version was not bumped to b771');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b771'"), 'app build was not bumped to b771');
