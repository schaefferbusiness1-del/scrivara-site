...
assert(app.includes("window.__MLS_AV='b927'"), 'ScribeFlow loader was not cache-busted to b927');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b927'"), 'shared asset version was not bumped to b927');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b927'"), 'app build was not bumped to b927');
