...
assert(app.includes("window.__MLS_AV='b389'"), 'ScribeFlow loader was not cache-busted to b389');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b389'"), 'shared asset version was not bumped to b389');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b389'"), 'app build was not bumped to b389');
