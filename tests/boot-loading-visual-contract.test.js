...
assert(app.includes("window.__MLS_AV='b535'"), 'ScribeFlow loader was not cache-busted to b535');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b535'"), 'shared asset version was not bumped to b535');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b535'"), 'app build was not bumped to b535');
