...
assert(app.includes("window.__MLS_AV='b519'"), 'ScribeFlow loader was not cache-busted to b519');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b519'"), 'shared asset version was not bumped to b519');
assert(connect.includes("var MLS_APP_BUILD='2026-07-23-b519'"), 'app build was not bumped to b519');
