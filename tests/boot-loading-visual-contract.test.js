...
assert(app.includes("window.__MLS_AV='b670'"), 'ScribeFlow loader was not cache-busted to b670');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b670'"), 'shared asset version was not bumped to b670');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b670'"), 'app build was not bumped to b670');
