...
assert(app.includes("window.__MLS_AV='b630'"), 'ScribeFlow loader was not cache-busted to b630');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b630'"), 'shared asset version was not bumped to b630');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b630'"), 'app build was not bumped to b630');
