...
assert(app.includes("window.__MLS_AV='b676'"), 'ScribeFlow loader was not cache-busted to b676');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b676'"), 'shared asset version was not bumped to b676');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b676'"), 'app build was not bumped to b676');
