...
assert(app.includes("window.__MLS_AV='b682'"), 'ScribeFlow loader was not cache-busted to b682');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b682'"), 'shared asset version was not bumped to b682');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b682'"), 'app build was not bumped to b682');
