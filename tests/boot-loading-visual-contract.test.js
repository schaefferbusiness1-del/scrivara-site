...
assert(app.includes("window.__MLS_AV='b588'"), 'ScribeFlow loader was not cache-busted to b588');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b588'"), 'shared asset version was not bumped to b588');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b588'"), 'app build was not bumped to b588');
