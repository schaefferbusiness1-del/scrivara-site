...
assert(app.includes("window.__MLS_AV='b812'"), 'ScribeFlow loader was not cache-busted to b812');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b812'"), 'shared asset version was not bumped to b812');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b812'"), 'app build was not bumped to b812');
