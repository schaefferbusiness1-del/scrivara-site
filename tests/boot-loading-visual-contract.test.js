...
assert(app.includes("window.__MLS_AV='b945'"), 'ScribeFlow loader was not cache-busted to b945');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b945'"), 'shared asset version was not bumped to b945');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b945'"), 'app build was not bumped to b945');
