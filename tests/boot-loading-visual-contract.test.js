...
assert(app.includes("window.__MLS_AV='b645'"), 'ScribeFlow loader was not cache-busted to b645');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b645'"), 'shared asset version was not bumped to b645');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b645'"), 'app build was not bumped to b645');
