...
assert(app.includes("window.__MLS_AV='b631'"), 'ScribeFlow loader was not cache-busted to b631');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b631'"), 'shared asset version was not bumped to b631');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b631'"), 'app build was not bumped to b631');
