...
assert(app.includes("window.__MLS_AV='b972'"), 'ScribeFlow loader was not cache-busted to b972');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b972'"), 'shared asset version was not bumped to b972');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b972'"), 'app build was not bumped to b972');
