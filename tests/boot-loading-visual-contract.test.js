...
assert(app.includes("window.__MLS_AV='b785'"), 'ScribeFlow loader was not cache-busted to b785');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b785'"), 'shared asset version was not bumped to b785');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b785'"), 'app build was not bumped to b785');
