...
assert(app.includes("window.__MLS_AV='b498'"), 'ScribeFlow loader was not cache-busted to b498');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b498'"), 'shared asset version was not bumped to b498');
assert(connect.includes("var MLS_APP_BUILD='2026-07-23-b498'"), 'app build was not bumped to b498');
