...
assert(app.includes("window.__MLS_AV='b416'"), 'ScribeFlow loader was not cache-busted to b416');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b416'"), 'shared asset version was not bumped to b416');
assert(connect.includes("var MLS_APP_BUILD='2026-07-18-b416'"), 'app build was not bumped to b416');
