...
assert(app.includes("window.__MLS_AV='b810'"), 'ScribeFlow loader was not cache-busted to b810');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b810'"), 'shared asset version was not bumped to b810');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b810'"), 'app build was not bumped to b810');
