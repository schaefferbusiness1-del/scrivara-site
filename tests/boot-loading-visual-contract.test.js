...
assert(app.includes("window.__MLS_AV='b418'"), 'ScribeFlow loader was not cache-busted to b418');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b418'"), 'shared asset version was not bumped to b418');
assert(connect.includes("var MLS_APP_BUILD='2026-07-18-b418'"), 'app build was not bumped to b418');
