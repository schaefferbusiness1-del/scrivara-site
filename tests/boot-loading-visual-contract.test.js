...
assert(app.includes("window.__MLS_AV='b699'"), 'ScribeFlow loader was not cache-busted to b699');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b699'"), 'shared asset version was not bumped to b699');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b699'"), 'app build was not bumped to b699');
