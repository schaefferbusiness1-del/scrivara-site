...
assert(app.includes("window.__MLS_AV=\"b295\""), 'ScribeFlow loader was not cache-busted to b295');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b295'"), 'shared asset version was not bumped to b295');
assert(connect.includes("var MLS_APP_BUILD='2026-07-15-b295'"), 'app build was not bumped to b295');
