...
assert(app.includes("window.__MLS_AV='b667'"), 'ScribeFlow loader was not cache-busted to b667');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b667'"), 'shared asset version was not bumped to b667');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b667'"), 'app build was not bumped to b667');
