...
assert(app.includes("window.__MLS_AV='b368'"), 'ScribeFlow loader was not cache-busted to b368');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b368'"), 'shared asset version was not bumped to b368');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b368'"), 'app build was not bumped to b368');
