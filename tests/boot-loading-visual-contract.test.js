...
assert(app.includes("window.__MLS_AV='b959'"), 'ScribeFlow loader was not cache-busted to b959');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b959'"), 'shared asset version was not bumped to b959');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b959'"), 'app build was not bumped to b959');
