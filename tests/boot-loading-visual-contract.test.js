...
assert(app.includes("window.__MLS_AV='b611'"), 'ScribeFlow loader was not cache-busted to b611');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b611'"), 'shared asset version was not bumped to b611');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b611'"), 'app build was not bumped to b611');
