...
assert(app.includes("window.__MLS_AV='b663'"), 'ScribeFlow loader was not cache-busted to b663');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b663'"), 'shared asset version was not bumped to b663');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b663'"), 'app build was not bumped to b663');
