...
assert(app.includes("window.__MLS_AV='b761'"), 'ScribeFlow loader was not cache-busted to b761');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b761'"), 'shared asset version was not bumped to b761');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b761'"), 'app build was not bumped to b761');
