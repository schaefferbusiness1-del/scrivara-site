...
assert(app.includes("window.__MLS_AV='b1032'"), 'ScribeFlow loader was not cache-busted to b1032');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b1032'"), 'shared asset version was not bumped to b1032');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b1032'"), 'app build was not bumped to b1032');
