...
assert(app.includes("window.__MLS_AV='b743'"), 'ScribeFlow loader was not cache-busted to b743');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b743'"), 'shared asset version was not bumped to b743');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b743'"), 'app build was not bumped to b743');
