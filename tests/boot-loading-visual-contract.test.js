...
assert(app.includes("window.__MLS_AV='b757'"), 'ScribeFlow loader was not cache-busted to b757');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b757'"), 'shared asset version was not bumped to b757');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b757'"), 'app build was not bumped to b757');
