...
assert(app.includes("window.__MLS_AV='b992'"), 'ScribeFlow loader was not cache-busted to b992');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b992'"), 'shared asset version was not bumped to b992');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b992'"), 'app build was not bumped to b992');
