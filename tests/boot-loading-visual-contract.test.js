...
assert(app.includes("window.__MLS_AV='b910'"), 'ScribeFlow loader was not cache-busted to b910');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b910'"), 'shared asset version was not bumped to b910');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b910'"), 'app build was not bumped to b910');
