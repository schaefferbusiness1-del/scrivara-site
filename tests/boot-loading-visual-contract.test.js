...
assert(app.includes("window.__MLS_AV='b665'"), 'ScribeFlow loader was not cache-busted to b665');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b665'"), 'shared asset version was not bumped to b665');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b665'"), 'app build was not bumped to b665');
