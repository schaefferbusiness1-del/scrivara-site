...
assert(app.includes("window.__MLS_AV='b354'"), 'ScribeFlow loader was not cache-busted to b354');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b354'"), 'shared asset version was not bumped to b354');
assert(connect.includes("var MLS_APP_BUILD='2026-07-16-b354'"), 'app build was not bumped to b354');
