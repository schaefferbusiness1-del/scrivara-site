...
assert(app.includes("window.__MLS_AV='b943'"), 'ScribeFlow loader was not cache-busted to b943');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b943'"), 'shared asset version was not bumped to b943');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b943'"), 'app build was not bumped to b943');
