...
assert(app.includes("window.__MLS_AV='b542'"), 'ScribeFlow loader was not cache-busted to b542');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b542'"), 'shared asset version was not bumped to b542');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b542'"), 'app build was not bumped to b542');
