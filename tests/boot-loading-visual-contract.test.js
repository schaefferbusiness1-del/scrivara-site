...
assert(app.includes("window.__MLS_AV='b497'"), 'ScribeFlow loader was not cache-busted to b497');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b497'"), 'shared asset version was not bumped to b497');
assert(connect.includes("var MLS_APP_BUILD='2026-07-21-b497'"), 'app build was not bumped to b497');
