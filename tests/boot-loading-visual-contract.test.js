...
assert(app.includes("window.__MLS_AV='b363'"), 'ScribeFlow loader was not cache-busted to b363');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b363'"), 'shared asset version was not bumped to b363');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b363'"), 'app build was not bumped to b363');
