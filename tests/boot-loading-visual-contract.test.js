...
assert(app.includes("window.__MLS_AV='b522'"), 'ScribeFlow loader was not cache-busted to b522');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b522'"), 'shared asset version was not bumped to b522');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b522'"), 'app build was not bumped to b522');
