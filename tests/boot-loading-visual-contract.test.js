...
assert(app.includes("window.__MLS_AV=\"b299\""), 'ScribeFlow loader was not cache-busted to b299');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b299'"), 'shared asset version was not bumped to b299');
assert(connect.includes("var MLS_APP_BUILD='2026-07-15-b299'"), 'app build was not bumped to b299');
