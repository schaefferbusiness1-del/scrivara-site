...
assert(app.includes("window.__MLS_AV='b625'"), 'ScribeFlow loader was not cache-busted to b625');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b625'"), 'shared asset version was not bumped to b625');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b625'"), 'app build was not bumped to b625');
