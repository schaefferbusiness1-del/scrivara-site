...
assert(app.includes("window.__MLS_AV='b750'"), 'ScribeFlow loader was not cache-busted to b750');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b750'"), 'shared asset version was not bumped to b750');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b750'"), 'app build was not bumped to b750');
