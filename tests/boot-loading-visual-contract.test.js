...
assert(app.includes("window.__MLS_AV='b379'"), 'ScribeFlow loader was not cache-busted to b379');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b379'"), 'shared asset version was not bumped to b379');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b379'"), 'app build was not bumped to b379');
