...
assert(app.includes("window.__MLS_AV='b345'"), 'ScribeFlow loader was not cache-busted to b345');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b345'"), 'shared asset version was not bumped to b345');
assert(connect.includes("var MLS_APP_BUILD='2026-07-16-b345'"), 'app build was not bumped to b345');
