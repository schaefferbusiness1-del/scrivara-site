...
assert(app.includes("window.__MLS_AV='b563'"), 'ScribeFlow loader was not cache-busted to b563');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b563'"), 'shared asset version was not bumped to b563');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b563'"), 'app build was not bumped to b563');
