...
assert(app.includes("window.__MLS_AV='b556'"), 'ScribeFlow loader was not cache-busted to b556');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b556'"), 'shared asset version was not bumped to b556');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b556'"), 'app build was not bumped to b556');
