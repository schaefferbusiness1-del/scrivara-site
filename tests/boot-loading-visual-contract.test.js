...
assert(app.includes("window.__MLS_AV='b592'"), 'ScribeFlow loader was not cache-busted to b592');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b592'"), 'shared asset version was not bumped to b592');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b592'"), 'app build was not bumped to b592');
