...
assert(app.includes("window.__MLS_AV='b582'"), 'ScribeFlow loader was not cache-busted to b582');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b582'"), 'shared asset version was not bumped to b582');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b582'"), 'app build was not bumped to b582');
