...
assert(app.includes("window.__MLS_AV='b346'"), 'ScribeFlow loader was not cache-busted to b346');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b346'"), 'shared asset version was not bumped to b346');
assert(connect.includes("var MLS_APP_BUILD='2026-07-16-b346'"), 'app build was not bumped to b346');
