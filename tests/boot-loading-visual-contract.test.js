...
assert(app.includes("window.__MLS_AV='b798'"), 'ScribeFlow loader was not cache-busted to b798');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b798'"), 'shared asset version was not bumped to b798');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b798'"), 'app build was not bumped to b798');
