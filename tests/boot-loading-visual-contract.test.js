...
assert(app.includes("window.__MLS_AV='b608'"), 'ScribeFlow loader was not cache-busted to b608');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b608'"), 'shared asset version was not bumped to b608');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b608'"), 'app build was not bumped to b608');
