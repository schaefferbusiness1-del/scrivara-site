...
assert(app.includes("window.__MLS_AV='b523'"), 'ScribeFlow loader was not cache-busted to b523');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b523'"), 'shared asset version was not bumped to b523');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b523'"), 'app build was not bumped to b523');
