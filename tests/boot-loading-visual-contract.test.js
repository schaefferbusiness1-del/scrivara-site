...
assert(app.includes("window.__MLS_AV='b597'"), 'ScribeFlow loader was not cache-busted to b597');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b597'"), 'shared asset version was not bumped to b597');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b597'"), 'app build was not bumped to b597');
