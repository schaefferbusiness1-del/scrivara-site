...
assert(app.includes("window.__MLS_AV='b692'"), 'ScribeFlow loader was not cache-busted to b692');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b692'"), 'shared asset version was not bumped to b692');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b692'"), 'app build was not bumped to b692');
