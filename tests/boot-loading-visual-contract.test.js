...
assert(app.includes("window.__MLS_AV='b987'"), 'ScribeFlow loader was not cache-busted to b987');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b987'"), 'shared asset version was not bumped to b987');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b987'"), 'app build was not bumped to b987');
