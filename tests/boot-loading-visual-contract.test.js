...
assert(app.includes("window.__MLS_AV='b768'"), 'ScribeFlow loader was not cache-busted to b768');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b768'"), 'shared asset version was not bumped to b768');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b768'"), 'app build was not bumped to b768');
