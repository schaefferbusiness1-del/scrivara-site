...
assert(app.includes("window.__MLS_AV='b414'"), 'ScribeFlow loader was not cache-busted to b414');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b414'"), 'shared asset version was not bumped to b414');
assert(connect.includes("var MLS_APP_BUILD='2026-07-18-b414'"), 'app build was not bumped to b414');
