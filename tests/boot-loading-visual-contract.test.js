...
assert(app.includes("window.__MLS_AV='b646'"), 'ScribeFlow loader was not cache-busted to b646');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b646'"), 'shared asset version was not bumped to b646');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b646'"), 'app build was not bumped to b646');
