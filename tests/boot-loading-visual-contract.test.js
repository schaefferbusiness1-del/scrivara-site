...
assert(app.includes("window.__MLS_AV='b767'"), 'ScribeFlow loader was not cache-busted to b767');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b767'"), 'shared asset version was not bumped to b767');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b767'"), 'app build was not bumped to b767');
