...
assert(app.includes("window.__MLS_AV='b1001'"), 'ScribeFlow loader was not cache-busted to b1001');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b1001'"), 'shared asset version was not bumped to b1001');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b1001'"), 'app build was not bumped to b1001');
