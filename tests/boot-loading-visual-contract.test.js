...
assert(app.includes("window.__MLS_AV='b639'"), 'ScribeFlow loader was not cache-busted to b639');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b639'"), 'shared asset version was not bumped to b639');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b639'"), 'app build was not bumped to b639');
