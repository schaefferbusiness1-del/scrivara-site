...
assert(app.includes("window.__MLS_AV='b877'"), 'ScribeFlow loader was not cache-busted to b877');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b877'"), 'shared asset version was not bumped to b877');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b877'"), 'app build was not bumped to b877');
