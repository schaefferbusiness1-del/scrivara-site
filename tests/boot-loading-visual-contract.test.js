...
assert(app.includes("window.__MLS_AV='b764'"), 'ScribeFlow loader was not cache-busted to b764');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b764'"), 'shared asset version was not bumped to b764');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b764'"), 'app build was not bumped to b764');
