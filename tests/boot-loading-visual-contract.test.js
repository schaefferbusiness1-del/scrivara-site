...
assert(app.includes("window.__MLS_AV='b672'"), 'ScribeFlow loader was not cache-busted to b672');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b672'"), 'shared asset version was not bumped to b672');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b672'"), 'app build was not bumped to b672');
