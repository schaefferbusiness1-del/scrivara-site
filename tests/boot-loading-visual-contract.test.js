...
assert(app.includes("window.__MLS_AV='b499'"), 'ScribeFlow loader was not cache-busted to b499');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b499'"), 'shared asset version was not bumped to b499');
assert(connect.includes("var MLS_APP_BUILD='2026-07-23-b499'"), 'app build was not bumped to b499');
