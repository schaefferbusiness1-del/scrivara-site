...
assert(app.includes("window.__MLS_AV='b887'"), 'ScribeFlow loader was not cache-busted to b887');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b887'"), 'shared asset version was not bumped to b887');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b887'"), 'app build was not bumped to b887');
