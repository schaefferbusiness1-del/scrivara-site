...
assert(app.includes("window.__MLS_AV='b941'"), 'ScribeFlow loader was not cache-busted to b941');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b941'"), 'shared asset version was not bumped to b941');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b941'"), 'app build was not bumped to b941');
