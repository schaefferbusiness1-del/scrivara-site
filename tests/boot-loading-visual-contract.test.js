...
assert(app.includes("window.__MLS_AV='b352'"), 'ScribeFlow loader was not cache-busted to b352');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b352'"), 'shared asset version was not bumped to b352');
assert(connect.includes("var MLS_APP_BUILD='2026-07-16-b352'"), 'app build was not bumped to b352');
