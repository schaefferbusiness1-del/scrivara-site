...
assert(app.includes("window.__MLS_AV='b599'"), 'ScribeFlow loader was not cache-busted to b599');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b599'"), 'shared asset version was not bumped to b599');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b599'"), 'app build was not bumped to b599');
