...
assert(app.includes("window.__MLS_AV='b841'"), 'ScribeFlow loader was not cache-busted to b841');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b841'"), 'shared asset version was not bumped to b841');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b841'"), 'app build was not bumped to b841');
