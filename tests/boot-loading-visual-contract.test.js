...
assert(app.includes("window.__MLS_AV='b869'"), 'ScribeFlow loader was not cache-busted to b869');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b869'"), 'shared asset version was not bumped to b869');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b869'"), 'app build was not bumped to b869');
