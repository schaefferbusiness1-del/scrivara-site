...
assert(app.includes("window.__MLS_AV='b784'"), 'ScribeFlow loader was not cache-busted to b784');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b784'"), 'shared asset version was not bumped to b784');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b784'"), 'app build was not bumped to b784');
