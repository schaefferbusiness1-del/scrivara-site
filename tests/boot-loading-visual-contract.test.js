...
assert(app.includes("window.__MLS_AV='b575'"), 'ScribeFlow loader was not cache-busted to b575');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b575'"), 'shared asset version was not bumped to b575');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b575'"), 'app build was not bumped to b575');
