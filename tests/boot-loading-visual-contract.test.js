...
assert(app.includes("window.__MLS_AV='b496'"), 'ScribeFlow loader was not cache-busted to b496');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b496'"), 'shared asset version was not bumped to b496');
assert(connect.includes("var MLS_APP_BUILD='2026-07-21-b496'"), 'app build was not bumped to b496');
