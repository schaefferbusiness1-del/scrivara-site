...
assert(app.includes("window.__MLS_AV='b775'"), 'ScribeFlow loader was not cache-busted to b775');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b775'"), 'shared asset version was not bumped to b775');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b775'"), 'app build was not bumped to b775');
