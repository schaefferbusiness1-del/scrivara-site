...
assert(app.includes("window.__MLS_AV='b509'"), 'ScribeFlow loader was not cache-busted to b509');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b509'"), 'shared asset version was not bumped to b509');
assert(connect.includes("var MLS_APP_BUILD='2026-07-23-b509'"), 'app build was not bumped to b509');
