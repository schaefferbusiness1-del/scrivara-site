...
assert(app.includes("window.__MLS_AV='b607'"), 'ScribeFlow loader was not cache-busted to b607');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b607'"), 'shared asset version was not bumped to b607');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b607'"), 'app build was not bumped to b607');
