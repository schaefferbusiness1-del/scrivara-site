...
assert(app.includes("window.__MLS_AV='b954'"), 'ScribeFlow loader was not cache-busted to b954');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b954'"), 'shared asset version was not bumped to b954');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b954'"), 'app build was not bumped to b954');
