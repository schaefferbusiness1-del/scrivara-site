...
assert(app.includes("window.__MLS_AV='b918'"), 'ScribeFlow loader was not cache-busted to b918');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b918'"), 'shared asset version was not bumped to b918');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b918'"), 'app build was not bumped to b918');
