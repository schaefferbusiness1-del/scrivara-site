...
assert(app.includes("window.__MLS_AV='b826'"), 'ScribeFlow loader was not cache-busted to b826');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b826'"), 'shared asset version was not bumped to b826');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b826'"), 'app build was not bumped to b826');
