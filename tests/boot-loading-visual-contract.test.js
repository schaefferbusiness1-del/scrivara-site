...
assert(app.includes("window.__MLS_AV='b718'"), 'ScribeFlow loader was not cache-busted to b718');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b718'"), 'shared asset version was not bumped to b718');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b718'"), 'app build was not bumped to b718');
