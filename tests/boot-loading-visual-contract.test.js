...
assert(app.includes("window.__MLS_AV='b480'"), 'ScribeFlow loader was not cache-busted to b480');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b480'"), 'shared asset version was not bumped to b480');
assert(connect.includes("var MLS_APP_BUILD='2026-07-21-b480'"), 'app build was not bumped to b480');
