...
assert(app.includes("window.__MLS_AV='b791'"), 'ScribeFlow loader was not cache-busted to b791');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b791'"), 'shared asset version was not bumped to b791');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b791'"), 'app build was not bumped to b791');
