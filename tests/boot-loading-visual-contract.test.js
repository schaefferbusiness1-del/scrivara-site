...
assert(app.includes("window.__MLS_AV='b898'"), 'ScribeFlow loader was not cache-busted to b898');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b898'"), 'shared asset version was not bumped to b898');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b898'"), 'app build was not bumped to b898');
