...
assert(app.includes("window.__MLS_AV='b980'"), 'ScribeFlow loader was not cache-busted to b980');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b980'"), 'shared asset version was not bumped to b980');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b980'"), 'app build was not bumped to b980');
