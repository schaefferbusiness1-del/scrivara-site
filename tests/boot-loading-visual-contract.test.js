...
assert(app.includes("window.__MLS_AV='b859'"), 'ScribeFlow loader was not cache-busted to b859');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b859'"), 'shared asset version was not bumped to b859');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b859'"), 'app build was not bumped to b859');
