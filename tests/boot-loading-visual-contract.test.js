...
assert(app.includes("window.__MLS_AV='b338'"), 'ScribeFlow loader was not cache-busted to b338');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b338'"), 'shared asset version was not bumped to b338');
assert(connect.includes("var MLS_APP_BUILD='2026-07-16-b338'"), 'app build was not bumped to b338');
