...
assert(app.includes("window.__MLS_AV='b621'"), 'ScribeFlow loader was not cache-busted to b621');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b621'"), 'shared asset version was not bumped to b621');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b621'"), 'app build was not bumped to b621');
