...
assert(app.includes("window.__MLS_AV='b490'"), 'ScribeFlow loader was not cache-busted to b490');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b490'"), 'shared asset version was not bumped to b490');
assert(connect.includes("var MLS_APP_BUILD='2026-07-21-b490'"), 'app build was not bumped to b490');
