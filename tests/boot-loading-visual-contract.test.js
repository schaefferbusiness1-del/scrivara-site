...
assert(app.includes("window.__MLS_AV='b735'"), 'ScribeFlow loader was not cache-busted to b735');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b735'"), 'shared asset version was not bumped to b735');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b735'"), 'app build was not bumped to b735');
