...
assert(app.includes("window.__MLS_AV='b696'"), 'ScribeFlow loader was not cache-busted to b696');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b696'"), 'shared asset version was not bumped to b696');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b696'"), 'app build was not bumped to b696');
