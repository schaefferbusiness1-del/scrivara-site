...
assert(app.includes("window.__MLS_AV='b541'"), 'ScribeFlow loader was not cache-busted to b541');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b541'"), 'shared asset version was not bumped to b541');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b541'"), 'app build was not bumped to b541');
