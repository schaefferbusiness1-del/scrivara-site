...
assert(app.includes("window.__MLS_AV='b766'"), 'ScribeFlow loader was not cache-busted to b766');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b766'"), 'shared asset version was not bumped to b766');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b766'"), 'app build was not bumped to b766');
