...
assert(app.includes("window.__MLS_AV='b747'"), 'ScribeFlow loader was not cache-busted to b747');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b747'"), 'shared asset version was not bumped to b747');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b747'"), 'app build was not bumped to b747');
