...
assert(app.includes("window.__MLS_AV='b703'"), 'ScribeFlow loader was not cache-busted to b703');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b703'"), 'shared asset version was not bumped to b703');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b703'"), 'app build was not bumped to b703');
