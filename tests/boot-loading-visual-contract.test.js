...
assert(app.includes("window.__MLS_AV='b804'"), 'ScribeFlow loader was not cache-busted to b804');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b804'"), 'shared asset version was not bumped to b804');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b804'"), 'app build was not bumped to b804');
