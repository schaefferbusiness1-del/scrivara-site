...
assert(app.includes("window.__MLS_AV='b834'"), 'ScribeFlow loader was not cache-busted to b834');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b834'"), 'shared asset version was not bumped to b834');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b834'"), 'app build was not bumped to b834');
