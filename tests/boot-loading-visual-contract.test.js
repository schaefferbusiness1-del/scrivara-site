...
assert(app.includes("window.__MLS_AV='b829'"), 'ScribeFlow loader was not cache-busted to b829');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b829'"), 'shared asset version was not bumped to b829');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b829'"), 'app build was not bumped to b829');
