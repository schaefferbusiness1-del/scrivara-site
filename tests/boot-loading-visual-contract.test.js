...
assert(app.includes("window.__MLS_AV='b842'"), 'ScribeFlow loader was not cache-busted to b842');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b842'"), 'shared asset version was not bumped to b842');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b842'"), 'app build was not bumped to b842');
