...
assert(app.includes("window.__MLS_AV='b493'"), 'ScribeFlow loader was not cache-busted to b493');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b493'"), 'shared asset version was not bumped to b493');
assert(connect.includes("var MLS_APP_BUILD='2026-07-21-b493'"), 'app build was not bumped to b493');
