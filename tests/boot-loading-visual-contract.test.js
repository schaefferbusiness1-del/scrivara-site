...
assert(app.includes("window.__MLS_AV='b897'"), 'ScribeFlow loader was not cache-busted to b897');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b897'"), 'shared asset version was not bumped to b897');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b897'"), 'app build was not bumped to b897');
