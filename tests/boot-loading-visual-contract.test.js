...
assert(app.includes("window.__MLS_AV=\"b302\""), 'ScribeFlow loader was not cache-busted to b302');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b302'"), 'shared asset version was not bumped to b302');
assert(connect.includes("var MLS_APP_BUILD='2026-07-15-b302'"), 'app build was not bumped to b302');
