...
assert(app.includes("window.__MLS_AV='b614'"), 'ScribeFlow loader was not cache-busted to b614');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b614'"), 'shared asset version was not bumped to b614');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b614'"), 'app build was not bumped to b614');
