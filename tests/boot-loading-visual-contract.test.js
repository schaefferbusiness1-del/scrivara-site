...
assert(app.includes("window.__MLS_AV='b966'"), 'ScribeFlow loader was not cache-busted to b966');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b966'"), 'shared asset version was not bumped to b966');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b966'"), 'app build was not bumped to b966');
