...
assert(app.includes("window.__MLS_AV='b751'"), 'ScribeFlow loader was not cache-busted to b751');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b751'"), 'shared asset version was not bumped to b751');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b751'"), 'app build was not bumped to b751');
