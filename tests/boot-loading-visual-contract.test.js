...
assert(app.includes("window.__MLS_AV='b738'"), 'ScribeFlow loader was not cache-busted to b738');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b738'"), 'shared asset version was not bumped to b738');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b738'"), 'app build was not bumped to b738');
