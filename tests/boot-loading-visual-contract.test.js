...
assert(app.includes("window.__MLS_AV='b393'"), 'ScribeFlow loader was not cache-busted to b393');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b393'"), 'shared asset version was not bumped to b393');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b393'"), 'app build was not bumped to b393');
