...
assert(app.includes("window.__MLS_AV='b641'"), 'ScribeFlow loader was not cache-busted to b641');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b641'"), 'shared asset version was not bumped to b641');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b641'"), 'app build was not bumped to b641');
