...
assert(app.includes("window.__MLS_AV='b975'"), 'ScribeFlow loader was not cache-busted to b975');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b975'"), 'shared asset version was not bumped to b975');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b975'"), 'app build was not bumped to b975');
