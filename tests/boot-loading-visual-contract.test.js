...
assert(app.includes("window.__MLS_AV='b991'"), 'ScribeFlow loader was not cache-busted to b991');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b991'"), 'shared asset version was not bumped to b991');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b991'"), 'app build was not bumped to b991');
