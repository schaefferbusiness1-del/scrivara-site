...
assert(app.includes("window.__MLS_AV='b893'"), 'ScribeFlow loader was not cache-busted to b893');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b893'"), 'shared asset version was not bumped to b893');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b893'"), 'app build was not bumped to b893');
