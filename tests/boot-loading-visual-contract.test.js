...
assert(app.includes("window.__MLS_AV='b813'"), 'ScribeFlow loader was not cache-busted to b813');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b813'"), 'shared asset version was not bumped to b813');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b813'"), 'app build was not bumped to b813');
