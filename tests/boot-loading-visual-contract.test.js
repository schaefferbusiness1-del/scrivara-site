...
assert(app.includes("window.__MLS_AV='b702'"), 'ScribeFlow loader was not cache-busted to b702');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b702'"), 'shared asset version was not bumped to b702');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b702'"), 'app build was not bumped to b702');
