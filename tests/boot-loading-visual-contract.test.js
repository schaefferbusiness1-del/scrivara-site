...
assert(app.includes("window.__MLS_AV='b973'"), 'ScribeFlow loader was not cache-busted to b973');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b973'"), 'shared asset version was not bumped to b973');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b973'"), 'app build was not bumped to b973');
