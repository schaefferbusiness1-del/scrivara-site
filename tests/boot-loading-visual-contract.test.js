...
assert(app.includes("window.__MLS_AV='b697'"), 'ScribeFlow loader was not cache-busted to b697');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b697'"), 'shared asset version was not bumped to b697');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b697'"), 'app build was not bumped to b697');
