...
assert(app.includes("window.__MLS_AV='b636'"), 'ScribeFlow loader was not cache-busted to b636');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b636'"), 'shared asset version was not bumped to b636');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b636'"), 'app build was not bumped to b636');
