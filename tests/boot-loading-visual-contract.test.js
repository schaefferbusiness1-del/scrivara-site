...
assert(app.includes("window.__MLS_AV='b686'"), 'ScribeFlow loader was not cache-busted to b686');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b686'"), 'shared asset version was not bumped to b686');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b686'"), 'app build was not bumped to b686');
