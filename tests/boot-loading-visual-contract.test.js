...
assert(app.includes("window.__MLS_AV='b763'"), 'ScribeFlow loader was not cache-busted to b763');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b763'"), 'shared asset version was not bumped to b763');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b763'"), 'app build was not bumped to b763');
