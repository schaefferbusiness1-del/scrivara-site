...
assert(app.includes("window.__MLS_AV='b508'"), 'ScribeFlow loader was not cache-busted to b508');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b508'"), 'shared asset version was not bumped to b508');
assert(connect.includes("var MLS_APP_BUILD='2026-07-23-b508'"), 'app build was not bumped to b508');
