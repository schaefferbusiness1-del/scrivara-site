...
assert(app.includes("window.__MLS_AV='b967'"), 'ScribeFlow loader was not cache-busted to b967');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b967'"), 'shared asset version was not bumped to b967');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b967'"), 'app build was not bumped to b967');
