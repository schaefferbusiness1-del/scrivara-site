...
assert(app.includes("window.__MLS_AV='b969'"), 'ScribeFlow loader was not cache-busted to b969');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b969'"), 'shared asset version was not bumped to b969');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b969'"), 'app build was not bumped to b969');
