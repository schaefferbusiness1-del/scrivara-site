...
assert(app.includes("window.__MLS_AV='b518'"), 'ScribeFlow loader was not cache-busted to b518');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b518'"), 'shared asset version was not bumped to b518');
assert(connect.includes("var MLS_APP_BUILD='2026-07-23-b518'"), 'app build was not bumped to b518');
