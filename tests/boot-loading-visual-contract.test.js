...
assert(app.includes("window.__MLS_AV='b862'"), 'ScribeFlow loader was not cache-busted to b862');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b862'"), 'shared asset version was not bumped to b862');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b862'"), 'app build was not bumped to b862');
