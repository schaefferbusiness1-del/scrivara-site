...
assert(app.includes("window.__MLS_AV='b871'"), 'ScribeFlow loader was not cache-busted to b871');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b871'"), 'shared asset version was not bumped to b871');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b871'"), 'app build was not bumped to b871');
