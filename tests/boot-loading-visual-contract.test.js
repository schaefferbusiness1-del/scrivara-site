...
assert(app.includes("window.__MLS_AV='b398'"), 'ScribeFlow loader was not cache-busted to b398');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b398'"), 'shared asset version was not bumped to b398');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b398'"), 'app build was not bumped to b398');
