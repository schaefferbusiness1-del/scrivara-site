...
assert(app.includes("window.__MLS_AV='b538'"), 'ScribeFlow loader was not cache-busted to b538');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b538'"), 'shared asset version was not bumped to b538');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b538'"), 'app build was not bumped to b538');
