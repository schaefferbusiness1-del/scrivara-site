...
assert(app.includes("window.__MLS_AV='b909'"), 'ScribeFlow loader was not cache-busted to b909');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b909'"), 'shared asset version was not bumped to b909');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b909'"), 'app build was not bumped to b909');
