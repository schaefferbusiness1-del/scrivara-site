...
assert(app.includes("window.__MLS_AV='b1034'"), 'ScribeFlow loader was not cache-busted to b1034');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b1034'"), 'shared asset version was not bumped to b1034');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b1034'"), 'app build was not bumped to b1034');
