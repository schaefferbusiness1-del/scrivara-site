...
assert(app.includes("window.__MLS_AV='b928'"), 'ScribeFlow loader was not cache-busted to b928');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b928'"), 'shared asset version was not bumped to b928');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b928'"), 'app build was not bumped to b928');
