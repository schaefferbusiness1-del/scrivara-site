...
assert(app.includes("window.__MLS_AV='b685'"), 'ScribeFlow loader was not cache-busted to b685');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b685'"), 'shared asset version was not bumped to b685');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b685'"), 'app build was not bumped to b685');
