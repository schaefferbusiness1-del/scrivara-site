...
assert(app.includes("window.__MLS_AV='b500'"), 'ScribeFlow loader was not cache-busted to b500');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b500'"), 'shared asset version was not bumped to b500');
assert(connect.includes("var MLS_APP_BUILD='2026-07-23-b500'"), 'app build was not bumped to b500');
