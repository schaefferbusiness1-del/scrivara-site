...
assert(app.includes("window.__MLS_AV='b796'"), 'ScribeFlow loader was not cache-busted to b796');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b796'"), 'shared asset version was not bumped to b796');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b796'"), 'app build was not bumped to b796');
