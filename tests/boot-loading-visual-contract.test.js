...
assert(app.includes("window.__MLS_AV='b543'"), 'ScribeFlow loader was not cache-busted to b543');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b543'"), 'shared asset version was not bumped to b543');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b543'"), 'app build was not bumped to b543');
