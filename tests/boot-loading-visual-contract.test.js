...
assert(app.includes("window.__MLS_AV='b325'"), 'ScribeFlow loader was not cache-busted to b325');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b325'"), 'shared asset version was not bumped to b325');
assert(connect.includes("var MLS_APP_BUILD='2026-07-16-b325'"), 'app build was not bumped to b325');
