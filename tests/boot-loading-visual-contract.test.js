...
assert(app.includes("window.__MLS_AV='b948'"), 'ScribeFlow loader was not cache-busted to b948');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b948'"), 'shared asset version was not bumped to b948');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b948'"), 'app build was not bumped to b948');
