...
assert(app.includes("window.__MLS_AV='b861'"), 'ScribeFlow loader was not cache-busted to b861');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b861'"), 'shared asset version was not bumped to b861');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b861'"), 'app build was not bumped to b861');
