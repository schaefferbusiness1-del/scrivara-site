...
assert(app.includes("window.__MLS_AV='b903'"), 'ScribeFlow loader was not cache-busted to b903');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b903'"), 'shared asset version was not bumped to b903');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b903'"), 'app build was not bumped to b903');
