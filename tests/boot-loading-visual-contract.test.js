...
assert(app.includes("window.__MLS_AV='b724'"), 'ScribeFlow loader was not cache-busted to b724');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b724'"), 'shared asset version was not bumped to b724');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b724'"), 'app build was not bumped to b724');
