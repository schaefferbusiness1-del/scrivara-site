...
assert(app.includes("window.__MLS_AV='b579'"), 'ScribeFlow loader was not cache-busted to b579');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b579'"), 'shared asset version was not bumped to b579');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b579'"), 'app build was not bumped to b579');
