...
assert(app.includes("window.__MLS_AV='b593'"), 'ScribeFlow loader was not cache-busted to b593');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b593'"), 'shared asset version was not bumped to b593');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b593'"), 'app build was not bumped to b593');
