...
assert(app.includes("window.__MLS_AV='b656'"), 'ScribeFlow loader was not cache-busted to b656');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b656'"), 'shared asset version was not bumped to b656');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b656'"), 'app build was not bumped to b656');
