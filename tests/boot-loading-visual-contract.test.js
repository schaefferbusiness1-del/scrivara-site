...
assert(app.includes("window.__MLS_AV='b635'"), 'ScribeFlow loader was not cache-busted to b635');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b635'"), 'shared asset version was not bumped to b635');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b635'"), 'app build was not bumped to b635');
