...
assert(app.includes("window.__MLS_AV='b580'"), 'ScribeFlow loader was not cache-busted to b580');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b580'"), 'shared asset version was not bumped to b580');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b580'"), 'app build was not bumped to b580');
