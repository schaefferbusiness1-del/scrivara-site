...
assert(app.includes("window.__MLS_AV=\"b297\""), 'ScribeFlow loader was not cache-busted to b297');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b297'"), 'shared asset version was not bumped to b297');
assert(connect.includes("var MLS_APP_BUILD='2026-07-15-b297'"), 'app build was not bumped to b297');
