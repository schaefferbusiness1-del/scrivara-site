...
assert(app.includes("window.__MLS_AV='b652'"), 'ScribeFlow loader was not cache-busted to b652');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b652'"), 'shared asset version was not bumped to b652');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b652'"), 'app build was not bumped to b652');
