...
assert(app.includes("window.__MLS_AV='b845'"), 'ScribeFlow loader was not cache-busted to b845');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b845'"), 'shared asset version was not bumped to b845');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b845'"), 'app build was not bumped to b845');
