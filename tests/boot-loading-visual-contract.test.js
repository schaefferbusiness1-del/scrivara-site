...
assert(app.includes("window.__MLS_AV='b868'"), 'ScribeFlow loader was not cache-busted to b868');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b868'"), 'shared asset version was not bumped to b868');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b868'"), 'app build was not bumped to b868');
