...
assert(app.includes("window.__MLS_AV='b756'"), 'ScribeFlow loader was not cache-busted to b756');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b756'"), 'shared asset version was not bumped to b756');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b756'"), 'app build was not bumped to b756');
