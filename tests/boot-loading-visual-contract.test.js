...
assert(app.includes("window.__MLS_AV='b590'"), 'ScribeFlow loader was not cache-busted to b590');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b590'"), 'shared asset version was not bumped to b590');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b590'"), 'app build was not bumped to b590');
