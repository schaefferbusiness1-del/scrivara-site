...
assert(app.includes("window.__MLS_AV='b801'"), 'ScribeFlow loader was not cache-busted to b801');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b801'"), 'shared asset version was not bumped to b801');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b801'"), 'app build was not bumped to b801');
