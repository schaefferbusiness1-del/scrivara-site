...
assert(app.includes("window.__MLS_AV='b913'"), 'ScribeFlow loader was not cache-busted to b913');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b913'"), 'shared asset version was not bumped to b913');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b913'"), 'app build was not bumped to b913');
