...
assert(app.includes("window.__MLS_AV='b956'"), 'ScribeFlow loader was not cache-busted to b956');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b956'"), 'shared asset version was not bumped to b956');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b956'"), 'app build was not bumped to b956');
