...
assert(app.includes("window.__MLS_AV='b511'"), 'ScribeFlow loader was not cache-busted to b511');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b511'"), 'shared asset version was not bumped to b511');
assert(connect.includes("var MLS_APP_BUILD='2026-07-23-b511'"), 'app build was not bumped to b511');
