...
assert(app.includes("window.__MLS_AV='b558'"), 'ScribeFlow loader was not cache-busted to b558');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b558'"), 'shared asset version was not bumped to b558');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b558'"), 'app build was not bumped to b558');
