...
assert(app.includes("window.__MLS_AV=\"b305\""), 'ScribeFlow loader was not cache-busted to b305');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b305'"), 'shared asset version was not bumped to b305');
assert(connect.includes("var MLS_APP_BUILD='2026-07-15-b305'"), 'app build was not bumped to b305');
