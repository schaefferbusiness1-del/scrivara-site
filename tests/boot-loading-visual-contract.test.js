...
assert(app.includes("window.__MLS_AV='b387'"), 'ScribeFlow loader was not cache-busted to b387');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b387'"), 'shared asset version was not bumped to b387');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b387'"), 'app build was not bumped to b387');
