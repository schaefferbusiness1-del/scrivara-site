...
assert(app.includes("window.__MLS_AV='b824'"), 'ScribeFlow loader was not cache-busted to b824');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b824'"), 'shared asset version was not bumped to b824');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b824'"), 'app build was not bumped to b824');
