...
assert(app.includes("window.__MLS_AV='b833'"), 'ScribeFlow loader was not cache-busted to b833');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b833'"), 'shared asset version was not bumped to b833');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b833'"), 'app build was not bumped to b833');
