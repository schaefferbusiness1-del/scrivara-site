...
assert(app.includes("window.__MLS_AV='b502'"), 'ScribeFlow loader was not cache-busted to b502');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b502'"), 'shared asset version was not bumped to b502');
assert(connect.includes("var MLS_APP_BUILD='2026-07-23-b502'"), 'app build was not bumped to b502');
