...
assert(app.includes("window.__MLS_AV='b488'"), 'ScribeFlow loader was not cache-busted to b488');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b488'"), 'shared asset version was not bumped to b488');
assert(connect.includes("var MLS_APP_BUILD='2026-07-21-b488'"), 'app build was not bumped to b488');
