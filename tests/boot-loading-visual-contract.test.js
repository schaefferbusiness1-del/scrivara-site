...
assert(app.includes("window.__MLS_AV='b863'"), 'ScribeFlow loader was not cache-busted to b863');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b863'"), 'shared asset version was not bumped to b863');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b863'"), 'app build was not bumped to b863');
