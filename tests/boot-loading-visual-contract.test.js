...
assert(app.includes("window.__MLS_AV='b781'"), 'ScribeFlow loader was not cache-busted to b781');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b781'"), 'shared asset version was not bumped to b781');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b781'"), 'app build was not bumped to b781');
