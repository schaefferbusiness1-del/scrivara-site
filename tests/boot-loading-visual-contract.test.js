...
assert(app.includes("window.__MLS_AV='b930'"), 'ScribeFlow loader was not cache-busted to b930');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b930'"), 'shared asset version was not bumped to b930');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b930'"), 'app build was not bumped to b930');
