...
assert(app.includes("window.__MLS_AV='b814'"), 'ScribeFlow loader was not cache-busted to b814');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b814'"), 'shared asset version was not bumped to b814');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b814'"), 'app build was not bumped to b814');
