...
assert(app.includes("window.__MLS_AV='b653'"), 'ScribeFlow loader was not cache-busted to b653');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b653'"), 'shared asset version was not bumped to b653');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b653'"), 'app build was not bumped to b653');
