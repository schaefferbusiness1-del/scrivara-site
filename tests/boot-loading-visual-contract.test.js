...
assert(app.includes("window.__MLS_AV='b612'"), 'ScribeFlow loader was not cache-busted to b612');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b612'"), 'shared asset version was not bumped to b612');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b612'"), 'app build was not bumped to b612');
