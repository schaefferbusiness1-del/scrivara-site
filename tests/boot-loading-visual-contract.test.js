...
assert(app.includes("window.__MLS_AV='b622'"), 'ScribeFlow loader was not cache-busted to b622');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b622'"), 'shared asset version was not bumped to b622');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b622'"), 'app build was not bumped to b622');
