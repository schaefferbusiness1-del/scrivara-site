...
assert(app.includes("window.__MLS_AV='b720'"), 'ScribeFlow loader was not cache-busted to b720');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b720'"), 'shared asset version was not bumped to b720');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b720'"), 'app build was not bumped to b720');
