...
assert(app.includes("window.__MLS_AV='b353'"), 'ScribeFlow loader was not cache-busted to b353');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b353'"), 'shared asset version was not bumped to b353');
assert(connect.includes("var MLS_APP_BUILD='2026-07-16-b353'"), 'app build was not bumped to b353');
