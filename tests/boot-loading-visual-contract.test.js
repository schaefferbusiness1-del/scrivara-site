...
assert(app.includes("window.__MLS_AV='b521'"), 'ScribeFlow loader was not cache-busted to b521');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b521'"), 'shared asset version was not bumped to b521');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b521'"), 'app build was not bumped to b521');
