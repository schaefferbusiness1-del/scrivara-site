...
assert(app.includes("window.__MLS_AV='b709'"), 'ScribeFlow loader was not cache-busted to b709');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b709'"), 'shared asset version was not bumped to b709');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b709'"), 'app build was not bumped to b709');
