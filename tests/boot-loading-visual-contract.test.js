...
assert(app.includes("window.__MLS_AV='b705'"), 'ScribeFlow loader was not cache-busted to b705');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b705'"), 'shared asset version was not bumped to b705');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b705'"), 'app build was not bumped to b705');
