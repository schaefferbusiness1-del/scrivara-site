...
assert(app.includes("window.__MLS_AV='b880'"), 'ScribeFlow loader was not cache-busted to b880');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b880'"), 'shared asset version was not bumped to b880');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b880'"), 'app build was not bumped to b880');
