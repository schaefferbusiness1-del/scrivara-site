...
assert(app.includes("window.__MLS_AV='b825'"), 'ScribeFlow loader was not cache-busted to b825');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b825'"), 'shared asset version was not bumped to b825');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b825'"), 'app build was not bumped to b825');
