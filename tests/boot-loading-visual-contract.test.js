...
assert(app.includes("window.__MLS_AV='b713'"), 'ScribeFlow loader was not cache-busted to b713');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b713'"), 'shared asset version was not bumped to b713');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b713'"), 'app build was not bumped to b713');
