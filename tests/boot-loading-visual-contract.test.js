...
assert(app.includes("window.__MLS_AV='b673'"), 'ScribeFlow loader was not cache-busted to b673');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b673'"), 'shared asset version was not bumped to b673');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b673'"), 'app build was not bumped to b673');
