...
assert(app.includes("window.__MLS_AV='b577'"), 'ScribeFlow loader was not cache-busted to b577');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b577'"), 'shared asset version was not bumped to b577');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b577'"), 'app build was not bumped to b577');
