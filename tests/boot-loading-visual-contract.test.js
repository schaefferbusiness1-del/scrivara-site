...
assert(app.includes("window.__MLS_AV='b755'"), 'ScribeFlow loader was not cache-busted to b755');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b755'"), 'shared asset version was not bumped to b755');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b755'"), 'app build was not bumped to b755');
