...
assert(app.includes("window.__MLS_AV='b595'"), 'ScribeFlow loader was not cache-busted to b595');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b595'"), 'shared asset version was not bumped to b595');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b595'"), 'app build was not bumped to b595');
