...
assert(app.includes("window.__MLS_AV='b374'"), 'ScribeFlow loader was not cache-busted to b374');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b374'"), 'shared asset version was not bumped to b374');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b374'"), 'app build was not bumped to b374');
