...
assert(app.includes("window.__MLS_AV='b858'"), 'ScribeFlow loader was not cache-busted to b858');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b858'"), 'shared asset version was not bumped to b858');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b858'"), 'app build was not bumped to b858');
