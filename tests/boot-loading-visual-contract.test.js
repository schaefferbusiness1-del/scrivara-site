...
assert(app.includes("window.__MLS_AV='b779'"), 'ScribeFlow loader was not cache-busted to b779');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b779'"), 'shared asset version was not bumped to b779');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b779'"), 'app build was not bumped to b779');
