...
assert(app.includes("window.__MLS_AV='b609'"), 'ScribeFlow loader was not cache-busted to b609');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b609'"), 'shared asset version was not bumped to b609');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b609'"), 'app build was not bumped to b609');
