...
assert(app.includes("window.__MLS_AV='b551'"), 'ScribeFlow loader was not cache-busted to b551');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b551'"), 'shared asset version was not bumped to b551');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b551'"), 'app build was not bumped to b551');
