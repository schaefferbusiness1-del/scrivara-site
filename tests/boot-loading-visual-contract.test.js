...
assert(app.includes("window.__MLS_AV='b391'"), 'ScribeFlow loader was not cache-busted to b391');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b391'"), 'shared asset version was not bumped to b391');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b391'"), 'app build was not bumped to b391');
