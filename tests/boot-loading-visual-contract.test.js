...
assert(app.includes("window.__MLS_AV='b380'"), 'ScribeFlow loader was not cache-busted to b380');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b380'"), 'shared asset version was not bumped to b380');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b380'"), 'app build was not bumped to b380');
