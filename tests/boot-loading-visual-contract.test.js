...
assert(app.includes("window.__MLS_AV='b629'"), 'ScribeFlow loader was not cache-busted to b629');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b629'"), 'shared asset version was not bumped to b629');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b629'"), 'app build was not bumped to b629');
