...
assert(app.includes("window.__MLS_AV='b610'"), 'ScribeFlow loader was not cache-busted to b610');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b610'"), 'shared asset version was not bumped to b610');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b610'"), 'app build was not bumped to b610');
