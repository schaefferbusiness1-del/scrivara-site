...
assert(app.includes("window.__MLS_AV='b701'"), 'ScribeFlow loader was not cache-busted to b701');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b701'"), 'shared asset version was not bumped to b701');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b701'"), 'app build was not bumped to b701');
