...
assert(app.includes("window.__MLS_AV='b1005'"), 'ScribeFlow loader was not cache-busted to b1005');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b1005'"), 'shared asset version was not bumped to b1005');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b1005'"), 'app build was not bumped to b1005');
