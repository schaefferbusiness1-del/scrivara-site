...
assert(app.includes("window.__MLS_AV='b574'"), 'ScribeFlow loader was not cache-busted to b574');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b574'"), 'shared asset version was not bumped to b574');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b574'"), 'app build was not bumped to b574');
