...
assert(app.includes("window.__MLS_AV='b706'"), 'ScribeFlow loader was not cache-busted to b706');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b706'"), 'shared asset version was not bumped to b706');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b706'"), 'app build was not bumped to b706');
