...
assert(app.includes("window.__MLS_AV='b649'"), 'ScribeFlow loader was not cache-busted to b649');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b649'"), 'shared asset version was not bumped to b649');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b649'"), 'app build was not bumped to b649');
