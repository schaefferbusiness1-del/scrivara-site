...
assert(app.includes("window.__MLS_AV='b576'"), 'ScribeFlow loader was not cache-busted to b576');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b576'"), 'shared asset version was not bumped to b576');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b576'"), 'app build was not bumped to b576');
