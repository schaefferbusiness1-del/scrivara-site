...
assert(app.includes("window.__MLS_AV='b658'"), 'ScribeFlow loader was not cache-busted to b658');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b658'"), 'shared asset version was not bumped to b658');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b658'"), 'app build was not bumped to b658');
