...
assert(app.includes("window.__MLS_AV='b710'"), 'ScribeFlow loader was not cache-busted to b710');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b710'"), 'shared asset version was not bumped to b710');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b710'"), 'app build was not bumped to b710');
