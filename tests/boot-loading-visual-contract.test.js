...
assert(app.includes("window.__MLS_AV='b934'"), 'ScribeFlow loader was not cache-busted to b934');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b934'"), 'shared asset version was not bumped to b934');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b934'"), 'app build was not bumped to b934');
