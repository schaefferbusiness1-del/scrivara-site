...
assert(app.includes("window.__MLS_AV='b642'"), 'ScribeFlow loader was not cache-busted to b642');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b642'"), 'shared asset version was not bumped to b642');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b642'"), 'app build was not bumped to b642');
