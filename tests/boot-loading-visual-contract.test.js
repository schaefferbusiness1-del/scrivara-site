...
assert(app.includes("window.__MLS_AV='b879'"), 'ScribeFlow loader was not cache-busted to b879');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b879'"), 'shared asset version was not bumped to b879');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b879'"), 'app build was not bumped to b879');
