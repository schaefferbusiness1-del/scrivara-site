...
assert(app.includes("window.__MLS_AV='b571'"), 'ScribeFlow loader was not cache-busted to b571');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b571'"), 'shared asset version was not bumped to b571');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b571'"), 'app build was not bumped to b571');
