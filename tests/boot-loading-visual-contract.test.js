...
assert(app.includes("window.__MLS_AV='b866'"), 'ScribeFlow loader was not cache-busted to b866');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b866'"), 'shared asset version was not bumped to b866');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b866'"), 'app build was not bumped to b866');
