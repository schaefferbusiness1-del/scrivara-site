...
assert(app.includes("window.__MLS_AV='b925'"), 'ScribeFlow loader was not cache-busted to b925');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b925'"), 'shared asset version was not bumped to b925');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b925'"), 'app build was not bumped to b925');
