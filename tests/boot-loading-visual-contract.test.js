...
assert(app.includes("window.__MLS_AV='b782'"), 'ScribeFlow loader was not cache-busted to b782');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b782'"), 'shared asset version was not bumped to b782');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b782'"), 'app build was not bumped to b782');
