...
assert(app.includes("window.__MLS_AV='b369'"), 'ScribeFlow loader was not cache-busted to b369');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b369'"), 'shared asset version was not bumped to b369');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b369'"), 'app build was not bumped to b369');
