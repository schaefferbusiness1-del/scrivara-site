...
assert(app.includes("window.__MLS_AV='b979'"), 'ScribeFlow loader was not cache-busted to b979');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b979'"), 'shared asset version was not bumped to b979');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b979'"), 'app build was not bumped to b979');
