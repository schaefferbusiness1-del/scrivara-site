...
assert(app.includes("window.__MLS_AV='b971'"), 'ScribeFlow loader was not cache-busted to b971');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b971'"), 'shared asset version was not bumped to b971');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b971'"), 'app build was not bumped to b971');
