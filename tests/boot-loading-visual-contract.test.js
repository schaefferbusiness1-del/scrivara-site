...
assert(app.includes("window.__MLS_AV='b936'"), 'ScribeFlow loader was not cache-busted to b936');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b936'"), 'shared asset version was not bumped to b936');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b936'"), 'app build was not bumped to b936');
