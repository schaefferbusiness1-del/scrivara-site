...
assert(app.includes("window.__MLS_AV='b816'"), 'ScribeFlow loader was not cache-busted to b816');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b816'"), 'shared asset version was not bumped to b816');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b816'"), 'app build was not bumped to b816');
