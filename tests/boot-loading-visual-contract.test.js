...
assert(app.includes("window.__MLS_AV='b591'"), 'ScribeFlow loader was not cache-busted to b591');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b591'"), 'shared asset version was not bumped to b591');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b591'"), 'app build was not bumped to b591');
