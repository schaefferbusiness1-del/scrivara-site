...
assert(app.includes("window.__MLS_AV='b978'"), 'ScribeFlow loader was not cache-busted to b978');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b978'"), 'shared asset version was not bumped to b978');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b978'"), 'app build was not bumped to b978');
