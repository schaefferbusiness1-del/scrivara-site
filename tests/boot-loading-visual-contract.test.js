...
assert(app.includes("window.__MLS_AV='b540'"), 'ScribeFlow loader was not cache-busted to b540');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b540'"), 'shared asset version was not bumped to b540');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b540'"), 'app build was not bumped to b540');
