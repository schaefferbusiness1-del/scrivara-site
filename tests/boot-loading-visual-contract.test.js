...
assert(app.includes("window.__MLS_AV='b603'"), 'ScribeFlow loader was not cache-busted to b603');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b603'"), 'shared asset version was not bumped to b603');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b603'"), 'app build was not bumped to b603');
