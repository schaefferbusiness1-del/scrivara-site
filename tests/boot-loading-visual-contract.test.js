...
assert(app.includes("window.__MLS_AV='b587'"), 'ScribeFlow loader was not cache-busted to b587');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b587'"), 'shared asset version was not bumped to b587');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b587'"), 'app build was not bumped to b587');
