...
assert(app.includes("window.__MLS_AV='b586'"), 'ScribeFlow loader was not cache-busted to b586');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b586'"), 'shared asset version was not bumped to b586');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b586'"), 'app build was not bumped to b586');
