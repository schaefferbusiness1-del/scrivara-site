...
assert(app.includes("window.__MLS_AV='b698'"), 'ScribeFlow loader was not cache-busted to b698');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b698'"), 'shared asset version was not bumped to b698');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b698'"), 'app build was not bumped to b698');
