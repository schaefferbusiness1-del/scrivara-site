...
assert(app.includes("window.__MLS_AV='b349'"), 'ScribeFlow loader was not cache-busted to b349');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b349'"), 'shared asset version was not bumped to b349');
assert(connect.includes("var MLS_APP_BUILD='2026-07-16-b349'"), 'app build was not bumped to b349');
