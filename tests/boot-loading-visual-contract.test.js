...
assert(app.includes("window.__MLS_AV='b628'"), 'ScribeFlow loader was not cache-busted to b628');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b628'"), 'shared asset version was not bumped to b628');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b628'"), 'app build was not bumped to b628');
