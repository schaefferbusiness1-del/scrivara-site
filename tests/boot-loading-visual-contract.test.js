...
assert(app.includes("window.__MLS_AV='b846'"), 'ScribeFlow loader was not cache-busted to b846');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b846'"), 'shared asset version was not bumped to b846');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b846'"), 'app build was not bumped to b846');
