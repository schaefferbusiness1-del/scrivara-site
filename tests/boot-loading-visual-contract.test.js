...
assert(app.includes("window.__MLS_AV='b487'"), 'ScribeFlow loader was not cache-busted to b487');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b487'"), 'shared asset version was not bumped to b487');
assert(connect.includes("var MLS_APP_BUILD='2026-07-21-b487'"), 'app build was not bumped to b487');
