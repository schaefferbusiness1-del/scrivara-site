...
assert(app.includes("window.__MLS_AV='b937'"), 'ScribeFlow loader was not cache-busted to b937');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b937'"), 'shared asset version was not bumped to b937');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b937'"), 'app build was not bumped to b937');
