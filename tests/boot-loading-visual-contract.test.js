...
assert(app.includes("window.__MLS_AV='b366'"), 'ScribeFlow loader was not cache-busted to b366');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b366'"), 'shared asset version was not bumped to b366');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b366'"), 'app build was not bumped to b366');
