...
assert(app.includes("window.__MLS_AV='b908'"), 'ScribeFlow loader was not cache-busted to b908');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b908'"), 'shared asset version was not bumped to b908');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b908'"), 'app build was not bumped to b908');
