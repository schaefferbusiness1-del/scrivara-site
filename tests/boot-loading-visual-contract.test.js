...
assert(app.includes("window.__MLS_AV='b736'"), 'ScribeFlow loader was not cache-busted to b736');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b736'"), 'shared asset version was not bumped to b736');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b736'"), 'app build was not bumped to b736');
