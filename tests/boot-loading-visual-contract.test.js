...
assert(app.includes("window.__MLS_AV='b712'"), 'ScribeFlow loader was not cache-busted to b712');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b712'"), 'shared asset version was not bumped to b712');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b712'"), 'app build was not bumped to b712');
