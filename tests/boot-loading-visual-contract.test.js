...
assert(app.includes("window.__MLS_AV='b566'"), 'ScribeFlow loader was not cache-busted to b566');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b566'"), 'shared asset version was not bumped to b566');
assert(connect.includes("var MLS_APP_BUILD='2026-07-24-b566'"), 'app build was not bumped to b566');
