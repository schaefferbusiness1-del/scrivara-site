...
assert(app.includes("window.__MLS_AV='b711'"), 'ScribeFlow loader was not cache-busted to b711');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b711'"), 'shared asset version was not bumped to b711');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b711'"), 'app build was not bumped to b711');
