...
assert(app.includes("window.__MLS_AV='b772'"), 'ScribeFlow loader was not cache-busted to b772');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b772'"), 'shared asset version was not bumped to b772');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b772'"), 'app build was not bumped to b772');
