...
assert(app.includes("window.__MLS_AV='b384'"), 'ScribeFlow loader was not cache-busted to b384');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b384'"), 'shared asset version was not bumped to b384');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b384'"), 'app build was not bumped to b384');
