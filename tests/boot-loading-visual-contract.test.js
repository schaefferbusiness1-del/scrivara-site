...
assert(app.includes("window.__MLS_AV='b783'"), 'ScribeFlow loader was not cache-busted to b783');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b783'"), 'shared asset version was not bumped to b783');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b783'"), 'app build was not bumped to b783');
