...
assert(app.includes("window.__MLS_AV='b901'"), 'ScribeFlow loader was not cache-busted to b901');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b901'"), 'shared asset version was not bumped to b901');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b901'"), 'app build was not bumped to b901');
