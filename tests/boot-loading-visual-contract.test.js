...
assert(app.includes("window.__MLS_AV='b624'"), 'ScribeFlow loader was not cache-busted to b624');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b624'"), 'shared asset version was not bumped to b624');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b624'"), 'app build was not bumped to b624');
