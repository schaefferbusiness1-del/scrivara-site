...
assert(app.includes("window.__MLS_AV='b1039'"), 'ScribeFlow loader was not cache-busted to b1039');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b1039'"), 'shared asset version was not bumped to b1039');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b1039'"), 'app build was not bumped to b1039');
