...
assert(app.includes("window.__MLS_AV='b988'"), 'ScribeFlow loader was not cache-busted to b988');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b988'"), 'shared asset version was not bumped to b988');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b988'"), 'app build was not bumped to b988');
