...
assert(app.includes("window.__MLS_AV='b627'"), 'ScribeFlow loader was not cache-busted to b627');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b627'"), 'shared asset version was not bumped to b627');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b627'"), 'app build was not bumped to b627');
