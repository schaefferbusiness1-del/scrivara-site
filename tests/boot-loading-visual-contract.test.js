...
assert(app.includes("window.__MLS_AV='b962'"), 'ScribeFlow loader was not cache-busted to b962');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b962'"), 'shared asset version was not bumped to b962');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b962'"), 'app build was not bumped to b962');
