...
assert(app.includes("window.__MLS_AV='b932'"), 'ScribeFlow loader was not cache-busted to b932');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b932'"), 'shared asset version was not bumped to b932');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b932'"), 'app build was not bumped to b932');
