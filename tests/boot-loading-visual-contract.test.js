...
assert(app.includes("window.__MLS_AV='b359'"), 'ScribeFlow loader was not cache-busted to b359');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b359'"), 'shared asset version was not bumped to b359');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b359'"), 'app build was not bumped to b359');
