...
assert(app.includes("window.__MLS_AV='b378'"), 'ScribeFlow loader was not cache-busted to b378');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b378'"), 'shared asset version was not bumped to b378');
assert(connect.includes("var MLS_APP_BUILD='2026-07-17-b378'"), 'app build was not bumped to b378');
