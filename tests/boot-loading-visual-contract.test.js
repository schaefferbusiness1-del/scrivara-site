...
assert(app.includes("window.__MLS_AV='b717'"), 'ScribeFlow loader was not cache-busted to b717');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b717'"), 'shared asset version was not bumped to b717');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b717'"), 'app build was not bumped to b717');
