...
assert(app.includes("window.__MLS_AV='b778'"), 'ScribeFlow loader was not cache-busted to b778');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b778'"), 'shared asset version was not bumped to b778');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b778'"), 'app build was not bumped to b778');
