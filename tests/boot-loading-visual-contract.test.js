...
assert(app.includes("window.__MLS_AV='b402'"), 'ScribeFlow loader was not cache-busted to b402');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b402'"), 'shared asset version was not bumped to b402');
assert(connect.includes("var MLS_APP_BUILD='2026-07-18-b402'"), 'app build was not bumped to b402');
