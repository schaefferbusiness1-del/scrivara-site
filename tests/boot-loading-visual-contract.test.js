...
assert(app.includes("window.__MLS_AV='b1014'"), 'ScribeFlow loader was not cache-busted to b1014');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b1014'"), 'shared asset version was not bumped to b1014');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b1014'"), 'app build was not bumped to b1014');
