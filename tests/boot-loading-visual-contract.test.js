...
assert(app.includes("window.__MLS_AV='b808'"), 'ScribeFlow loader was not cache-busted to b808');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b808'"), 'shared asset version was not bumped to b808');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b808'"), 'app build was not bumped to b808');
