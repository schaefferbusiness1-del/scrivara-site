...
assert(app.includes("window.__MLS_AV='b626'"), 'ScribeFlow loader was not cache-busted to b626');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b626'"), 'shared asset version was not bumped to b626');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b626'"), 'app build was not bumped to b626');
