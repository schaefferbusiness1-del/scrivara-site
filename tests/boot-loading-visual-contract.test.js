...
assert(app.includes("window.__MLS_AV='b867'"), 'ScribeFlow loader was not cache-busted to b867');
...
assert(connect.includes("window.__MLS_AV = window.__MLS_AV || 'b867'"), 'shared asset version was not bumped to b867');
assert(connect.includes("var MLS_APP_BUILD='2026-07-25-b867'"), 'app build was not bumped to b867');
