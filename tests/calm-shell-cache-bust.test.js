 ...
 * transcript fold, b576 the patient-page density cut - and NONE of it reached a
 ...
 * under that token. Measured live at b576: app-version.json said b576 while the
...
for (const asset of MUST_AUTOBUST) {
  ...
  assert(re.test(connect),
    ...
    'which is exactly what happened for six builds (b565-b576).');
