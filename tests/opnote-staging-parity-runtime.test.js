...
async function main() {
  ...
  const integrityAt = connector.indexOf('feat_mls_opnote_integrity.js?v=20260727oni2161');
  const fillAt = connector.indexOf('feat_mls_opnote_fill.js?v=20260727onf2120');
