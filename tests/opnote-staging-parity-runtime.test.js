...
async function main() {
  ...
  const integrityAt = connector.indexOf('feat_mls_opnote_integrity.js?v=20260723oni2150');
  const fillAt = connector.indexOf('feat_mls_opnote_fill.js?v=20260723onf2100');
