...
/* token moved 20260817chk3062 -> 20260817chk3063 deliberately with the 3.0.63
   ...
   pins is unchanged. */
assert(liveLoader.includes('feat_mls_checker.js?v=20260817chk3063'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260817chk3063'), 'staging checker loader must match live');
