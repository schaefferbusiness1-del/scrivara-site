...
/* token moved 20260808chk3050 -> 20260808chk3051 deliberately with the 3.0.51
   ...
   pins is unchanged. */
assert(liveLoader.includes('feat_mls_checker.js?v=20260808chk3051'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260808chk3051'), 'staging checker loader must match live');
