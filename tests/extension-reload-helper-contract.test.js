...
/* token moved 20260823chk3079 -> 20260825chk3080 deliberately with the 3.0.80
   ...
   pins is unchanged. */
assert(liveLoader.includes('feat_mls_checker.js?v=20260825chk3080'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260825chk3080'), 'staging checker loader must match live');
