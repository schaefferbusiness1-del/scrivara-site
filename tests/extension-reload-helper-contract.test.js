...
/* token moved 20260817chk3063 -> 20260818chk3064 deliberately with the 3.0.64
   ...
   pins is unchanged. */
assert(liveLoader.includes('feat_mls_checker.js?v=20260818chk3064'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260818chk3064'), 'staging checker loader must match live');
