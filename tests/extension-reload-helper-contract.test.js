...
assert(liveLoader.includes('feat_mls_checker.js?v=20260719chk2922r2'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260719chk2922r2'), 'staging checker loader must match live');
