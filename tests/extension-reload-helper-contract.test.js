...
/* token moved 20260803chk3044 -> 20260806chk3045 deliberately with the 3.0.45
   ...
   pins is unchanged. */
assert(liveLoader.includes('feat_mls_checker.js?v=20260806chk3045'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260806chk3045'), 'staging checker loader must match live');
