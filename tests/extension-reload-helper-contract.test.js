...
assert(liveLoader.includes('feat_mls_checker.js?v=20260725chk3018r1'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260725chk3018r1'), 'staging checker loader must match live');
