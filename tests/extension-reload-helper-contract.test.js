...
/* token moved 20260808chk3047 -> 20260808chk3047 deliberately with the 3.0.47
   ...
   pins is unchanged. */
assert(liveLoader.includes('feat_mls_checker.js?v=20260808chk3047'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260808chk3047'), 'staging checker loader must match live');
