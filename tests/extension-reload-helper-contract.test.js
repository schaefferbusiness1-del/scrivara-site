...
/* token moved 20260808chk3048 -> 20260808chk3048 deliberately with the 3.0.48
   ...
   pins is unchanged. */
assert(liveLoader.includes('feat_mls_checker.js?v=20260808chk3048'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260808chk3048'), 'staging checker loader must match live');
