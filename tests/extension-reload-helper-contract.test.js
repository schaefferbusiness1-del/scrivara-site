...
/* token moved 20260819chk3074 -> 20260820chk3076 deliberately with the 3.0.76
   ...
   pins is unchanged. */
assert(liveLoader.includes('feat_mls_checker.js?v=20260820chk3076'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260820chk3076'), 'staging checker loader must match live');
