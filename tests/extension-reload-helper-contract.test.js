...
assert(liveLoader.includes('feat_mls_checker.js?v=20260802chk3041'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260802chk3041'), 'staging checker loader must match live');
