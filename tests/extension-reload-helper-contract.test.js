...
/* token moved 20260825chk3080 -> 20260825chk3081 deliberately with the 3.0.81
   ...
   pins is unchanged. */
assert(liveLoader.includes('feat_mls_checker.js?v=20260825chk3081'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260825chk3081'), 'staging checker loader must match live');
