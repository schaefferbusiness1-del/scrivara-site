...
/* token moved 20260808chk3053 -> 20260808chk3054 deliberately with the 3.0.54
   ...
   pins is unchanged. */
assert(liveLoader.includes('feat_mls_checker.js?v=20260808chk3054'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260808chk3054'), 'staging checker loader must match live');
