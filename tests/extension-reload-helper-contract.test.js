...
assert(liveLoader.includes('feat_mls_checker.js?v=20260727chk3025'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260727chk3025'), 'staging checker loader must match live');
