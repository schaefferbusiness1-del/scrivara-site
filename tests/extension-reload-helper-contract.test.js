...
/* token moved 20260808chk3049 -> 20260808chk3050 deliberately with the 3.0.50
   ...
   pins is unchanged. */
assert(liveLoader.includes('feat_mls_checker.js?v=20260808chk3050'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260808chk3050'), 'staging checker loader must match live');
