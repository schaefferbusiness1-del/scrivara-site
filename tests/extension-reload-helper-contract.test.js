...
/* token moved 20260819chk3072 -> 20260819chk3074 deliberately with the 3.0.74
   ...
   pins is unchanged. */
assert(liveLoader.includes('feat_mls_checker.js?v=20260819chk3074'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260819chk3074'), 'staging checker loader must match live');
