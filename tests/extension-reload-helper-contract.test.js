...
/* token moved 20260810chk3061 -> 20260817chk3062 deliberately with the 3.0.62
   ...
   pins is unchanged. */
assert(liveLoader.includes('feat_mls_checker.js?v=20260817chk3062'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260817chk3062'), 'staging checker loader must match live');
