...
/* token moved 20260818chk3064 -> 20260819chk3072 deliberately with the 3.0.72
   ...
   pins is unchanged. */
assert(liveLoader.includes('feat_mls_checker.js?v=20260819chk3072'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260819chk3072'), 'staging checker loader must match live');
