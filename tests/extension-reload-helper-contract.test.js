...
/* token moved 20260808chk3048 -> 20260808chk3049 deliberately with the 3.0.49
   ...
   pins is unchanged. */
assert(liveLoader.includes('feat_mls_checker.js?v=20260808chk3049'), 'live checker loader must cache-bust the reload control');
assert(stagingLoader.includes('feat_mls_checker.js?v=20260808chk3049'), 'staging checker loader must match live');
