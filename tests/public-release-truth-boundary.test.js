...
assert(/MLS_Assist_v3.0.74.zip/.test(download) &&
  /70c7a57ca80bf58a946531775d6ab0398b9fd82558bb435a20c62d0b4909ac72/i.test(download) &&
...
assert.strictEqual(feed.version, '3.0.74', 'public feed must state the released stable channel exactly');
