...
assert(/MLS_Assist_v3\.0\.21\.zip/.test(download) &&
  /60cb01b9d2f59f8a319ac1b6d92f30c31d9c31d10e35b6fc85f1319fcdc966f4/i.test(download) &&
 ...
 * at MLS_Assist_v3.0.21.zip, because the label was hand-maintained and the
...
assert.strictEqual(feed.version, '3.0.21', 'public feed must state the released stable channel exactly');
