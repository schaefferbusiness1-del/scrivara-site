...
assert(/MLS_Assist_v3.0.51.zip/.test(download) &&
  /6523fa1cf5cb30fcc2f45c214626e137c9516f296c56836219be7a5b453329f8/i.test(download) &&
...
assert.strictEqual(feed.version, '3.0.51', 'public feed must state the released stable channel exactly');
