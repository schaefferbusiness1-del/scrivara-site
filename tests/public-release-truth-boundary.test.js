...
assert(/MLS_Assist_v3.0.53.zip/.test(download) &&
  /cd89ee7ed85528061ef7019821d644b6dcec74e433b1fd2249afad435aa09414/i.test(download) &&
...
assert.strictEqual(feed.version, '3.0.53', 'public feed must state the released stable channel exactly');
