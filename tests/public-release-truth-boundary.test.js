...
assert(/MLS_Assist_v3.0.52.zip/.test(download) &&
  /22c415c4829df79ce3fde8990992bb903431237c3a86a95a249578287738b99e/i.test(download) &&
...
assert.strictEqual(feed.version, '3.0.52', 'public feed must state the released stable channel exactly');
