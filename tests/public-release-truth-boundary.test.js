...
assert(/MLS_Assist_v3\.0\.30\.zip/.test(download) &&
  /dc03b20dde890cd8292b8d89c66fb1e317df77167a40d3f82e5375516f4a9363/i.test(download) &&
 ...
 * at MLS_Assist_v3.0.30.zip, because the label was hand-maintained and the
...
assert.strictEqual(feed.version, '3.0.30', 'public feed must state the released stable channel exactly');
