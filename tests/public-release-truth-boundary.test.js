...
assert(/MLS_Assist_v3.0.54.zip/.test(download) &&
  /34041bcfc076ef3da87a8ab6d8300a720ff6fa5dca405d84be328894241bb5c8/i.test(download) &&
...
assert.strictEqual(feed.version, '3.0.54', 'public feed must state the released stable channel exactly');
