...
assert(/MLS_Assist_v3.0.57.zip/.test(download) &&
  /0efd00ccf06a48d8e8a5992681a2e58d52105fcc3ff661c884f2d4d9303575df/i.test(download) &&
...
assert.strictEqual(feed.version, '3.0.57', 'public feed must state the released stable channel exactly');
