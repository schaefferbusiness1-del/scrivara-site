...
assert(/MLS_Assist_v3\.0\.29\.zip/.test(download) &&
  /c124d56497bd5c82d345022b2fc47d315181d23ef6e02cee064e964cc1776d4e/i.test(download) &&
 ...
 * at MLS_Assist_v3.0.29.zip, because the label was hand-maintained and the
...
assert.strictEqual(feed.version, '3.0.29', 'public feed must state the released stable channel exactly');
