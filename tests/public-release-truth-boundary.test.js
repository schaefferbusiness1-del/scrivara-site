...
assert(/MLS_Assist_v3\.0\.28\.zip/.test(download) &&
  /da548e7dfdc63c24c7a1ce10cc192ee1c02e5e76af7cc2f5c314e54552564a12/i.test(download) &&
 ...
 * at MLS_Assist_v3.0.28.zip, because the label was hand-maintained and the
...
assert.strictEqual(feed.version, '3.0.28', 'public feed must state the released stable channel exactly');
