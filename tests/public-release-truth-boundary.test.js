...
assert(/MLS_Assist_v3.0.47.zip/.test(download) &&
  /81c7bd84535047757734bdd2879e1132401a13e403cd4d74d74c59eed87ae113/i.test(download) &&
...
assert.strictEqual(feed.version, '3.0.47', 'public feed must state the released stable channel exactly');
