...
assert(/MLS_Assist_v3\.0\.19\.zip/.test(download) &&
  /09f51ac73a58be2dab21e5b66c532164f81a24eafcfd16825094f75a8f573b97/i.test(download) &&
 ...
 * at MLS_Assist_v3.0.19.zip, because the label was hand-maintained and the
...
assert.strictEqual(feed.version, '3.0.19', 'public feed must state the released stable channel exactly');
