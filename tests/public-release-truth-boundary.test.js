...
assert(/MLS_Assist_v3\.0\.20\.zip/.test(download) &&
  /344ebdcb8adef92775d85f81055abedad399fa7afe2284b507bf072bfa0ffe6d/i.test(download) &&
 ...
 * at MLS_Assist_v3.0.20.zip, because the label was hand-maintained and the
...
assert.strictEqual(feed.version, '3.0.20', 'public feed must state the released stable channel exactly');
