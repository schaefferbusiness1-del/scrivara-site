...
assert(/MLS_Assist_v3\.0\.40\.zip/.test(download) &&
  /8cb1e4be2a81fde4516094aaad7a5cf3f7ccab0aeafc22d9b166ca941d2bc3de/i.test(download) &&
 ...
 * at MLS_Assist_v3.0.40.zip, because the label was hand-maintained and the
...
assert.strictEqual(feed.version, '3.0.40', 'public feed must state the released stable channel exactly');
