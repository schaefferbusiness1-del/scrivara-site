...
assert(/MLS_Assist_v3\.0\.41\.zip/.test(download) &&
  /1098b36eb3ae6af9b3a6c821198715b98140b845c35c20e8b6e7413c6bb35fb8/i.test(download) &&
 ...
 * at MLS_Assist_v3.0.41.zip, because the label was hand-maintained and the
...
assert.strictEqual(feed.version, '3.0.41', 'public feed must state the released stable channel exactly');
