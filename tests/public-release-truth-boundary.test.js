...
assert(/MLS_Assist_v3.0.46.zip/.test(download) &&
  /dd9ece28d9df9ba7c829451a1cdac41282bc3ab2cd266a9fdc1517434440bb41/i.test(download) &&
...
assert.strictEqual(feed.version, '3.0.46', 'public feed must state the released stable channel exactly');
