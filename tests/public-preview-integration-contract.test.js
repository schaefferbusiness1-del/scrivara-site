...
const policyTag = '<script src="public-preview-policy.js?v=b482"></script>';
const runtimeTag = '<script src="public-preview-runtime.js?v=b482"></script>';
...
for (const asset of ['public-preview-policy.js', 'public-preview-runtime.js']) {
  ...
  assert(sw.includes(`/${asset}?v=b482`), `${asset} is missing from the immutable app shell`);
}
