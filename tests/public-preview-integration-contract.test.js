...
const policyTag = '<script src="public-preview-policy.js?v=b472"></script>';
const runtimeTag = '<script src="public-preview-runtime.js?v=b472"></script>';
...
for (const asset of ['public-preview-policy.js', 'public-preview-runtime.js']) {
  ...
  assert(sw.includes(`/${asset}?v=b472`), `${asset} is missing from the immutable app shell`);
}
