...
const policyTag = '<script src="public-preview-policy.js?v=b446"></script>';
const runtimeTag = '<script src="public-preview-runtime.js?v=b446"></script>';
...
for (const asset of ['public-preview-policy.js', 'public-preview-runtime.js']) {
  ...
  assert(sw.includes(`/${asset}?v=b446`), `${asset} is missing from the immutable app shell`);
}
