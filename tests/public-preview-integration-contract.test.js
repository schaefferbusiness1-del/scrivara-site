...
const runtimeTag = '<script src="public-preview-runtime.js?v=20260923pv715"></script>';
...
assert(studyGroups.includes('__MLS_PUBLIC_PREVIEW') && studyGroups.includes("skipped: 'public-synthetic-preview'") &&
  bundle.includes('feat_mls_studygroups.js') && bundle.includes('20260912sg1c9'),
...
const shellTokens = { 'public-preview-policy.js': 'b497', 'public-preview-runtime.js': '20260923pv715' };
