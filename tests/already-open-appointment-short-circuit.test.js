...
(async () => {
  ...
  try {
    ...
    assert(background.includes('reasonCodes: []') &&
      ...
      background.includes("diag: searchOpenDiag(Object.assign({}, (findRes && findRes.diag) || {}, (sched && sched.diag) || {}, __navDiag, { appointmentNavigationProven: false }))") /* navproof-diag-1.0.0 (3.0.136) + finddiag-1.0.0 (3.0.137): the refusal carries the Find and opener diag and closed counts */,
