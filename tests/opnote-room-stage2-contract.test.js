...
/* ---- source pins ------------------------------------------------------- */
assert(room.includes("var VERSION = 'opr-1.2.1';"), 'room module is not opr-1.2.1');
...
assert.strictEqual(ctx.__mlsOpNoteRoom.version, 'opr-1.2.1', 'wrong room version installed');
