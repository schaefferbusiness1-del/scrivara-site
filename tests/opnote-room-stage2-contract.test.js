...
/* ---- source pins ------------------------------------------------------- */
assert(room.includes("var VERSION = 'opr-1.2.0';"), 'room module is not opr-1.2.0');
...
assert.strictEqual(ctx.__mlsOpNoteRoom.version, 'opr-1.2.0', 'wrong room version installed');
