...
assert(connect.includes("feat_mls_patient_reach_v2.js?v=20260716pr202"), 'Patient Reach v2 loader is not cache-busted to its explicit rail-routing release');
...
(function runtime() {
  ...
  assert.strictEqual(api.version, '2.0.2');
