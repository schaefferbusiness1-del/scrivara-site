...
const procedureLoaderLine = connect.split(/\r?\n/).find((line) => line.includes("s.src='mls-procedure-report.js?v=20260730lib3'"));
...
assert.strictEqual((connect.match(/mls-procedure-report\.js\?v=20260730lib3/g) || []).length, 1,
