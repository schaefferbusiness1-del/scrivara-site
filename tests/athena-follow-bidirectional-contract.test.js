...
assert.strictEqual(manifest.version, '3.0.80', 'extension manifest must be 3.0.80'); /* pin moved with the 3.0.80 release train */
...
assert.strictEqual(feed.version, '3.0.80', 'release feed must announce 3.0.80');
