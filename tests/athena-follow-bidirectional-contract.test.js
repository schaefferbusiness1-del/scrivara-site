...
assert.strictEqual(manifest.version, '3.0.79', 'extension manifest must be 3.0.79'); /* pin moved with the 3.0.79 release train */
...
assert.strictEqual(feed.version, '3.0.79', 'release feed must announce 3.0.79');
