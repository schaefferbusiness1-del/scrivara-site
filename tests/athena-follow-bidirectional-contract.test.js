...
assert.strictEqual(manifest.version, '3.0.64', 'extension manifest must be 3.0.64'); /* pin moved with the 3.0.64 release train (srr-1.0) */
/* qol-2.4b: SELF-DERIVED from manifest.version rather than a hand-carried
   literal — this line still said 3.0.56 while line 45 said 3.0.64, red since
...
assert.strictEqual(feed.version, '3.0.64', 'release feed must announce 3.0.64');
