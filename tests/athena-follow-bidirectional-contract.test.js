...
assert.strictEqual(manifest.version, '3.0.77', 'extension manifest must be 3.0.77'); /* pin moved with the 3.0.77 release train (srr-1.0) */
...
assert.strictEqual(feed.version, '3.0.77', 'release feed must announce 3.0.77');
