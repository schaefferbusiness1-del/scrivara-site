...
assert.strictEqual(manifest.version, '3.0.42', 'extension manifest must be 3.0.42');
assert(/^3\.0\.42\+core-sha256:[0-9a-f]{64}$/.test(manifest.version_name), 'manifest must carry the stamped core digest');
assert.strictEqual(feed.version, '3.0.42', 'release feed must announce 3.0.42');
