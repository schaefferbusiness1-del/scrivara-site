...
assert.strictEqual(manifest.version, '3.0.81', 'extension manifest must be 3.0.81'); /* pin moved with the 3.0.81 release train */
...
assert.strictEqual(feed.version, '3.0.81', 'release feed must announce 3.0.81');
