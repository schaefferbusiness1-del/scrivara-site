...
(function () {
  ...
  function ensureStyle() {
    ...
    s.textContent =
      '.' + BTN_CLASS + '{cursor:pointer;font-weight:600;font-size:12px;padding:7px 12px;border-radius:9px;border:1px solid #7c3aed;background:#ede9fe;color:#5b21b6;margin-top:8px;margin-left:8px}' +
      ...
      '#' + PANEL_ID + ' .sa-x{cursor:pointer;border:1px solid #cbd5e1;background:#f8fafc;border-radius:8px;padding:4px 10px;font-weight:700}' +
      ...
      '#' + PANEL_ID + ' .sa-go{cursor:pointer;font-weight:700;border:1px solid #7c3aed;background:#7c3aed;color:#fff;border-radius:9px;padding:9px 16px}' +
      '#' + PANEL_ID + ' .sa-clear{cursor:pointer;font-weight:600;border:1px solid #cbd5e1;background:#f8fafc;color:#334155;border-radius:9px;padding:8px 13px}' +
      ...
      '#' + BANNER_ID + '.ok{background:#ecfdf5;border:1px solid #10b981;color:#065f46}' +
