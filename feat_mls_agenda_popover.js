  ...
  function injectCss(){
    ...
    try{
      ...
      s.textContent=
        ...
        'padding:2px 8px 8px;}'+
        '#'+POP_ID+' .ag-h .ag-sub{font-weight:600;color:var(--muted);text-transform:none;letter-spacing:0;}'+
        ...
        '#'+POP_ID+' .ag-foot{padding:8px 8px 2px;font-size:11px;color:var(--muted);}'+
