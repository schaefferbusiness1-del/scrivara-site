  ...
  function injectCss(){
    ...
    try{
      ...
      s.textContent=
        ...
        'box-shadow:0 14px 40px rgba(2,12,27,.26);padding:10px 8px;font-size:13px;color:#1E2B24;display:none;}'+
        ...
        '#'+POP_ID+' .ag-badge.next{background:rgba(31,122,224,.14);color:#2E6A4B;}'+
