...
;(function () {
  ...
  function injectStyle() {
    ...
    s.textContent = [
      ...
      "background:linear-gradient(135deg,#1A211C,#16335a);color:#fff;}",
      ...
      "border-bottom:1px solid #F4F2EC;background:#f7fafe;}",
      ...
      "#" + PANEL_ID + " .as-tab.on{background:#fff;color:#1f4fd1;box-shadow:0 -2px 0 #2E6A4B inset;}",
      /* body */
      ...
      "#" + PANEL_ID + " .as-pcard:hover{border-color:#b9d0f3;box-shadow:0 8px 20px -14px rgba(20,33,28,.4);}",
      ...
      "background:#EAF1EE;border:1px solid #dbe6f6;border-radius:8px;padding:5px 6px;line-height:1.15;}",
      ...
      "background:#f7fafe;color:#1A211C;border:1px solid #dbe6f6;border-radius:10px;",
