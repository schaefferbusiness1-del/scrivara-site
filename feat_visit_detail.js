...
(function () {
  ...
  function injectStyle() {
    ...
    var css = [
      ".mlsvd-card{border:1px solid var(--line,#E7E5DD);border-radius:var(--r-card,14px);background:var(--card,#fff);margin:10px 0;overflow:hidden;box-shadow:var(--shadow-soft,0 1px 2px rgba(20,33,28,.05))}",
      ".mlsvd-card.mlsvd-open{box-shadow:0 4px 16px rgba(20,33,28,.10)}",
      ".mlsvd-head{display:flex;align-items:center;gap:10px;padding:12px 14px;cursor:pointer;user-select:none}",
      ".mlsvd-head:hover{background:var(--soft2,#FCFBF8)}",
      ".mlsvd-chev{color:var(--muted,#79837C);font-size:11px;transition:transform .15s ease;flex:0 0 auto}",
      ".mlsvd-card.mlsvd-open .mlsvd-chev{transform:rotate(90deg)}",
      ".mlsvd-date{font-weight:700;color:var(--ink,#1A211C);font-size:14px;flex:0 0 auto}",
      ".mlsvd-dot{color:var(--line,#cfd8e6);flex:0 0 auto}",
      ".mlsvd-type{color:var(--ink,#1A211C);font-size:14px;flex:1 1 auto;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}",
      ".mlsvd-hpills{display:flex;gap:5px;flex:0 0 auto;align-items:center}",
      ".mlsvd-src{font-size:11px;font-weight:600;color:var(--muted,#79837C);background:var(--soft,#EAF1EE);border:1px solid var(--line,#E7E5DD);padding:2px 8px;border-radius:999px;flex:0 0 auto}",
      ".mlsvd-body{padding:4px 16px 16px;border-top:1px solid var(--line,#eef1f6)}",
      ".mlsvd-sec{margin:14px 0 0}",
      ".mlsvd-lbl{font-size:11px;font-weight:700;letter-spacing:.04em;text-transform:uppercase;color:var(--muted,#79837C);margin:0 0 6px}",
      ...
      ".mlsvd-pill-med{background:var(--soft,#EAF1EE);color:var(--brand-dk,#204034);border:1px solid #d6e2f5}",
      ".mlsvd-cpt{display:flex;flex-wrap:wrap;align-items:baseline;gap:8px;padding:7px 11px;border:1px solid var(--line,#E7E5DD);border-radius:10px;background:var(--field-bg,#FCFBF8);margin:0 0 6px}",
      ".mlsvd-cpt-code{font-weight:700;color:var(--brand-dk,#204034);font-size:13px}",
      ".mlsvd-cpt-desc{color:var(--ink,#1A211C);font-size:12.5px;flex:1 1 160px;min-width:120px}",
      ".mlsvd-cpt-rvu{color:var(--muted,#79837C);font-size:12px;font-weight:600;white-space:nowrap}",
      ".mlsvd-rvutot{margin-top:2px;font-size:12.5px;font-weight:700;color:var(--green-dk,#204034)}",
      ".mlsvd-text{background:var(--field-bg,#FCFBF8);border:1px solid var(--line,#E7E5DD);border-radius:10px;padding:10px 12px;color:var(--ink,#1A211C);font-size:13.5px;line-height:1.5;white-space:pre-wrap;word-break:break-word}",
      ".mlsvd-scores{display:flex;flex-wrap:wrap;gap:8px}",
      ".mlsvd-score{display:inline-flex;flex-direction:column;align-items:flex-start;gap:1px;background:var(--field-bg,#FCFBF8);border:1px solid var(--line,#E7E5DD);border-radius:10px;padding:6px 12px;min-width:64px}",
      ".mlsvd-score b{font-size:16px;color:var(--ink,#1A211C);line-height:1.1}",
      ".mlsvd-score span{font-size:10.5px;font-weight:700;letter-spacing:.03em;text-transform:uppercase;color:var(--muted,#79837C)}",
      ".mlsvd-ai{background:rgba(37,99,201,.06);border:1px solid #d6e2f5;border-left:3px solid var(--brand,#2E6A4B);border-radius:10px;padding:11px 13px;color:var(--ink,#1A211C);font-size:13.5px;line-height:1.55;white-space:pre-wrap;word-break:break-word}",
      ".mlsvd-ai-empty{color:var(--muted,#79837C);font-style:italic}",
      ".mlsvd-raw{margin-top:14px}",
      ".mlsvd-raw>summary{cursor:pointer;font-size:12px;font-weight:600;color:var(--muted,#79837C);outline:none}",
      ".mlsvd-raw pre{margin:8px 0 0;background:var(--field-bg,#FCFBF8);border:1px solid var(--line,#E7E5DD);border-radius:10px;padding:10px 12px;color:var(--ink,#1A211C);font-size:12px;line-height:1.45;white-space:pre-wrap;word-break:break-word;max-height:280px;overflow:auto}",
      ".mlsvd-acts{display:flex;flex-wrap:wrap;gap:8px;margin-top:16px;align-items:center}",
      ".mlsvd-btn{font:inherit;font-size:13px;font-weight:600;padding:7px 14px;border-radius:var(--r-ctl,10px);cursor:pointer;border:1px solid var(--line,#E7E5DD);background:#fff;color:var(--ink,#1A211C);transition:background .12s ease,box-shadow .12s ease}",
      ".mlsvd-btn:hover{background:var(--soft2,#FCFBF8)}",
      ".mlsvd-btn-primary{background:var(--brand,#2E6A4B);border-color:var(--brand,#2E6A4B);color:#fff}",
      ".mlsvd-btn-primary:hover{background:var(--brand-dk,#204034)}",
      ".mlsvd-btn-ok{background:var(--green,#2E6A4B);border-color:var(--green,#2E6A4B);color:#fff}",
      ".mlsvd-btn-ok:hover{background:var(--green-dk,#204034)}",
      ".mlsvd-btn[disabled]{opacity:.55;cursor:default}",
      ".mlsvd-status{font-size:12.5px;font-weight:600;color:var(--muted,#79837C)}",
      ".mlsvd-status.ok{color:var(--green-dk,#204034)}",
      ...
      ".mlsvd-f label{font-size:11px;font-weight:700;letter-spacing:.04em;text-transform:uppercase;color:var(--muted,#79837C)}",
      ".mlsvd-f input,.mlsvd-f textarea{font:inherit;font-size:13.5px;color:var(--ink,#1A211C);background:#fff;border:1px solid var(--line,#E7E5DD);border-radius:9px;padding:8px 10px;width:100%;box-sizing:border-box}",
      ".mlsvd-f textarea{resize:vertical;min-height:64px;line-height:1.45}",
      ".mlsvd-f input:focus,.mlsvd-f textarea:focus{outline:none;border-color:var(--brand,#2E6A4B);box-shadow:var(--ring,0 0 0 3px rgba(37,99,201,.18))}",
      ".mlsvd-hint{font-size:11px;color:var(--muted,#79837C)}",
  ...
  function buildRead(v) {
    ...
    if (skeys.length) {
      ...
      skeys.forEach(function (k) {
        ...
        sc2.appendChild(el("b", null, esc(scores[k]) + (unit ? '<span style="font-size:11px;font-weight:600;color:var(--muted,#79837C)"> ' + unit + "</span>" : "")));
