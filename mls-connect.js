...
;(function(){try{var A="feat_mls_patient_age.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260628age2";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item41: patient age at-a-glance -- read-only "Age N" chip live under DOB inputs (Complex hero + Simple manual entry) and on the active-patient context bar; computed from DOB, display-only, no data mutation -- additive, reversible (window.__mlsPatientAge.revert()) */

;(function(){try{var A="feat_mls_note_metrics.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260628nm1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item42: generated-note metrics meter -- read-only word count + estimated read time under the generated-note box so the doctor can gauge note length before sign (display-only, no data mutation) -- additive, reversible (window.__mlsNoteMetrics.revert()) */
;(function(){try{var A="feat_mls_note_autofit.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260628af1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item43: generated-note auto-fit -- the generated-note textarea grows to show the whole note without inner scrolling (capped at 70vh, then scrolls) so the doctor reviews the full note at once -- additive, reversible (window.__mlsNoteAutofit.revert()) */
;(function(){try{var A="feat_mls_dotphrase_keys.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260628dk1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item44: dot-phrase keyboard shortcuts -- Alt+1/2/3 fire the existing .normal-exam/.ros-neg/.return-precautions chips (reuses app handler) with discoverable Alt+N badges; hands stay on keyboard -- additive, reversible (window.__mlsDotKeys.revert()) */

;(function(){try{var A="feat_mls_allergy_strip.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629alg1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item45: Allergy safety strip in the Visit view -- surfaces active patient's allergies (one source of truth: activePatient().allergies) above the note columns where it was previously absent; NKDA-aware, read-only -- additive, reversible (window.__mlsAllergyStrip.revert()) */
;(function(){try{var A="feat_mls_visit_stepper.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629stp1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item46: Visit flow stepper -- ties Capture/Note/Sign columns into one guided flow with a single shared progress truth (Patient -> Visit captured -> Note ready -> Ready to sign); click-to-jump; honest detectable state -- additive, reversible (window.__mlsVisitStepper.revert()) */
;(function(){try{var A="feat_mls_keyboard_layer.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629kbd1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item47: Unified keyboard layer + discoverable shortcuts overlay -- Alt+G generate / Alt+C copy / Alt+P print (reuse existing buttons) and "?" overlay listing all shortcuts incl. item44 dot phrases; cohesive keyboard story -- additive, reversible (window.__mlsKbd.revert()) */
;(function(){try{var A="feat_mls_problem_strip.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629ps1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item48: Active Problem List strip in the Visit view -- surfaces activePatient().problems as read-only chips above the note columns (one source of truth: the Athena-pulled problem list visible while writing/reviewing the note), sits just above the allergy strip -- additive, reversible (window.__mlsProblemStrip.revert()) */
;(function(){try{var A="feat_mls_patient_snapshot.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629snap1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item49: Patient Snapshot popover -- one Snapshot button on the active-patient context bar opens an in-place read-only card (age+DOB, allergies, active problems, recent visits) from activePatient(), so the doctor sees the whole picture without navigating to History and back -- additive, reversible (window.__mlsPatientSnapshot.revert()) */
;(function(){try{var A="feat_mls_note_jump.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629nj1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item50: Generated-note section quick-jump chips -- clickable chips above the formatted note (CC/HPI/ROS/Exam/Assessment/Plan) smooth-scroll the note to that section and flash the header; pure navigation aid, never edits note content -- additive, reversible (window.__mlsNoteJump.revert()) */
...
;(function(){try{var A="feat_mls_stop_confirm.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629sc1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item62: "Are you sure you want to stop recording?" confirm popup -- wraps toggleCapture so a user-clicked Stop opens a small centered on-theme dialog; only "Yes, stop" calls the original stopCapture, "Keep recording"/Esc/backdrop cancels and recording continues; internal/auto stops (newVisit, loadRecordIntoEditor, nav, recog.onend) are NOT gated -- additive, reversible (window.__mlsStopConfirm.revert()) */
...
;(function(){try{var A="feat_mls_appwidth_responsive.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629awr1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item67: app-wide responsive width -- #appWrap.wrap grows to min(1680px,95vw) on every view EXCEPT calendar (calendar owned by item64/66 via more-specific :has, no double-apply); inner auto-fill card grids reflow to use the width; smaller screens keep existing 920/980/600px breakpoints -- additive, reversible (window.__mlsAppWidth.revert()) */
;(function(){try{var A="feat_mls_studygroups.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629sg1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item68: Study Groups -- named patient cohorts with per-visit records (dedupe), intake (manual + CSV/JSON import in the app {patients:[{name,dob,mrn,history:[{date,note}]}]} shape), feature-detected Athena per-visit extraction (stubbed if pull fn unreachable; manual/import works), and AI Studio Run-study producing a graph + Excel (.xlsx) + up to ~100-page PDF -- additive, reversible (window.__mlsStudyGroups.revert()) */
;(function(){try{var A="feat_mls_show_assistant.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629sa1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item69: "Show MLS Assistant" -- teach-by-demonstration writeback targeting; adds a "Show MLS Assistant" option to the Writeback Destination panel (item61 window.__mlsWbConsole) that enters a READ-ONLY observe mode, watches where the doctor clicks the target note section/field in athenaOne, captures a robust selector + section label, saves it as the destination via the existing writeback router (__mlsWbRouter.setTarget, per-doctor, no PHI) with clear/re-teach; athenaOne capture asks MLS Assist over the ping-gated bridge (mlsAppTeachStart/Result) and falls back to an HONEST in-page capture if the extension observer is absent; observing never writes/signs, later writes still use the user-initiated name+DOB-gated writers -- additive, reversible (window.__mlsShowAsst.revert()) */
;(function(){try{var A="feat_mls_settings_wb.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629swb1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item70: add a SECOND entry point to the item61 Writeback destination panel (window.__mlsWbConsole) from the Settings area -- injects one clean on-theme row+button into the Settings modal Integrations section that calls the EXISTING __mlsWbConsole.open(); the Visit-screen "Writeback destination..." launchers stay exactly where they are; no panel markup duplicated -- additive, reversible (window.__mlsSettingsWb.revert()) */

;(function(){try{var A="feat_mls_ctxbar_age_dedupe.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629dd1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item71: de-duplicate patient age on the active-patient context bar -- hides ONLY item41 feat_mls_patient_age's blue "Age N yrs" context-bar chip (.mls-age-ctx) while the bar's own meta line already shows the age ("<N>y") / DOB; leaves item41's DOB-input age hints (.mls-age-hint) intact -- additive, reversible (window.__mlsCtxbarAgeDedupe.revert()) */

;(function(){try{var A="feat_mls_expert_top.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629et1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item72: move the "Expert marketplace listing" card (#expertCard) to the TOP of the Legal requests view (#legalReqView), above the incoming-requests list -- relocates the EXISTING DOM node (opt-in form + "Build my advertisement" CTA travel with it), idempotent, additive, reversible (window.__mlsExpertTop.revert()) */
;(function(){try{var A="feat_mls_legal_pay_setup.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629lp1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item73: Stripe Connect "Set up payments" control added to the Legal Expert Profile settings panel (CV / billing footer / rates) — reuses startConnectOnboard + /api/connect/status, shows a friendly "finishing activation" message when Connect is not enabled in LIVE; additive, reversible (window.__mlsLegalPaySetup.revert()) */
