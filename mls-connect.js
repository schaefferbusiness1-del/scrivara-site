(function(){
  ...
  var n=0, iv=setInterval(function(){ wrap('sfShowGateLoading',start); wrap('sfHideGateLoading',done); var g=document.getElementById('sfGateLoading'); if(g&&!g.__mlsBLobs){ g.__mlsBLobs=true; try{ var mo=new MutationObserver(function(){ var vis=getComputedStyle(g).display!=='none'; if(vis&&!g.__on){g.__on=true;start();} else if(!vis&&g.__on){g.__on=false;done();} }); mo.observe(g,{attributes:true,attributeFilter:['style','class']}); }catch(e){} if(getComputedStyle(g).display!=='none'){g.__on=true;start();} } if(++n>50)clearInterval(iv); },150);
})();
...
(function(){
  ...
  var MLS_APP_BUILD='2026-07-05-b23';
