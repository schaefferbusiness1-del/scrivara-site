...
;(function(){try{var A="feat_mls_patient_age.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260628age1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item41: patient age at-a-glance -- read-only "Age N" chip live under DOB inputs (Complex hero + Simple manual entry) and on the active-patient context bar; computed from DOB, display-only, no data mutation -- additive, reversible (window.__mlsPatientAge.revert()) */
