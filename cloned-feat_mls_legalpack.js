...
(function () {
  'use strict';
  if (!window.__MLS_CLONED || window.__MLS_CLONED.enabled !== true) return;
  ...
  function syncDoor() {
    ...
    node.setAttribute('title', 'Open the free read-only Legal / IME draft preview for the exact active patient');
  ...
  function generateDraft() {
    ...
    return chain.then(function () {
      ...
      toast('Legal / IME draft ready for clinician review.', 'ok');
      return true;
  ...
  function shellHtml() {
    ...
    return '<div class="p1l-shell">' +
      '<div class="p1l-top"><div><span class="p1l-badge">Free preview · read-only draft workspace</span><h1 id="mlsP1LegalTitle">Legal / IME workspace</h1><p>No signing, delivery, chart filing, EMR writing, payment, messaging, or public intake.</p></div><button type="button" class="p1l-close" id="mlsP1LegalClose">Close preview</button></div>' +
  ...
  function renderNoPatient(message) {
    ...
    root.innerHTML = '<div class="p1l-shell"><div class="p1l-top"><div><span class="p1l-badge">Free preview · fail closed</span><h1 id="mlsP1LegalTitle">Legal / IME workspace</h1></div><button type="button" class="p1l-close" id="mlsP1LegalClose">Close preview</button></div><div class="p1l-card"><h2>No bound patient workspace</h2><div class="p1l-warn" role="alert">' + esc(message || 'Select exactly one active patient, then reopen this preview.') + '</div></div></div>';
