...
(function () {
  ...
  function shellHtml(binding) {
    return '<div class="p1l-shell">' +
      '<div class="p1l-top"><div><span class="p1l-badge">Free preview · read-only draft workspace</span><h1 id="mlsP1LegalTitle">Legal / IME workspace</h1><p>Exact active chart, local files, and a ' + SECTIONS.length + '-section clinician-review draft on your practice letterhead. No signing, delivery, chart filing, Athena writing, payment, messaging, or public intake.</p></div><button type="button" class="p1l-close" id="mlsP1LegalClose">Close preview</button></div>' +
