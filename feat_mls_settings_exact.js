...
;(function () {
  ...
  function injectCSS() {
    var css = [
      /* navy backdrop */
      "#settingsModal.show{background:linear-gradient(135deg,rgba(20,33,28,.92),rgba(20,53,96,.92))!important}",
      ...
      "#settingsModal .modal > .set-section .set-head{font-size:13px!important;font-weight:700!important;letter-spacing:.04em!important;color:#1A211C!important;margin:0 0 6px!important}",
      "#settingsModal .modal > .set-section .set-desc{color:#79837C!important;font-size:13px!important;line-height:1.5!important;margin:0 0 14px!important}",
      "#settingsModal .modal > .set-section .field{margin-bottom:14px!important}",
      "#settingsModal .modal > .set-section .field label{display:block!important;font-size:13px!important;font-weight:700!important;margin-bottom:8px!important;color:#1A211C!important}",
      FIELD + "{width:100%!important;min-height:46px!important;border-radius:11px!important;border:1px solid #e0e8f1!important;background:#FCFBF8!important;padding:11px 15px!important;font-size:14px!important;font-family:inherit!important;color:#1A211C!important;outline:none!important;max-width:100%}",
      "#settingsModal .modal > .set-section textarea{min-height:90px!important}",
      "#settingsModal .modal .btn-primary{border:0!important;background:linear-gradient(135deg,#2E6A4B,#204034)!important;color:#fff!important;border-radius:11px!important;font-weight:700!important}",
      /* right section-nav panel (the app's real #settingsTabBar) */
      "#settingsModal #settingsTabBar{grid-area:2 / 2 / 9999 / 3!important;position:sticky!important;top:65px!important;align-self:start!important;display:flex!important;flex-direction:column!important;gap:4px!important;width:auto!important;max-height:calc(90vh - 150px)!important;overflow-y:auto!important;background:#f3f6fb!important;border-left:1px solid #F4F2EC!important;padding:20px 16px!important;margin:0!important;border-radius:0!important}",
      ...
      "#settingsModal #settingsTabBar .set-tab:hover{background:rgba(32,64,52,.07)!important}",
      "#settingsModal #settingsTabBar .set-tab.on{background:linear-gradient(135deg,#2E6A4B,#204034)!important;color:#fff!important;font-weight:700!important;box-shadow:0 8px 18px -8px rgba(32,64,52,.6)!important}",
      /* sticky footer (Save/Close) spanning full width */
      "#settingsModal .modal > .row{grid-column:1 / -1!important;position:sticky!important;bottom:0!important;z-index:7!important;display:flex!important;gap:12px!important;padding:16px 28px!important;border-top:1px solid #F4F2EC!important;background:#fbfcfe!important;margin:0!important}",
