...
const FULL_GATE_TESTS = 1035; /* 2026-09-15: the canonical registry (tests/run-all.js --plan) is 1035 after this session's registered suites; fast-release-gate-contract pins the two equal */
