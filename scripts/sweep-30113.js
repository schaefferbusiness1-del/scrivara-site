/* sweep-30113.js - move every 3.0.112 release pin to 3.0.113 (qpidle-1.0.0 / pinready-1.0.0 / legacyidle-1.0.0).
 * Notes paragraphs swapped by index-scan FIRST, then PIN-SPECIFIC subs (never
 * global: the new notes prose legitimately names v3.0.112). Fail-closed exact
...
['1pScribeFlow.html', '1p/index.html'].forEach(function (f) {
  ...
  subs(f, [
    ['>3.0.112</b>', '>3.0.113</b>', 1],
    ['MLS_Assist_v3.0.112.bin', 'MLS_Assist_v3.0.113.bin', 1],
    ['download="MLS_Assist_v3.0.112.zip"', 'download="MLS_Assist_v3.0.113.zip"', 1],
    ['>3.0.112</span>', '>3.0.113</span>', 2]
  ]);
});
...
subs('feat_mls_checker.js', [["SERVER_EXT_VERSION = '3.0.112'", "SERVER_EXT_VERSION = '3.0.113'", 1]]);
subs('_config.yml', [['3.0.112', '3.0.113', 4], [OLD_ZIP_SHA, NEW_ZIP_SHA, 1]]);
subs('get-extension.html', [['3.0.112', '3.0.113', 5], [OLD_ZIP_SHA, NEW_ZIP_SHA, 1]]);
subs('pages-publication-inventory.json', [['MLS_Assist_v3.0.112.bin', 'MLS_Assist_v3.0.113.bin', 1], ['MLS_Assist_v3.0.112.zip', 'MLS_Assist_v3.0.113.zip', 1]]);
subs('tests/extension-package.test.js', [['3.0.112', '3.0.113', 2], [OLD_ZIP_SHA, NEW_ZIP_SHA, 1]]);
subs('tests/public-publication-boundary.test.js', [['3.0.112', '3.0.113', 13], [OLD_ZIP_SHA, NEW_ZIP_SHA, 1]]);
subs('tests/1p-preview-contract.test.js', [["'MLS_Assist_v3.0.61', 'MLS_Assist_v3.0.112'", "'MLS_Assist_v3.0.61', 'MLS_Assist_v3.0.113'", 1], ['MLS Assist 3.0.112 package', 'MLS Assist 3.0.113 package', 1], [OLD_ZIP_SHA, NEW_ZIP_SHA, 1]]);
fs.writeFileSync('extension-version.json', JSON.stringify({ version: '3.0.113', minChrome: 116, notes: NEW_NOTES }, null, 2) + '\n');
