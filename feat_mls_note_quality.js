...
(function () {
  ...
  CONTRACTS[T_SOAP] =
    ...
    "VISIT METADATA. Capture documented date and time of service, encounter modality (including telehealth modality and patient location when supplied), visit type, chief complaint with documented laterality, and allergies including documented NKDA. Do not fabricate a missing value.\n\n" +
    "OBJECTIVE. Include only the focused regional exam, vitals, and data actually documented today. When supplied, preserve laterality or midline, quantified ROM, strength, provocative tests with side/result, reflexes, sensation, gait, what was re-performed today, and whether imaging was independently interpreted or only reported. Do not turn an absent exam or data review into normal findings or a claim of independent interpretation.\n\n" +
    ...
    "For documented controlled-substance management, preserve drug details and the actual PDMP finding, UDS date and interpretation or documented pending/not-yet-due status, pill count, agreement status, naloxone decision, and total daily MME for a full-agonist regimen (never convert buprenorphine; qualify methadone as nonlinear). Do not infer any of these reviews, findings, or medication continuation.\n\n" +
    "For a documented procedure plan, preserve the actual target laterality, level or joint, approach, image guidance, indication, and stated decision. When anticoagulant or antiplatelet management is documented, preserve the hold/continue decision, interval, coordinating prescriber, and resumption plan. Preserve documented risks, benefits, alternatives, follow-up interval/event anchor, plan-specific return precautions, signature credentials, date/time, and scribe or teaching attestation; never invent consent, coordination, precautions, a signature, or an attestation.\n\n" +
