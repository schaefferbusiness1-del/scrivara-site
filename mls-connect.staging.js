...
;(function(){try{var A="feat_mls_day_pace.js";if(document.querySelector(String.fromCharCode(115)+"cript[data-mls-asset='"+A+"']"))return;var s=document.createElement("script");s.src=A+"?v=20260629dp1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item67 (STAGING): Clinic Day Pace meter on the Who is Next box -- shared scoped schedule, place-in-the-day -- additive, reversible (window.__mlsDayPace.revert()) */
;(function(){try{var A="feat_mls_next_patient.js";if(document.querySelector(String.fromCharCode(115)+"cript[data-mls-asset='"+A+"']"))return;var s=document.createElement("script");s.src=A+"?v=20260629np1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item68 (STAGING): one-click Next/Prev patient advance through the shared schedule via __mlsPick.select -- additive, reversible (window.__mlsNextPatient.revert()) */
;(function(){try{var A="feat_mls_day_agenda.js";if(document.querySelector(String.fromCharCode(115)+"cript[data-mls-asset='"+A+"']"))return;var s=document.createElement("script");s.src=A+"?v=20260629ag1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item69 (STAGING): full-day agenda panel, click any patient to jump (shared schedule + __mlsPick.select) -- additive, reversible (window.__mlsDayAgenda.revert()) */
