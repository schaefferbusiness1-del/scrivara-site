...
;(function(){try{var A="feat_mls_find_doctors.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629fd1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item54: Find Doctors - real athenaOne provider names (normalizes the string entries in _calProviders, "Last_First_CRED" -> "First Last, CRED") replacing "Provider N", plus a Find Doctors button to pick a doctor and scope the pull - additive, reversible (window.__mlsFindDoctors.revert()) */
