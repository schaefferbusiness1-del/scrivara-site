...
;(function(){try{if(document.querySelector('script[data-mls-asset="feat_mls_assistant_exact.js"]'))return;var s=document.createElement('script');s.src='feat_mls_assistant_exact.js?v=20260624asst3';s.setAttribute('data-mls-asset','feat_mls_assistant_exact.js');s.async=false;(document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* MLSscribe feat_mls_assistant_exact.js (STAGING) - one honest assistant panel, additive reversible */
;(function(){try{if(document.querySelector('script[data-mls-asset="feat_mls_schedimport_exact.js"]'))return;var s=document.createElement('script');s.src='feat_mls_schedimport_exact.js?v=20260624si2';s.setAttribute('data-mls-asset','feat_mls_schedimport_exact.js');s.async=false;(document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* MLSscribe feat_mls_schedimport_exact.js (STAGING) - corrected schedule->calendar import */
...
;(function(){try{var A="feat_mls_patient_age.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260628age2";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item41 (STAGING): patient age at-a-glance -- read-only "Age N" chip live under DOB inputs and on the active-patient context bar; computed from DOB, display-only, no data mutation -- additive, reversible (window.__mlsPatientAge.revert()) */

;(function(){try{var A="feat_mls_note_metrics.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260628nm1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item42 (STAGING): generated-note metrics meter -- read-only word count + estimated read time under the generated-note box so the doctor can gauge note length before sign (display-only, no data mutation) -- additive, reversible (window.__mlsNoteMetrics.revert()) */
;(function(){try{var A="feat_mls_note_autofit.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260628af1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item43 (STAGING): generated-note auto-fit -- the generated-note textarea grows to show the whole note without inner scrolling (capped at 70vh, then scrolls) so the doctor reviews the full note at once -- additive, reversible (window.__mlsNoteAutofit.revert()) */
;(function(){try{var A="feat_mls_dotphrase_keys.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260628dk1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item44 (STAGING): dot-phrase keyboard shortcuts -- Alt+1/2/3 fire the existing .normal-exam/.ros-neg/.return-precautions chips (reuses app handler) with discoverable Alt+N badges; hands stay on keyboard -- additive, reversible (window.__mlsDotKeys.revert()) */

;(function(){try{var A="feat_mls_allergy_strip.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629alg1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item45 (STAGING): Allergy safety strip in the Visit view -- surfaces active patient's allergies (one source of truth: activePatient().allergies) above the note columns; NKDA-aware, read-only -- additive, reversible (window.__mlsAllergyStrip.revert()) */
;(function(){try{var A="feat_mls_visit_stepper.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629stp1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item46 (STAGING): Visit flow stepper -- ties Capture/Note/Sign columns into one guided flow with one shared progress truth; click-to-jump -- additive, reversible (window.__mlsVisitStepper.revert()) */
;(function(){try{var A="feat_mls_keyboard_layer.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629kbd1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item47 (STAGING): Unified keyboard layer + shortcuts overlay -- Alt+G/C/P reuse existing buttons, "?" overlay lists all shortcuts incl. item44 dot phrases -- additive, reversible (window.__mlsKbd.revert()) */
;(function(){try{var A="feat_mls_problem_strip.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629ps1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item48 (STAGING): Active Problem List strip in the Visit view -- surfaces activePatient().problems as read-only chips above the note columns, sits above the allergy strip -- additive, reversible (window.__mlsProblemStrip.revert()) */
;(function(){try{var A="feat_mls_patient_snapshot.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629snap1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item49 (STAGING): Patient Snapshot popover -- one button on the context bar opens an in-place read-only card (age, allergies, active problems, recent visits) from activePatient() -- additive, reversible (window.__mlsPatientSnapshot.revert()) */
;(function(){try{var A="feat_mls_note_jump.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629nj1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item50 (STAGING): Generated-note section quick-jump chips -- clickable chips above the formatted note smooth-scroll to each section; navigation aid only -- additive, reversible (window.__mlsNoteJump.revert()) */
;(function(){try{var A="feat_mls_visit_stepper_orderfix.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629vsof1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item51: Visit-header order fix - stops the stepper/Active-problems ping-pong above the note; mutes original visit stepper (item46) and reships it corrected with one deterministic order [stepper -> Active problems -> Allergies -> note], idempotent placement - additive, reversible (window.__mlsVisitStepperOrderFix.revert()) */
;(function(){try{var A="feat_mls_pick_smartscope.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629pss1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item52: Patient picker smart-scope - the selectable patient-card grid no longer vanishes after a schedule pull / on an empty "today"; reships the inline Complex picker via __mlsPick.renderGrid with a smart scope (today, else the most-recent clinic day with appts) and re-renders after each pull - additive, reversible (window.__mlsPickSmartScope.revert()) */
;(function(){try{var A="feat_mls_herotoday_fix.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629ht1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item53: Patient picker lives in the BLUE hero (#heroToday) - fixes the _renderTodayPatients infinite recursion (upnow_realtime<->upnow_sync) that crashed every pull, feeds the NEXT-UP picker from unified _calAppts (today else most-recent clinic day), retires the white grids - additive, reversible (window.__mlsHeroToday.revert()) */
;(function(){try{var A="feat_mls_find_doctors.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629fd2";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item54: Find Doctors - real athenaOne provider names (normalizes the string entries in _calProviders, "Last_First_CRED" -> "First Last, CRED") replacing "Provider N", plus a Find Doctors button to pick a doctor and scope the pull - additive, reversible (window.__mlsFindDoctors.revert()) */
;(function(){try{var A="feat_mls_whosnext.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629wn1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item55: "Who's Next" picker - renames the blue NEXT-UP picker to Who's Next, renders boxes that always match the count (fixes "N seen / 0 shown"), scopes to the doctor picked in Find Doctors using the pull's in-memory provider data, shows the picked doctor name - additive, reversible (window.__mlsWhosNext.revert()) */
;(function(){try{var A="feat_mls_ctx_appt.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629ctxa1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item56: active-patient appointment chip on the patient context bar (appt time + reason matched from the shared __mlsPick schedule; one source of truth picker->active patient->bar) -- additive, reversible (window.__mlsCtxAppt.revert()) */
;(function(){try{var A="feat_mls_hero_search.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629hsrch1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item57: today's-schedule quick search in the visit-hero NEXT UP picker (live-filter all patients by name/reason/MRN/time; result click uses shared __mlsPick.select) -- additive, reversible (window.__mlsHeroSearch.revert()) */
;(function(){try{var A="feat_mls_hero_glance.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629hgln1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item58: day-at-a-glance schedule strip above the NEXT UP picker (up next, count still ahead, last appt -- from the shared schedule) -- additive, reversible (window.__mlsHeroGlance.revert()) */

;(function(){try{var A="feat_mls_assistant_selffix.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629asf2";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item59: MLS Assistant Phase-1 self-fix -- read-only app introspection (enumerates __mls* handles, key globals _calAppts/_calProviders/activePatient/currentView, recent console errors, current-screen DOM) + plain-language diagnosis of known breakage patterns (module throw/recursion, count-vs-rendered mismatch, missing picker/strip, duplicate inserts, data-in-memory-not-rendered) + SAFE reversible self-actions (revert/re-apply/re-run a module own render) gated on in-chat confirmation; hard-blocks patient-data, athenaOne and repo writes -- additive, reversible (window.__mlsAssistantSelfFix.revert()) */

/* ---- item60: feat_mls_whosnext_cleanfix.js (CSS-only Who's Next picker fix; reversible via window.__mlsWhosNextCleanFix.revert()) ---- */
;(function(){try{if(document.querySelector('script[data-mls-asset="feat_mls_whosnext_cleanfix.js"]'))return;var s=document.createElement('script');s.src='feat_mls_whosnext_cleanfix.js?v=20260629wncf1';s.setAttribute('data-mls-asset','feat_mls_whosnext_cleanfix.js');s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})();

;(function(){try{var A="feat_mls_wb_console.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629wbc1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item61: MLS Assistant writeback destination console (UI to choose where each output lands in athenaOne: op-note tab/section/template, note/dx/cpt) + chat-driven confirm-gated writeback + de-dupe of the duplicate Write-note caption + opt-in USER-INITIATED Sign & Save driving athenaOne Sign & Save (name+DOB gated, honest, never autonomous) via existing gated writers __mlsOpWb/__mlsAthenaWriteback -- additive, reversible (window.__mlsWbConsole.revert()) */

;(function(){try{var A="feat_mls_stop_confirm.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629sc1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item62 (STAGING): "Are you sure you want to stop recording?" confirm popup -- wraps toggleCapture so a user-clicked Stop opens a small centered on-theme dialog; only "Yes, stop" calls the original stopCapture, "Keep recording"/Esc/backdrop cancels and recording continues; internal/auto stops are NOT gated -- additive, reversible (window.__mlsStopConfirm.revert()) */

;(function(){try{var A="feat_mls_cal_athena_sync.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629cas1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item63 (STAGING): Calendar<->athenaOne sync -- calendar always shows the pulled day (uncapped/newest-first read + empty-read retry + re-render), provider sent on the pull's POST so the backend provider column populates on re-pull, real doctor names in the calendar provider filter (kills "Provider N"/"Provider undefined"), render-layer de-dupe by patient+date+time+provider (legacy triples show once, no records deleted), garbled parser-noise rows suppressed at render, and a clear "Viewing: <day> -- N appointments (deduped)" state with provider scoping over STORED appointments -- additive, reversible (window.__mlsCalAthenaSync.revert()) */
...
;(function(){try{var A="feat_mls_problem_strip_hide.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629psh1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item65: remove the Active Problems strip from the VISIT SCREEN only (hides/quiets #mlsProblemStrip item48 via window.__mlsProblemStrip.revert()); Allergy strip (item45) stays on the Visit screen and Active problems remain in the Patient Snapshot popover (item49, reads activePatient().problems independently) -- additive, reversible (window.__mlsProblemStripHide.revert()) */

;(function(){try{var A="feat_mls_appwidth_responsive.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629awr1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item67 (STAGING): app-wide responsive width -- #appWrap.wrap grows to min(1680px,95vw) on every view EXCEPT calendar (calendar owned by item64/66 via more-specific :has, no double-apply); inner auto-fill card grids reflow to use the width; smaller screens keep existing 920/980/600px breakpoints -- additive, reversible (window.__mlsAppWidth.revert()) */

;(function(){try{var A="feat_mls_studygroups.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629sg1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item68 (STAGING): Study Groups -- named patient cohorts with per-visit records (dedupe), intake (manual + CSV/JSON import in the app {patients:[{name,dob,mrn,history:[{date,note}]}]} shape), feature-detected Athena per-visit extraction (stubbed if pull fn unreachable; manual/import works), and AI Studio Run-study producing a graph + Excel (.xlsx) + up to ~100-page PDF -- additive, reversible (window.__mlsStudyGroups.revert()) */

;(function(){try{var A="feat_mls_show_assistant.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629sa1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item69 (STAGING): "Show MLS Assistant" -- teach-by-demonstration writeback targeting; adds a "Show MLS Assistant" option to the Writeback Destination panel (item61 window.__mlsWbConsole) that enters a READ-ONLY observe mode, watches where the doctor clicks the target note section/field in athenaOne, captures a robust selector + section label, saves it as the destination via the existing writeback router (__mlsWbRouter.setTarget, per-doctor, no PHI) with clear/re-teach; athenaOne capture asks MLS Assist over the ping-gated bridge (mlsAppTeachStart/Result) and falls back to an HONEST in-page capture if the extension observer is absent; observing never writes/signs, later writes still use the user-initiated name+DOB-gated writers -- additive, reversible (window.__mlsShowAsst.revert()) */

;(function(){try{var A="feat_mls_settings_wb.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629swb1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item70 (STAGING): add a SECOND entry point to the item61 Writeback destination panel (window.__mlsWbConsole) from the Settings area -- injects one clean on-theme row+button into the Settings modal Integrations section that calls the EXISTING __mlsWbConsole.open(); the Visit-screen "Writeback destination..." launchers stay exactly where they are; no panel markup duplicated -- additive, reversible (window.__mlsSettingsWb.revert()) */

;(function(){try{var A="feat_mls_ctxbar_age_dedupe.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629dd1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item71 (STAGING): de-duplicate patient age on the active-patient context bar -- hides ONLY item41 feat_mls_patient_age's blue "Age N yrs" context-bar chip (.mls-age-ctx) while the bar's own meta line already shows the age ("<N>y") / DOB; leaves item41's DOB-input age hints (.mls-age-hint) intact -- additive, reversible (window.__mlsCtxbarAgeDedupe.revert()) */

;(function(){try{var A="feat_mls_expert_top.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629et1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item67: move the "Expert marketplace listing" card (#expertCard) to the TOP of the Legal requests view (#legalReqView), above the incoming-requests list -- relocates the EXISTING DOM node (opt-in form + "Build my advertisement" CTA travel with it), idempotent, additive, reversible (window.__mlsExpertTop.revert()) */
;(function(){try{var A="feat_mls_legal_pay_setup.js";if(document.querySelector('script[data-mls-asset="'+A+'"]'))return;var s=document.createElement("script");s.src=A+"?v=20260629lp1";s.setAttribute("data-mls-asset",A);s.async=false;(document.body||document.head||document.documentElement).appendChild(s);}catch(e){}})(); /* item72: Stripe Connect "Set up payments" control added to the Legal Expert Profile settings panel (CV / billing footer / rates) — reuses startConnectOnboard + /api/connect/status, shows a friendly "finishing activation" message when Connect is not enabled in LIVE; additive, reversible (window.__mlsLegalPaySetup.revert()) */
