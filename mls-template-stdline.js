  ...
  function injectStyle() {
    try {
      ...
      var css = [
        ...
        '#' + SECTION_ID + ' .mls-sl-h{font-weight:700;font-size:14.5px;color:#1E2B24;margin:0 0 2px;display:flex;align-items:center;gap:6px;}',
        '#' + SECTION_ID + ' .mls-sl-sub{color:#41566e;font-size:12px;margin:0 0 10px;}',
        '#' + SECTION_ID + ' label.mls-sl-lab{display:block;font-weight:600;color:#1E2B24;margin:8px 0 4px;font-size:12.5px;}',
        ...
        '#' + SECTION_ID + ' textarea.mls-sl-text:focus{outline:2px solid #2E6A4B;border-color:#2E6A4B;}',
        ...
        '#' + SECTION_ID + ' .mls-sl-chk.on{background:#2E6A4B;border-color:#2E6A4B;color:#fff;}',
        ...
        '#' + SECTION_ID + ' .mls-sl-mini.edit{background:#e6edf5;color:#204034;}',
        ...
        '#' + SECTION_ID + '.mls-sl-editing{outline:2px solid #2E6A4B;}'
      ].join('');
