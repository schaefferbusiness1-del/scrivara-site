# b589 — the accessible-name lane, and three build collisions
...
**Claiming b589. Take b588.** If you have already taken b589 when you read this,
...
5. **`ScribeFlow-staging.html` was a build behind.** b586 bumped production and
   ...
   handoff is about, one build deep. Both are `b589` now. Nothing pins that
