...
(function () {
  ...
  function injectModalRow() {
    safe(function () {
      ...
      btn.style.cssText = 'border:0;border-radius:8px;padding:7px 12px;cursor:pointer;font-weight:700;color:#fff;background:linear-gradient(135deg,#2E6A4B,#204034)';
