...
;(function () {
  ...
  function injectCSS() {
    var css = [
      "#authScreen.auth-wrap:not([style*='display: none']):not([style*='display:none']){background:linear-gradient(135deg,#204034,#204034)!important;min-height:100vh!important;display:flex!important;align-items:center!important;justify-content:center!important;padding:36px 20px!important}",
  ...
  function build() { injectCSS(); var a = $("authScreen"); if (a && a.getAttribute("data-lgx-built") !== VERSION) a.setAttribute("data-lgx-built", VERSION); }
