...
(function () {
  ...
  function injectStyle() {
    ...
    st.textContent = [
      ...
      'background:#ffffff;color:#204034;font-size:14px;font-weight:800;box-shadow:0 2px 8px rgba(20,33,28,.18);}',
      '.mlsproto-upnow .dot{width:9px;height:9px;border-radius:50%;background:#2E6A4B;box-shadow:0 0 0 3px rgba(46,106,75,.25);}',
      ...
      'background:#ffffff;border:2px solid rgba(255,255,255,.65);color:#1A211C;box-shadow:0 2px 8px rgba(20,33,28,.16);',
      'font-family:inherit;transition:transform .06s ease,box-shadow .12s ease;}',
      '#mlsProtoGrid button:hover{transform:translateY(-1px);box-shadow:0 5px 16px rgba(20,33,28,.26);border-color:#fff;}',
      '#mlsProtoGrid button:focus-visible{outline:3px solid #ffd34d;outline-offset:2px;}',
      '#mlsProtoGrid button > span:first-child{font-size:15px;font-weight:800;color:#1A211C;line-height:1.2;}',
      ...
      'color:#2E6A4B;text-transform:uppercase;}',
      '#mlsProtoGrid button.is-upnow{border-color:#2E6A4B;box-shadow:0 0 0 3px rgba(46,106,75,.22),0 3px 10px rgba(20,33,28,.2);}',
      ...
      'border:2px solid rgba(255,255,255,.55);background:#fff;color:#1A211C;font:14px/1.45 inherit;}',
