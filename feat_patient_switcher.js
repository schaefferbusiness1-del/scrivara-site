...
(function () {
  ...
  function ensureStyle() {
    ...
    s.textContent = [
      ...
      '.mlsps-hd{display:flex;align-items:center;gap:10px;padding:12px 14px;background:#1E2B24;color:#fff;}',
      ...
      '.mlsps-srch input:focus{border-color:#2E6A4B;box-shadow:0 0 0 3px rgba(47,107,214,.18);}',
      ...
      '.mlsps-row.sel{background:#dbeafe;outline:2px solid #2E6A4B;}',
      '.mlsps-av{flex:0 0 34px;width:34px;height:34px;border-radius:50%;background:#1E2B24;color:#fff;',
      ...
      '.mlsps-foot kbd{font:inherit;background:#F4F2EC;border:1px solid #cdd8e3;border-bottom-width:2px;',
