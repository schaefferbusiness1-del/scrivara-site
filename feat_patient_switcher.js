...
(function () {
  ...
  function ensureStyle() {
    ...
    s.textContent = [
      ...
      'align-items:flex-start;justify-content:center;background:rgba(26,33,28,.45);',
      ...
      'background:#ffffff;color:#1A211C;border:1px solid #E7E5DD;border-radius:14px;overflow:hidden;',
      'box-shadow:0 1px 2px rgba(20,33,28,.04),0 18px 44px -18px rgba(20,33,28,.25);font:14px/1.4 -apple-system,Segoe UI,Roboto,Arial,sans-serif;}',
      '.mlsps-hd{display:flex;align-items:center;gap:10px;padding:12px 14px;background:#FCFBF8;color:#1A211C;border-bottom:1px solid #E7E5DD;}',
      '.mlsps-hd .t{font-weight:700;font-size:14px;}',
      '.mlsps-hd .x{margin-left:auto;cursor:pointer;background:none;border:0;color:#8A8F86;font-size:18px;line-height:1;opacity:.85;}',
      '.mlsps-hd .x:hover{opacity:1;}',
      '.mlsps-srch{padding:10px 12px;border-bottom:1px solid #EFEDE6;background:#FCFBF8;}',
      '.mlsps-srch input{width:100%;box-sizing:border-box;padding:11px 12px;font-size:15px;color:#1A211C;',
      'border:2px solid #D9D6CD;border-radius:9px;outline:none;background:#fff;}',
      '.mlsps-srch input:focus{border-color:#204034;box-shadow:0 0 0 3px rgba(32,64,52,.18);}',
      '.mlsps-cnt{padding:6px 14px;font-size:11.5px;color:#79837C;border-bottom:1px solid #EFEDE6;}',
      ...
      '.mlsps-row:hover{background:#F2F0E9;}',
      '.mlsps-row.sel{background:#F2F0E9;outline:2px solid #204034;}',
      '.mlsps-av{flex:0 0 34px;width:34px;height:34px;border-radius:50%;background:#204034;color:#fff;',
      ...
      '.mlsps-nm{font-weight:600;color:#1A211C;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}',
      '.mlsps-sub{font-size:12px;color:#55605A;margin-top:1px;}',
      '.mlsps-badge{flex:0 0 auto;font-size:10px;font-weight:700;letter-spacing:.03em;color:#2E6A4B;',
      'background:#F2F0E9;border:1px solid #E4E1D8;border-radius:999px;padding:2px 8px;}',
      '.mlsps-empty{padding:22px 14px;text-align:center;color:#79837C;}',
      '.mlsps-foot{padding:8px 14px;border-top:1px solid #EFEDE6;font-size:11px;color:#79837C;background:#FCFBF8;}',
      '.mlsps-foot kbd{font:inherit;background:#F4F2EC;border:1px solid #D9D6CD;border-bottom-width:2px;',
      'border-radius:5px;padding:0 5px;color:#55605A;}',
