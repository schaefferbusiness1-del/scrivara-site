...
(function () {
  ...
  function injectStyle() {
    ...
    st.textContent = [
      ...
      '#' + PANEL_ID + ' .mlssk-cb{flex:0 0 auto;width:22px;height:22px;margin-top:2px;cursor:pointer;accent-color:#204034;}',
      '#' + PANEL_ID + ' .mlssk-row.mlssk-disabled .mlssk-cb{cursor:not-allowed;}',
      '#' + PANEL_ID + ' .mlssk-main{flex:1 1 auto;min-width:0;}',
      '#' + PANEL_ID + ' .mlssk-lbl{font-size:15px;font-weight:800;color:#1A211C;line-height:1.25;display:flex;align-items:center;flex-wrap:wrap;gap:7px;}',
      '#' + PANEL_ID + ' .mlssk-badge{font-size:10px;font-weight:900;letter-spacing:.03em;color:#B07636;background:#FCF8EF;border:1px solid #EFE4CE;border-radius:6px;padding:2px 6px;text-transform:uppercase;}',
      '#' + PANEL_ID + ' .mlssk-sub{font-size:12.6px;font-weight:500;color:#204034;line-height:1.4;margin-top:3px;}',
      '#' + PANEL_ID + ' .mlssk-reason{font-size:12px;font-weight:700;color:#B07636;line-height:1.4;margin-top:4px;}',
      ...
      '#' + PANEL_ID + ' .mlssk-stat.ok{color:#2E6A4B;}',
      '#' + PANEL_ID + ' .mlssk-stat.fail{color:#B23B3B;}',
      '#' + PANEL_ID + ' .mlssk-stat.hand{color:#B07636;}',
      ...
      'background:#204034;color:#fff;font-size:16px;font-weight:800;line-height:1.2;box-shadow:0 8px 20px -8px rgba(32,64,52,.6);}',
      '#' + PANEL_ID + ' .mlssk-submit:disabled{background:#79837C;cursor:not-allowed;box-shadow:none;}',
