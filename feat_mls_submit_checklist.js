...
(function () {
  ...
  function injectStyle() {
    ...
    st.textContent = [
      ...
      '#' + PANEL_ID + ' .mlssk-hsub{font-size:12.8px;color:#eaf2ff;opacity:.95;line-height:1.4;margin:0 0 11px;}',
      ...
      '#' + PANEL_ID + ' .mlssk-row.mlssk-disabled{opacity:.62;background:#eef2f7;border-color:rgba(255,255,255,.3);}',
      ...
      '#' + PANEL_ID + ' .mlssk-sub{font-size:12.6px;font-weight:500;color:#33506e;line-height:1.4;margin-top:3px;}',
      ...
      '#' + PANEL_ID + ' .mlssk-stat.run{color:#1d4ed8;}',
