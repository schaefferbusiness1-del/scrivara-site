...
(function () {
  ...
  var ROUTES = [
    ...
    { sel: '#visitView #mlsEz3Body:has(#ez3Change) .ez3-row2:not(:has(#ez3Prep)):not(:has(#ez3Prep2)):not(:has(#ez3NextPt))',
    ...
    { sel: '#visitView #mlsEz3Body:has(#ez3Change) .ez3-row2 > *:not(#ez3Prep):not(#ez3Prep2):not(#ez3NextPt)',
      route: 'the "Visit shortcuts" chip already on the visit (#ez3QToolsToggle / #ez3flToolsToggle)',
      why: 'inside the surviving row, op notes and Next patient stay visible; other shortcuts still fold' },
    { sel: '#visitView #mlsEz3Body:has(#ez3Change) .ez3-toolslbl:has(+ .ez3-row2:not(:has(#ez3Prep)):not(:has(#ez3Prep2)):not(:has(#ez3NextPt)))',
  ...
  var CSS = [
    ...
    /* The secondary chip row and the note-format chips answer to the "Visit
       ...
       Op notes stay visible by owner order (2026-07-26): "make sure the op
       ...
       row survives when it carries the op-note chip or Next patient, so the
       next visit is reachable without opening shortcuts. Other chips fold. */
    'body.' + BODY + ':not(.' + TOOLS + ') #visitView #mlsEz3Body:has(#ez3Change) .ez3-row2:not(:has(#ez3Prep)):not(:has(#ez3Prep2)):not(:has(#ez3NextPt)),' +
    'body.' + BODY + ':not(.' + TOOLS + ') #visitView #ez3StyleChips{display:none!important}',
    'body.' + BODY + ':not(.' + TOOLS + ') #visitView #mlsEz3Body:has(#ez3Change) .ez3-row2 > *:not(#ez3Prep):not(#ez3Prep2):not(#ez3NextPt){display:none!important}',
    ...
    'body.' + BODY + ':not(.' + TOOLS + ') #visitView #mlsEz3Body:has(#ez3Change) .ez3-toolslbl:has(+ .ez3-row2:not(:has(#ez3Prep)):not(:has(#ez3Prep2)):not(:has(#ez3NextPt))){display:none!important}',
