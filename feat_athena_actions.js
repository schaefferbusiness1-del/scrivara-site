...
(function () {
  ...
  function ensureStyle() {
    ...
    s.textContent = [
      ...
      '.mlsaa-hd{display:flex;align-items:center;gap:8px;padding:10px 12px;background:#10294a;color:#fff;font-weight:700;}',
      ...
      '.mlsaa-intent-top{padding:8px 12px;background:#eef4fb;color:#1d3a5f;font-size:12px;border-bottom:1px solid #e2ebf4;}',
      ...
      '.mlsaa-done.ok{color:#0f8a45;} .mlsaa-done.fail{color:#a01818;} .mlsaa-done.info{color:#1d3a5f;}',
